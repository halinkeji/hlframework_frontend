...
export function getItemData ({ commit }, params) {
  return new Promise((resolve, reject) => {
    const apiUrl = 'v3/timing/view?id=' + params
...
export function deleteDetail ({ commit }, item) {
  return new Promise((resolve, reject) => {
    const apiUrl = 'v3/timing/deldetail'
    api
      .post(apiUrl, item)
      .then(response => {
        resolve(response)
...
export function getAllData ({ commit }, item) {
  return new Promise((resolve, reject) => {
    api
      .get('v3/timing/alldata', { params: item })
      .then(response => {
        resolve(response)
      })
      .catch(error => {
