...
export function saveTemplate ({ commit }, params) {
  return new Promise((resolve, reject) => {
    api.post('cloudprinter/v1/setting/save-template', params)
      .then(response => {
        resolve(response)
      })
      .catch(error => {
...
export function getTemplate ({ commit }, params) {
  return new Promise((resolve, reject) => {
    api.get('cloudprinter/v1/setting/get-template', { params })
      .then(response => {
        resolve(response)
      })
      .catch(error => {
...
export function sendTest ({ commit }, params) {
  return new Promise((resolve, reject) => {
    api.get('cloudprinter/v1/setting/send-test', { params })
      .then(response => {
        resolve(response)
      })
      .catch(error => {
...
export function printErp ({ commit }, params) {
  return new Promise((resolve, reject) => {
