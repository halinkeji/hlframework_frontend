    ...
    >
      <div class="fit column no-wrap justify-between items-stretch content-stretch no-scroll">
        <div class="col-shrink bg-white q-px-xs q-pb-md  q-pa-sm">
          ...
          <div class="row">
            <q-input outlined class="col-12 col-md-5 q-mr-sm" dense v-model="searchQuery" label="可搜索:会员卡号/手机号/身份证号/真实姓名/昵称" />
            <q-select
              ...
              label="请选择会员等级"
            />
            <q-btn class="col-12 col-md-1 q-mr-sm" label="搜索" unelevated color="primary" @click="getMemberListData()" />
            <q-btn
        ...
        <div class="col-shrink bg-white q-pb-md row item-center q-pa-sm">
          ...
          <q-space />
          <q-btn class="q-px-xl q-mx-xs" label="确认" unelevated color="primary" :disable="dataListSelections.length > 0 ? false : true" @click="selectAdministrator()" />
