        ...
        },
        {
          ...
          valueGetter: (p) => {
            if (p.data.phr_hb_amount > 0) {
              return this.$q.localStorage.getItem('oneyouka_store_local').storeBaseConfig.consume_base_moneySymbol + p.data.phr_hb_amount
            }
          },
          width: this.nowpx(0.15) + 'px'
        },

        {
          ...
          valueGetter: (p) => {
            if (p.data.phr_handle_money_count > 0) {
              return this.$q.localStorage.getItem('oneyouka_store_local').storeBaseConfig.consume_base_moneySymbol + p.data.phr_handle_money_count
            }
          },
          width: this.nowpx(0.15) + 'px'
        },
        {
          ...
          valueGetter: (p) => {
            if (p.data.phr_real_money_count > 0) {
              return this.$q.localStorage.getItem('oneyouka_store_local').storeBaseConfig.consume_base_moneySymbol + p.data.phr_real_money_count
            }
          },
          width: this.nowpx(0.15) + 'px'
        },
