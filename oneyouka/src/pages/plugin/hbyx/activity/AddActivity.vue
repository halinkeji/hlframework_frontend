          ...
          <div style="overflow-y: scroll" class="fit full-height">
            <q-form ref="ruleDataRef" class="row q-pa-sm q-col-gutter-sm">
              ...
              <div class="col-12 text-red">
                ...
                {{ $q.localStorage.getItem('oneyouka_store_local').storeBaseConfig.consume_base_moneyUnit }} ，最小随机金额 30
                {{ $q.localStorage.getItem('oneyouka_store_local').storeBaseConfig.consume_base_moneyUnit }}。那么会员在领取时会领取到10 - 30
                {{ $q.localStorage.getItem('oneyouka_store_local').storeBaseConfig.consume_base_moneyUnit }}之内的随机红包。
              </div>
