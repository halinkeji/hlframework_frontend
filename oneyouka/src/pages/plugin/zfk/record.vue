  ...
  data () {
    return {
      ...
      columnDefs: [
        ...
        {
          headerName: '使用' + this.$q.localStorage.getItem('oneyouka_store_local').storeBaseConfig.consume_base_balanceUnit,
          field: 'zcl_balance_amount',
          width: this.nowpx(0.1) + 'px'
        },
        {
          headerName: '使用' + this.$q.localStorage.getItem('oneyouka_store_local').storeBaseConfig.consume_base_integralUnit,
