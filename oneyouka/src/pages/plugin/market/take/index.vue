...
export default {
  ...
  data () {
    return {
      ...
      marketLevelList: [],
      takeModeOptions: [
        { value: 'balance', label: this.$q.localStorage.getItem('oneyouka_store_local').storeBaseConfig.consume_base_balanceUnit },
        ...
        },
        {
          ...
          valueGetter: (p) => {
            if (p.data.mtr_take_mode == 'balance') {
              return this.$q.localStorage.getItem('oneyouka_store_local').storeBaseConfig.consume_base_balanceUnit
