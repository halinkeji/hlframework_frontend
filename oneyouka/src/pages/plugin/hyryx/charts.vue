      ...
      <div class="q-mt-sm q-pa-md bg-white">
        ...
        <div style="height:240px">
          ...
          ></ag-grid-vue>
            ...
            <div class="q-mt-sm q-pa-md bg-white">
        <div class="full-width text-weight-bold q-mb-md">
          会员赠送{{ $q.localStorage.getItem('oneyouka_store_local').storeBaseConfig.consume_base_integralUnit }}TOP排行榜
  ...
  methods: {
    ...
    drawLine () {
      ...
      serviceChart.setOption({
        ...
        series: [
          ...
          {
            name: '赠送' + this.$q.localStorage.getItem('oneyouka_store_local').storeBaseConfig.consume_base_integralUnit + '总额',
    ...
    exportButtonIntegral () {
      ...
      this.gridOptionsIntegral.api.exportDataAsCsv({
        fileName: date + '-会员赠送' + this.$q.localStorage.getItem('oneyouka_store_local').storeBaseConfig.consume_base_integralUnit + 'TOP排行榜'
      })
    },
    exportButtonLevel () {
      const date = this.$q_date.formatDate(new Date(), 'YYYYMMDDHHmmss')
