<template>
  <div>
    ...
    <q-btn unelevated color="primary" class="q-mr-sm" label="通过" @click="setTakeAmountData(2)" v-if="authorityMeta('editTake') && params.data.ptr_status < 2"> </q-btn>
    <q-btn unelevated color="red" label="拒绝" @click="setTakeAmountData(4)" v-if="authorityMeta('editTake') && params.data.ptr_status < 2 "> </q-btn>
  </div>
</template>
<script>
export default {
