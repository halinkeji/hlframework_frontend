          ...
          <div class="q-mt-sm row q-px-md">
            <div class="col-md-4 col-12 q-pr-md q-mt-md">
              <q-card bordered flat>
                ...
                <q-separator />
                <div class="q-ma-md">
                  启用后，会员使用{{ $q.localStorage.getItem('oneyouka_store_local').storeBaseConfig.consume_base_balanceUnit }}结账时，单笔可使用{{
                  ...
                  示例：某会员张三一共有{{ $q.localStorage.getItem('oneyouka_store_local').storeBaseConfig.consume_base_balanceUnit }}100{{
                    ...
                    $q.localStorage.getItem('oneyouka_store_local').storeBaseConfig.consume_base_moneyUnit
                  }}，则张三只能使用总{{ $q.localStorage.getItem('oneyouka_store_local').storeBaseConfig.consume_base_balanceUnit }}的（100*80%=80{{
                    $q.localStorage.getItem('oneyouka_store_local').storeBaseConfig.consume_base_moneyUnit
                  }}）。设置范围为1~100。
                </div>
                <q-input
            ...
            <div class="col-md-4 col-12 q-pr-md q-mt-md">
              <q-card bordered flat>
                ...
                <q-separator />
                <div class="q-ma-md">
                  启用后，会员使用{{ $q.localStorage.getItem('oneyouka_store_local').storeBaseConfig.consume_base_integralUnit }}结账时，单笔可使用{{
