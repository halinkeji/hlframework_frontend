      ...
      <q-form ref="typeDataRef" class="q-gutter-md">
        ...
        <div class="row q-px-sm">
          <div class="col-12 col-md-8 q-pr-xl">
            <q-input
              outlined
              dense
              v-model="typeData.wt_sort" label="排序:数字越小，排序越靠前"
              lazy-rules
            ...
            <q-select
              ...
              <q-select
                ...
                :options="[ { label: '默认', value: '1' }, { label: '首页推荐', value: '2' }, ]"
                dense
                label="请选择分类属性"
                bottom-slots
                />
            ...
            <wxmall-type-tree
              ...
              :inputLabel="'wt_name'"
              :inputValue="'id'"
              :showValue="typeData.wt_pid"
              @resetValue="typeData.wt_pid = ''"
          ...
          <div class="col-12 col-md-4 q-px-sm text-center">
            <hl-upload
              ...
              @input="(val)=>{ $nextTick(()=>{ typeData.wt_cover_image = val })}"
        ...
        <div class="row">
          <q-input
            ...
            v-model="typeData.wt_description"
            type="textarea"
            label="简介"
            />
        </div>
...
<script>
import wxmallTypeTree from '../select-tree/index.vue'
export default {
  name: 'AddType',
  components: {
    wxmallTypeTree
