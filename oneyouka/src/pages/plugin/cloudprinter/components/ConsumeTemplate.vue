              ...
              <div v-for="(item, index, key) in defaultTemplateParams">
                <div v-if="item.status">
                  <div class="text-center" v-if="index == 'logo' || index == 'qrcode'">
                    <!-- <q-img :src="`${$q.localStorage.getItem('oneyouka_system_local').attach_url}` + item.value" width="60px" height="60px">
                  ...
                  <div v-else-if="index == 'consumeOilList'">
                  ...
                  <div class="row items-start">
                    ...
                    <div class="col-3 offset-1">
                      <q-select
                        outlined
                        dense
                        v-model="templateForm.pct_page_width"
