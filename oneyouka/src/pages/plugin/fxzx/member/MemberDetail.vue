        ...
        <div class="col-3 q-pr-sm">
          <q-card flat bordered class="q-pa-lg row">
            ...
            <div>
              ...
              <div class="text-h5 text-weight-bold q-mt-sm">{{ $q.localStorage.getItem('oneyouka_store_local').storeBaseConfig.consume_base_moneySymbol }}{{ memberData.pfm_total_fxzx_amount }}</div>
            </div>
          </q-card>
        </div>
        <div class="col-3 q-px-sm">
          <q-card flat bordered class="q-pa-lg row">
            ...
            <div>
              ...
              <div class="text-h5 text-weight-bold q-mt-sm">{{ $q.localStorage.getItem('oneyouka_store_local').storeBaseConfig.consume_base_moneySymbol }}{{ memberData.pfm_take_fxzx_amount }}</div>
            </div>
          </q-card>
        </div>
        <div class="col-3 q-px-sm">
          <q-card flat bordered class="q-pa-lg row">
            ...
            <div>
              ...
              <div class="text-h5 text-weight-bold q-mt-sm">{{ $q.localStorage.getItem('oneyouka_store_local').storeBaseConfig.consume_base_moneySymbol }}{{ memberData.waitFxzxAmount }}</div>
            </div>
          </q-card>
        </div>
