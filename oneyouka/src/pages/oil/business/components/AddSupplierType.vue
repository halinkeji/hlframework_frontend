    ...
    >
      ...
      <q-form ref="oilGunRef" class="q-gutter-md">
        <q-card flat>
          <div class="row q-py-sm q-px-md q-mt-xs q-col-gutter-md">
            <div class="col-md-12 col-12 q-pt-none">
              ...
              <q-input outlined bottom-slots v-model="supplierTypeFrom.est_name" dense :rules="[(val) => !!val || '供应商分类名称是必填项']">
              </q-input>
            </div>
          </div>
        </q-card>
        <div class="row q-gutter-sm q-mt-sm justify-center ">
          ...
          <q-btn class="q-px-xl" label="保存" unelevated @click="saveData()" color="primary" />
