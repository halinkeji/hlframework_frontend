...
export default {
  ...
  created () {
    ...
    if (LocalStorage.getItem('oneyouka_plugins_local').openPlugins) {
      this.openPlugins = LocalStorage.getItem('oneyouka_plugins_local').openPlugins
    }

    if (LocalStorage.getItem('oneyouka_store_local').storeMemberConfig) {
      this.storeMemberConfig = LocalStorage.getItem('oneyouka_store_local').storeMemberConfig
    }
  },
  methods: {
    changeMemberMobile () {
