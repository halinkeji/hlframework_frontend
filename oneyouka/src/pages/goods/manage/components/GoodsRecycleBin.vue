  ...
  <div class="fit column no-wrap justify-between items-stretch content-stretch no-scroll">
    <div class="col-shrink bg-white q-px-xs q-pb-md">
      ...
      <div class="row  q-gutter-sm items-start">
        <q-input class="col-12 col-md-2 q-mt-sm" clearable outlined v-model="searchValue" label="名称/条码/助记码/简称" dense />
        ...
        <div class="col-12 col-md-2">
          <q-select class=" col-12 col-md-2" outlined option-value="value" option-label="label" emit-value map-options v-model="goodsOrService" :options="options" dense label="属性" clearable />
        </div>
        <q-btn color="primary" class=" q-mt-sm q-mx-md" unelevated @click="getGoodsRecycleBin()">搜索</q-btn>
        <q-btn color="grey-6" unelevated @click="emptySeacher()" class="q-mt-sm q-mr-md">重置</q-btn>
        <q-btn @click="exportBut" unelevated color="green" class=" q-mt-sm q-mr-md" v-if="authorityMeta('exportRecy')">全部导出</q-btn>
        <q-btn @click="batchRecovery()" unelevated color="green" v-if="authorityMeta('restoreAll')" class=" q-mt-sm q-mr-md">批量恢复</q-btn>
        <q-btn color="red" :disable="dataListSelections.length > 0 ? false : true" class=" q-mt-sm q-mr-md" unelevated v-if="authorityMeta('delAllRecy')" @click="deleteBut()">批量删除</q-btn>
      </div>
    </div>
