          ...
          <q-form ref="typeDataRef">
            <div class="row q-py-lg q-px-md q-col-gutter-md">
              <div class="col-md-6 col-12 q-pt-none">
                <div>
                  <span>排序</span>
                  <q-input outlined bottom-slots dense v-model="goodsTypeData.gt_sort" placeholder="请输入排序" :rules="[(val) => /^\d+$/.test(val) || '请输入正确的排序']"> </q-input>
                </div>
                <div>
                  <span>分类名称</span>
                  <q-input outlined bottom-slots dense v-model="goodsTypeData.gt_name" placeholder="请输入分类名称" :rules="[(val) => (val && val.length > 0) || '请设置分类名称']"> </q-input>
                </div>
                <div>
                  <span>商品属性</span>
                  <q-select
                ...
                <div class="q-mt-md">
                  ...
                  <hl-select-tree :list_width="400" @getItem="getNowItem" :dataList="goodsTypeListData" textName="分类" :inputLabel="'gt_name'" :inputValue="'id'" :showValue="goodsTypeData.gt_pid" />
                </div>
                <div class="q-mt-md">
                  <span>简介</span>
                ...
                <div class="col-md-6 col-12">
                  <hl-upload
                    ...
                    @input="(val)=>{ $nextTick(()=>{ goodsTypeData.gt_pictureUrl = val })}"
