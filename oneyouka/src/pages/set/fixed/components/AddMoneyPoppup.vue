...
export default {
  ...
  data () {
    return {
      ...
      fixedData: [
        {
          label: '增加/扣除' + this.$q.localStorage.getItem('oneyouka_store_local').storeBaseConfig.consume_base_integralUnit,
          value: '1'
        },
        {
          label: '快速消费',
        ...
        {
          label: this.$q.localStorage.getItem('oneyouka_store_local').storeBaseConfig.consume_base_balanceUnit + '扣费',
          value: '4'
        },
        {
          label: '油品收银|自助加油',
