      ...
      <div class="fit column no-wrap justify-between items-stretch content-stretch no-scroll">
        ...
        <div class="col-shrink q-pa-sm full-height bg-white q-mt-xs">
          <q-form ref="rechargeDataRef" class="row">
            <div class="col-8 col-md-4 q-px-xs">
              <q-input
                outlined
                dense
                label="排序:数字越小，排序越靠前"
            ...
            <div class="col-8 col-md-4 q-px-xs">
              <q-select
                ...
                label="充值套餐状态"
                bottom-slots
                v-model="rechargeFrom.rp_status"
                :options="rechargePackageData"
                dense
                emit-value
                map-options
              >
              ...
              <q-select
                ...
                label="套餐类别"
                bottom-slots
                v-model="rechargeFrom.rp_source_group"
                hint="不选为通用套餐，选择之后充值卡项必须与套餐类别一致"
              ...
              >
                <template v-slot:append>
                  ...
                  <span style="font-size: 14px"
                    >{{ returnRecharge }}{{ $q.localStorage.getItem('oneyouka_store_local').storeBaseConfig.consume_base_balanceUnit }}/期</span
                  >
                </template>
              </q-input>
            </div>
            <div class="col-8 col-md-3 q-px-xs">
              <q-input outlined dense @input="getConclusion()" label="分期上账规则" v-model="rechargeFrom.rp_give_money_rule_number"> </q-input>
            </div>
            <div class="col-8 col-md-3 q-px-xs">
              <q-select
                outlined
            ...
            <div class="col-8 col-md-3 q-px-xs">
              ...
              >
                <template v-slot:append>
                  <q-separator dark color="grey" class="q-mx-sm" vertical />
                  <span style="font-size: 14px"
                    >{{ returnPoint }}{{ $q.localStorage.getItem('oneyouka_store_local').storeBaseConfig.consume_base_integralUnit }}/期</span
                  >
                </template>
              </q-input>
            </div>
            ...
            <div class="col-8 col-md-3 q-px-xs">
              <q-input outlined dense @input="getConclusion()" label="分期上账规则" v-model="rechargeFrom.rp_give_points_rule_number"> </q-input>
            </div>
            <div class="col-8 col-md-3 q-px-xs">
              <q-select
                outlined
            ...
            <div class="q-mt-lg">
              合 计 : <span class="text-h6 text-negative"> {{ rechargeSum }} </span>
              {{ $q.localStorage.getItem('oneyouka_store_local').storeBaseConfig.consume_base_balanceUnit }}，赠 送
              <span class="text-h6 text-negative"> {{ rechargeFrom.rp_give_points }} </span
...
export default {
  ...
  data () {
    return {
      ...
      sourceGroupOptions: this.$store.state.components.balanceGroupData
    }
  },
  created () {
