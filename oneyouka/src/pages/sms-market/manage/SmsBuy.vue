            ...
            <q-item>
              <q-item-section avatar>
                <q-avatar v-if="localLibInfo.logoData && localLibInfo.logoData.id">
                  <img :src="$q.localStorage.getItem('oneyouka_system_local').attach_url + localLibInfo.logoData.path" />
                </q-avatar>
...
export default {
  ...
  created () {
    if (LocalStorage.getItem('oneyouka_account_info')) {
      const headerLocalInfo = LocalStorage.getItem('oneyouka_account_info')
