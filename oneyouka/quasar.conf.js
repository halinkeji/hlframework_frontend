...
module.exports = function (ctx) {
  return {
    ...
    pwa: {
      ...
      manifest: {
        name: 'hlframework frontend web oneyouka',
        short_name: 'hlframework frontend web oneyouka',
        description: 'hlframework frontend web oneyouka',
        display: 'standalone',
    ...
    electron: {
      ...
      builder: {
        ...
        appId: 'hlframework_frontend_web_oneyouka'
