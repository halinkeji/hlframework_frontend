...
export function getGoodsInfo ({ commit }, params) {
  return new Promise((resolve, reject) => {
    api.get(`${siteUrl}/api/v1/cloud-goods/get-code-data`, { params })
      .then(response => {
        resolve(response)
      })
      .catch(error => {
...
export function getListData ({ commit }, item) {
  return new Promise((resolve, reject) => {
    api.get('v1/goods/componentgoods', { params: item })
      .then((response) => {
        resolve(response)
      })
      .catch((error) => { reject(error) })
...
export function checkout ({ commit }, item) {
  return new Promise((resolve, reject) => {
    api.post('v1/work/checkout', item)
      .then((response) => {
        resolve(response)
      })
      .catch((error) => { reject(error) })
...
export function getListErpData ({ commit }, item) {
  return new Promise((resolve, reject) => {
    api
      .get('v1/goods/goodserp', { params: item })
      .then(response => {
        resolve(response)
      })
      .catch(error => {
...
export function checkoutPlugin ({ commit }, item) {
  return new Promise((resolve, reject) => {
    api.post('v1/work/checkout-plugin', item)
      .then((response) => {
        resolve(response)
      })
      .catch((error) => { reject(error) })
...
export function getGoodsListData ({ commit }, params) {
  return new Promise((resolve, reject) => {
    api.get('v1/goods/goods-lists', { params })
      .then((response) => {
        resolve(response)
      })
      .catch((error) => { reject(error) })
...
export function getDepotGoods ({ commit }, params) {
  return new Promise((resolve, reject) => {
    api
      .get('v1/erpnumber/depot-goods-number', { params })
      .then(response => {
        resolve(response)
      })
      .catch(error => {
