...
export function delUserInfo ({ commit }, item) {
  return new Promise((resolve, reject) => {
    api.delete(`v1/user/delete?id=${item}`)
      .then((response) => {
        resolve(response)
      })
      .catch((error) => {
...
export function getUserExtend ({ commit }, params) {
  return new Promise((resolve, reject) => {
    api.get('v1/user/get-user-extend', { params })
      .then((response) => {
        resolve(response)
      })
      .catch((error) => {
...
export function setUserExtend ({ commit }, params) {
  return new Promise((resolve, reject) => {
    api.post('v1/user/set-user-extend', params)
      .then((response) => {
        resolve(response)
      })
      .catch((error) => {
...
export function getUserItem ({ commit }, params) {
  return new Promise((resolve, reject) => {
    api.get('v1/user/get-user-info', { params })
      .then((response) => {
        resolve(response)
      })
      .catch((error) => {
...
export function setUserItem ({ commit }, params) {
  return new Promise((resolve, reject) => {
    api.post('v1/user/set-user-info', params)
      .then((response) => {
        resolve(response)
      })
      .catch((error) => {
...
export function getMobileUserInfo ({ commit }, params) {
  return new Promise((resolve, reject) => {
    api.get('v1/user/get-mobile-user-info', { params })
      .then((response) => {
        resolve(response)
      })
      .catch((error) => {
...
export function getUnSaasUserList ({ commit }, params) {
  return new Promise((resolve, reject) => {
    api.get('v1/user/get-un-saas-user-list', { params })
      .then((response) => {
        resolve(response)
      })
      .catch((error) => {
