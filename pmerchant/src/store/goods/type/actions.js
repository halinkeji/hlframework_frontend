...
export function getTreeList ({ commit }, item) {
  return new Promise((resolve, reject) => {
    api
      .get('v1/goods-type/tree', { params: item })
      .then((response) => {
        resolve(response)
      })
      .catch((error) => {
...
export function getItem ({ commit }, itemId) {
  return new Promise((resolve, reject) => {
    api.get('v1/goods-type/view?id=' + itemId)
      .then((response) => {
        resolve(response)
      })
      .catch((error) => {
...
export function delData ({ commit }, item) {
  return new Promise((resolve, reject) => {
    let apiUrl = 'v1/goods-type/delete?id='
    apiUrl += (item)
...
export function getAllData ({ commit }, params) {
  return new Promise((resolve, reject) => {
    api
      .get('v1/goods-type/lists', { params })
      .then((response) => {
        resolve(response)
      })
      .catch((error) => {
