...
export function delData ({ commit }, item) {
  return new Promise((resolve, reject) => {
    const apiUrl = 'v1/goods-tag/alldel'
...
export function getItemData ({ commit }, item) {
  return new Promise((resolve, reject) => {
    const apiUrl = 'v1/goods-tag/view?id=' + item
...
export function getBindListData ({ commit }, params) {
  return new Promise((resolve, reject) => {
    const apiUrl = 'v1/goods-tag/bind-list'
...
export function setBindData ({ commit }, params) {
  return new Promise((resolve, reject) => {
    const apiUrl = 'v1/goods-tag/set-bind'
...
export function delBindData ({ commit }, item) {
  return new Promise((resolve, reject) => {
    const apiUrl = 'v1/goods-tag/del-bind-data'
