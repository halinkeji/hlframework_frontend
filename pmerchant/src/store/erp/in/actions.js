...
export function delData ({ commit }, item) {
  return new Promise((resolve, reject) => {
    let apiUrl = 'v1/erp-in/delete?id='
    apiUrl += item
    api
      .delete(apiUrl, item)
      .then(response => {
...
export function getGoodsBuf ({ commit }, item) {
  return new Promise((resolve, reject) => {
    api
      .get('v1/erp-in/buttfer', { params: item })
      .then((response) => {
        resolve(response)
      })
      .catch((error) => {
...
export function getThData ({ commit }, item) {
  return new Promise((resolve, reject) => {
    api
      .get('v1/erp-out/outdata', { params: item })
      .then(response => {
        resolve(response)
      })
      .catch(error => {
...
export function settleInvoice ({ commit }, parasm) {
  return new Promise((resolve, reject) => {
    api.post('v1/erp-in/settle', parasm)
      .then(response => {
        resolve(response)
      })
      .catch(error => {
