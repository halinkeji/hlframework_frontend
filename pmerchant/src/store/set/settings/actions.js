...
export function addPrefix ({ commit }, item) {
  return new Promise((resolve, reject) => {
    api
      .post('v1/settings/addprefix', item)
      .then((response) => {
        resolve(response)
      })
      .catch((error) => {
...
export function getConsumeSet ({ commit }, item) {
  return new Promise((resolve, reject) => {
    api
      .post('v1/settings/consumeset', item)
      .then((response) => {
        resolve(response)
      })
      .catch((error) => {
...
export function getErpSet ({ commit }, params) {
  return new Promise((resolve, reject) => {
    api
      .get('v1/settings/get-erp-set', { params })
      .then((response) => {
        resolve(response)
      })
      .catch((error) => {
...
export function addErpSet ({ commit }, item) {
  return new Promise((resolve, reject) => {
    api
      .post('v1/settings/add-erp-set', item)
      .then((response) => {
        resolve(response)
      })
      .catch((error) => {
...
export function getParams ({ commit }, params) {
  return new Promise((resolve, reject) => {
    api
      .get('v1/settings/get-params', { params })
      .then((response) => {
        resolve(response)
      })
      .catch((error) => {
...
export function setPayChannel ({ commit }, item) {
  return new Promise((resolve, reject) => {
    api
      .post('v1/settings/set-pay-channel', item)
      .then((response) => {
        resolve(response)
      })
      .catch((error) => {
...
export function getPayChannel ({ commit }, params) {
  return new Promise((resolve, reject) => {
    api
      .get('v1/settings/get-pay-channel', { params })
      .then((response) => {
        resolve(response)
      })
      .catch((error) => {
...
export function getSuperModel ({ commit }, params) {
  return new Promise((resolve, reject) => {
    api
      .get('v1/settings/get-super-model', { params })
      .then((response) => {
        resolve(response)
      })
      .catch((error) => {
...
export function setSuperModel ({ commit }, params) {
  return new Promise((resolve, reject) => {
    api
      .post('v1/settings/set-super-model', params)
      .then((response) => {
        resolve(response)
      })
      .catch((error) => {
...
export function getApplyListData ({ commit }, params) {
  return new Promise((resolve, reject) => {
    const apiUrl = 'v1/settings/get-apply-list-data'
...
export function getAllStore ({ commit }, params) {
  return new Promise((resolve, reject) => {
    const apiUrl = 'v1/settings/get-all-store'
    api.get(apiUrl, { params })
      .then((response) => {
        resolve(response)
      })
...
export function getWxappQrcode ({ commit }, params) {
  return new Promise((resolve, reject) => {
    api
      .get('v1/settings/get-wxapp-qrcode', { params })
      .then((response) => {
        resolve(response)
      })
      .catch((error) => {
