...
export function getMembertagCount ({ commit }, params) {
  return new Promise((resolve, reject) => {
    api
      .get('v1/member-tag/count', { params })
      .then(response => {
        resolve(response)
      })
      .catch(error => {
...
export function getItemData ({ commit }, item) {
  return new Promise((resolve, reject) => {
    const apiUrl = 'v1/member-tag/view?id=' + parseInt(item)
...
export function delData ({ commit }, item) {
  return new Promise((resolve, reject) => {
    let apiUrl = 'v1/member-tag/delete?id='
    apiUrl += item
    api
      .delete(apiUrl)
      .then(response => {
...
export function getAllTag ({ commit }, params) {
  return new Promise((resolve, reject) => {
    const apiUrl = 'v1/member-tag/all-list'
    api
      .get(apiUrl, { params })
      .then(response => {
        resolve(response)
