  ...
  <q-page class="fit">
    <div class="fit column no-wrap justify-between items-stretch content-stretch no-scroll">
      <div class="q-gutter-x-xs row col-shrink bg-white q-px-xs q-pb-md">
        <q-input class=" col-12 col-md-2 q-mt-sm" outlined v-model="receipt" label="付款单据号/购货单据号" dense />
        ...
        <q-btn-dropdown color="primary" class=" q-mt-sm" unelevated label="新增付款">
          <q-list>
