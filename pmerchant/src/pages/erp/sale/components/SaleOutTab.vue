  ...
  <div class="fit column no-wrap justify-between items-stretch content-stretch no-scroll">
    <div class="col-shrink bg-white q-px-xs q-pb-md">
      <div class="q-gutter-xs row">
        ...
        <q-btn color="primary" unelevated @click="exprotCsv" label="导出Csv文件" :disable="returnGoodsListData.length == 0" />
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    rowSpan (params) {
      const fields = ['gii_inventoryInCode', 'created_at', 'gii_note', 'gii_returnAmount', 'gii_returnQuantity']
