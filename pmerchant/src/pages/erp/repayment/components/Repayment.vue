  ...
  <q-page class="fit">
    <div class="fit column no-wrap justify-between items-stretch content-stretch no-scroll">
      <div class="q-gutter-x-xs row col-shrink bg-white q-px-xs q-pb-md">
        <q-input class=" col-12 col-md-2 q-mt-sm" outlined v-model="receipt" label="收款单据号/销货单据号" dense />
        <q-select class=" col-12 col-md-2 q-mt-sm" outlined option-value="id" option-label="ecp_name" emit-value map-options v-model="clientId" :options="clientList" dense label="客户" />
        <q-select class=" q-mt-sm col-12 col-md-2" outlined option-value="id" option-label="type" emit-value map-options v-model="payTypeId" :options="payType" dense label="付款类型" />
        ...
        <q-btn color="primary" class=" q-mt-sm" unelevated label="搜索" @click="getReceiptList()" />
        <q-btn color="warning" class=" q-mt-sm" unelevated label="重置" @click="clearBut()" />
        <q-btn-dropdown color="primary" class=" q-mt-sm" unelevated label="新增收款">
          <q-list>
