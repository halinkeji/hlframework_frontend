        ...
        <div class="row q-col-gutter-md q-pa-sm">
          ...
          <div class="col-6 col-md-3">
            <q-card flat bordered class="text-white  q-mt-sm">
              ...
              <q-separator />
              <div class="text-h4 text-grey-8 text-center q-my-lg">
                {{ $q.localStorage.getItem('pmerchant_store_local').storeBaseConfig.consume_base_moneySymbol }}{{ formatAmount(erpTotal.clientMoney) }}/{{ $q.localStorage.getItem('pmerchant_store_local').storeBaseConfig.consume_base_moneySymbol }}{{ formatAmount(erpTotal.clientArrears) }}
              </div>
            </q-card>
          </div>
          <div class="col-6 col-md-3">
            <q-card flat bordered class="text-white  q-mt-sm">
              ...
              <q-separator />
              <div class="text-h4 text-grey-8 text-center q-my-lg">
                {{ $q.localStorage.getItem('pmerchant_store_local').storeBaseConfig.consume_base_moneySymbol }}{{ formatAmount(erpTotal.supplierMoney) }}/{{ $q.localStorage.getItem('pmerchant_store_local').storeBaseConfig.consume_base_moneySymbol }}{{ formatAmount(erpTotal.supplierArrears) }}
              </div>
            </q-card>
          </div>
          ...
          <div class="col-6 col-md-3">
            <q-card flat bordered class="text-white  q-mt-sm">
              ...
              <q-separator />
              <div class="text-h4 text-grey-8 text-center q-my-lg">
                {{ formatAmount(erpTotal.inNumber) }}/{{ $q.localStorage.getItem('pmerchant_store_local').storeBaseConfig.consume_base_moneySymbol }}{{ formatAmount(erpTotal.inMoney) }}
              </div>
            </q-card>
          </div>
          <div class="col-6 col-md-3">
            <q-card flat bordered class="text-white  q-mt-sm">
              ...
              <q-separator />
              <div class="text-h4 text-grey-8 text-center q-my-lg">
                {{ formatAmount(erpTotal.saleNumber) }}/{{ $q.localStorage.getItem('pmerchant_store_local').storeBaseConfig.consume_base_moneySymbol }}{{ formatAmount(erpTotal.saleMoney) }}
              </div>
            </q-card>
          </div>
          <div class="col-6 col-md-3">
            <q-card flat bordered class="text-white  q-mt-sm">
              ...
              <q-separator />
              <div class="text-h4 text-grey-8 text-center q-my-lg">
                {{ formatAmount(erpTotal.comsumeNumber) }}/{{ $q.localStorage.getItem('pmerchant_store_local').storeBaseConfig.consume_base_moneySymbol }}{{ formatAmount(erpTotal.consumeMoney) }}
              </div>
            </q-card>
          </div>
          <div class="col-6 col-md-3">
            <q-card flat bordered class="text-white  q-mt-sm">
              ...
              <q-separator />
              <div class="text-h4 text-grey-8 text-center q-my-lg">
                {{ formatAmount(erpTotal.comsumeReturnNumber) }}/{{ $q.localStorage.getItem('pmerchant_store_local').storeBaseConfig.consume_base_moneySymbol
