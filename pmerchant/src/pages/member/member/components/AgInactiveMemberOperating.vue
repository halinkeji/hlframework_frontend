<template>
  <div>
    <q-btn @click="editRecord" color="primary" class="q-ml-sm" v-if="authorityMeta('edit')">激活</q-btn>
    <q-btn @click="delBut" color="red" class="q-ml-sm" v-if="authorityMeta('del')">删除</q-btn>
  </div>
</template>
<script>
export default {
