    ...
    <div class="col-shrink bg-white q-px-xs q-py-sm">
      <div class="row q-gutter-sm">
        <div class="col-12 col-md-2">
          <q-input clearable label="请输入单据号" outlined v-model="searchFrom.searchSerm" dense />
        </div>
        <div class="col-12 col-md-2">
          <q-input clearable v-if="!memberId" label="请输入会员卡号|姓名" outlined v-model="searchFrom.memberText" dense />
        </div>
        ...
        <q-btn @click="exportBut()" v-if="searchFrom.member_id == 0" color="red" unelevated label="导出" />
      </div>
    </div>
  ...
  data () {
    return {
      ...
      columnDefs: [
        ...
        {
          headerName: '变更' + this.$q.localStorage.getItem('pmerchant_store_local').storeBaseConfig.consume_base_integralUnit,
        ...
        {
          headerName: this.$q.localStorage.getItem('pmerchant_store_local').storeBaseConfig.consume_base_integralUnit + '来源',
        ...
        {
          headerName: this.$q.localStorage.getItem('pmerchant_store_local').storeBaseConfig.consume_base_integralUnit + '状态',
  ...
  methods: {
    ...
    exportBut () {
      ...
      this.gridOptions.api.exportDataAsCsv({
        fileName: date + '-' + this.$q.localStorage.getItem('pmerchant_store_local').storeBaseConfig.consume_base_integralUnit + '记录'
      })
    }
  }
}
