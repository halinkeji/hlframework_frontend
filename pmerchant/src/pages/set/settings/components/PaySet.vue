          ...
          <div class="col-4">
            <q-card flat bordered>
              <q-card-section>
                ...
                <div class="text-caption">默认开启所有支付方式。注意：此处支付方式没有实际支付能力，仅做为账务单据支付方式分类统计使用。</div>
              </q-card-section>
          ...
          <div class="col-4">
            <q-card flat bordered>
              <q-card-section>
                ...
                <div class="text-caption text-primary">关联收款商户：{{ payMchRelation.mch_name }}</div>
                ...
                <q-item :key="'extend-' + key" v-for="(item, key) in hlpayChannel">
                  ...
                  <q-item-section>
                    <div class="row justify-center">
                      <q-img :src="item.iconImage && item.iconImage.id ? $q.localStorage.getItem('pmerchant_system_local').attach_url + item.iconImage.path : ''" ratio="1" width="40px">
            ...
            <q-card flat bordered>
              <q-card-section>
                ...
                <div class="text-caption">
                  默认为空，设置后会在收银台与单据列表、详情等相关位置进行展示。注意：此处支付方式没有实际支付能力，仅做为账务单据支付方式分类统计使用。支付方式只能新增、开启禁用，不能删除。
                </div>
              </q-card-section>
              <q-list separator bordered padding>
