    ...
    <div class="fit column no-wrap justify-between items-stretch content-stretch no-scroll">
      <div class="col-shrink bg-white q-px-xs q-pb-md">
        <div class="row q-gutter-x-xs ">
          <q-input clearable outlined dense class="col-12 col-md-2 q-mt-sm" v-model="groupForm.groupName" label="名称" />
          <q-select clearable outlined dense class="col-12 col-md-2 q-mt-sm" v-model="groupForm.groupStatus" :options="groupStatus" label="状态" option-label="label" map-options emit-value />
          ...
          <q-btn color="primary" unelevated class="col-12 col-md-1 q-mt-sm" :to="{ name: 'addTiming' }" label="新增" />
          <q-btn color="red" unelevated class="col-12 col-md-1 q-mt-sm" :disable="dataListSelections.length > 0 ? false : true" @click="deleteTiming" label="批量删除" />
        </div>
      </div>
