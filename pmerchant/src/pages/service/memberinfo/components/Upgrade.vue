...
export default {
  ...
  methods: {
    ...
    init (val) {
      if (val && val.id && val.level_id > 0) {
        this.currentMemberCardLevelId = val.level_id
        this.getLevelData()
        this.mPmerchantId = val.m_pmerchant_id
    ...
    saveBut () {
      const obj = {
        m_pmerchant_id: this.mPmerchantId,
        level_id: this.memberCardLevelId,
