  ...
  <q-page class="fit">
    <div class="fit column no-wrap justify-between items-stretch content-stretch no-scroll">
      ...
      <div class="col-shrink bg-white q-pa-sm full-height q-mt-xs" v-show="activeTab == 2">
        <document-management :mPmerchantId="userData.m_pmerchant_id" ref="documentManagementRef"></document-management>
      </div>
      ...
      <div class="col-shrink bg-white full-height q-mt-xs" v-if="activeTab == 'hlcoupon'">
        <coupon-list :mPmerchantId="userData.m_pmerchant_id"></coupon-list>
      </div>
      ...
      <div class="col-shrink bg-white full-height q-mt-xs" v-if="activeTab == 'growRecord'">
        <grow-record :mPmerchantId="userData.m_pmerchant_id" ref="memberGrowRecord" />
      </div>
      <div class="col-shrink bg-white full-height" v-if="activeTab == 'upgradeList'">
        <upgrade-record :mPmerchantId="userData.m_pmerchant_id"  />
      </div>
    </div>
  </q-page>
</template>
...
export default {
  ...
  mounted () {
    if (this.$route.query.phone_number) {
      this.$refs.memberCardReading.setNumberCardReader(this.$route.query.phone_number)
    }
  },
  created () {
