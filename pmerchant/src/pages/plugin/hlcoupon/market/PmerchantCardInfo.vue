<template>
  <q-dialog @hide="closeCardInfoDialog" v-model="addStoreSidebar" persistent>
    <q-card
      :style="{
        width: parseInt(this.$q.screen.width) + 'px',
        'max-width': parseInt(this.$q.screen.width) + 'px',
        height: parseInt(this.$q.screen.width * 0.7) + 'px',
      }"
      class="q-pa-sm"
    >
      <div class="fit column no-wrap justify-between items-stretch content-stretch no-scroll">
        <div class="row col-shrink bg-white q-px-xs q-py-xs">
          <div class="text-subtitle2">平台卡券推广记录</div>
          <q-space />
        ...
        <div class="row col-shrink bg-white q-px-xs q-pb-md q-gutter-sm">
          <div class="col">
            <q-item class="bg-grey-2">
              <q-item-section>
                <q-item-label>商家推广单价</q-item-label>
              </q-item-section>

              <q-item-section>
                <q-item-label class="text-subtitle1 text-weight-bold text-primary text-right">{{ formatAmount(rowData.pc_service_money / rowData.pc_market_quantity) }}</q-item-label>
              </q-item-section>
            </q-item>
          </div>
          ...
          <div class="col">
            <q-item class="bg-grey-2">
              ...
              <q-item-section>
                <q-item-label class="text-subtitle1 text-weight-bold text-primary text-right">{{ formatAmount(rowData.pc_market_quantity) }}</q-item-label>
              </q-item-section>
            </q-item>
          </div>
          ...
          <div class="col">
            <q-item class="bg-grey-2">
              ...
              <q-item-section>
                <q-item-label class="text-subtitle1 text-weight-bold text-primary text-right">{{ formatAmount(rowData.pc_service_money - (rowData.pc_market_money * rowData.pc_market_quantity)) }}</q-item-label>
              </q-item-section>
            </q-item>
          </div>
          ...
          <div class="col">
            <q-item class="bg-grey-2">
              <q-item-section>
                <q-item-label>商家推广剩余数量</q-item-label>
              </q-item-section>

              <q-item-section>
                <q-item-label class="text-subtitle1 text-weight-bold text-primary text-right">{{ formatAmount(rowData.pc_market_last_quantity) }}</q-item-label>
              </q-item-section>
            </q-item>
          </div>
           ...
           <div class="col">
            <q-item class="bg-grey-2">
              <q-item-section>
                <q-item-label>已推广数量</q-item-label>
              </q-item-section>

              <q-item-section>
                <q-item-label class="text-subtitle1 text-weight-bold text-primary text-right">{{ formatAmount(rowData.pc_market_quantity - rowData.pc_market_last_quantity) }}</q-item-label>
              </q-item-section>
            </q-item>
          </div>
          ...
          <div class="col">
            <q-item class="bg-grey-2">
              <q-item-section>
                <q-item-label>平台推广单价</q-item-label>
              </q-item-section>

              <q-item-section>
                <q-item-label class="text-subtitle1 text-weight-bold text-primary text-right">{{ formatAmount(rowData.pc_market_money) }}</q-item-label>
              </q-item-section>
            </q-item>
          </div>
          ...
          <div class="col">
            <q-item class="bg-grey-2">
              <q-item-section>
                <q-item-label>平台利润</q-item-label>
              </q-item-section>
