<template>
  <div class="fit column no-wrap justify-between items-stretch content-stretch no-scroll">
    ...
    <check-coupon-status v-if="checkDialogStatus" @closeDialog="closeCheckDialog" ref="checkCouponDialogRef" />
  </div>
</template>
<script>
import AgOperating from './AgOperating.vue'
import CheckCouponStatus from './CheckCouponStatus.vue'
...
export default {
  ...
  methods: {
    ...
    clickCheckCouponStatus (marketItem) {
      this.checkDialogStatus = true

      this.$nextTick(() => {
        this.$refs.checkCouponDialogRef.init(marketItem)
      })
    },
