      ...
      <div class="col-shrink bg-white q-px-xs q-py-sm">
        <div class="q-gutter-xs row ">
          <div  class="col-12 col-md-2 ">
            <q-input outlined v-model="searchQuery" label="请输入接收手机号" dense />
          </div>

          <div  class="col-12 col-md-2 ">
            <q-select  outlined v-model="sendStatus" :options="mode" option-value="value" option-label="label" emit-value map-options dense label="请选择发送状态" />
