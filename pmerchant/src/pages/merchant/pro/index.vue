    ...
    <div class="fit column no-wrap justify-between items-stretch content-stretch no-scroll">
      <div class="col-shrink bg-white q-px-xs q-py-md">
        <div class="row q-gutter-xs">
          ...
          <!-- <q-btn @click="openApplyStore" color="primary" unelevated label="邀请商家"> </q-btn> -->
        </div>
      </div>
      ...
      <div class="col-shrink q-px-xs full-height bg-grey-2">
        <ag-grid-vue
          ref="agGridTable"
          class="ag-theme-balham pro-merchant-list ag-grid-table hl_header_center hl_content_center full-height"
      ...
      <apply-join
        ref="applyJoinDialogRef"
        v-if="joinDialogStatus"
        @closeDialog="
...
import ApplyJoin from '../ApplyJoin.vue'
...
export default {
  ...
  data () {
    return {
      ...
      columnDefs: [
        ...
        {
          headerName: '商家营业总额',
          field: 'totalTurnoverCount'
        },

        {
          headerName: '账户总金额', // 总金额 可用 + 冻结
          field: 'accountTotalAmount'
        },

        {
          headerName: '可用金额', // 可用金额 未结算 满足T+1或T+0 条件
          field: 'accountUseAmount'
        },

        {
          headerName: '未结算提现订单', // 结算中 挂起
          field: 'accountWithdrawAmount'
        },

        {
          headerName: '冻结金额', // 冻结 未满足T+1或T+0 条件
          field: 'accountFreezeAmount'
        },

        {
          headerName: '花销汇总',
          field: 'totalExpendCount'
        },

        {
          headerName: '服务套餐',
          field: 'productInfo.title'
        },
  ...
  methods: {
    ...
    openApplyStore () {
      this.joinDialogStatus = true
      this.$nextTick(() => {
        this.$refs.applyJoinDialogRef.init()
      })
    }
  }
}
...
<style>
.pro-merchant-list .cell-span-is-main {
  background: white;
