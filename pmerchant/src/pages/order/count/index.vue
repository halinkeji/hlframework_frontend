    ...
    <div class="fit column no-wrap justify-between items-stretch content-stretch no-scroll">
      ...
      <div class="col-shrink q-pa-sm full-height bg-white q-mt-xs">
        <q-scroll-area class="fit full-height">
          ...
          <div class="row" v-if="totalCount && totalCount.length > 0">
            <div class="q-px-sm col q-pt-sm" v-for="(item, key) in totalCount" :key="key">
...
export default {
  ...
  methods: {
    ...
    getchartsData () {
      ...
      this.$store
        .dispatch('financeManage/getCountCharts', params)
        .then((res) => {
          if (res.code == 200) {
