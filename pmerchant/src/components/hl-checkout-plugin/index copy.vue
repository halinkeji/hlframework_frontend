          ...
          <div class="col-12 col-md-5 q-pa-xs">
            ...
            <div class="row justify-between">
              ...
              >
                ...
                <div class="text-red" v-if="v.key == 'rechargePay'">当前{{ $q.localStorage.getItem('pmerchant_store_local').storeBaseConfig.consume_base_balanceUnit }} : {{ memberInfo.mem_memberMoneyCount }} 赠送{{ $q.localStorage.getItem('pmerchant_store_local').storeBaseConfig.consume_base_integralUnit }}:{{ useMoneyGivePoint }}</div>
                <div class="text-red" v-if="v.key == 'pointPay'">
                  当前{{ $q.localStorage.getItem('pmerchant_store_local').storeBaseConfig.consume_base_integralUnit }} : {{ memberInfo.mem_memberPointsCount }} 使用{{ $q.localStorage.getItem('pmerchant_store_local').storeBaseConfig.consume_base_integralUnit }} :
                  {{ useDiscountPoint }}
                </div>
