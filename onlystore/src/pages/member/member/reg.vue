...
export default {
  ...
  created () {
    ...
    if (LocalStorage.getItem('onlystore_plugins_local').openPlugins) {
      this.openPlugins = LocalStorage.getItem('onlystore_plugins_local').openPlugins
    }

    if (LocalStorage.getItem('onlystore_store_local').storeMemberConfig) {
      this.storeMemberConfig = LocalStorage.getItem('onlystore_store_local').storeMemberConfig
    }
  },
  methods: {
    changeMemberMobile () {
