<template>
  <div class="fit column no-wrap justify-between items-stretch content-stretch no-scroll">
    <div class="col-shrink bg-white  q-pb-md q-pt-xs row q-gutter-sm q-px-xs">
      <div class="col-12 col-md-2">
        <q-input label="单据号" outlined v-model="receiptNum" dense />
      </div>

      <q-btn @click="getDatalist()" color="primary" unelevated label="搜索" />
      <q-btn @click="restButton" color="warning" unelevated label="重置" />
    </div>
  ...
  data () {
    return {
      ...
      columnDefs: [
        ...
        {
          headerName: '总赠送' + this.$q.localStorage.getItem('onlystore_store_local').storeBaseConfig.consume_base_integralUnit,
          field: 'invoice_code',
          width: 150,
          rowSpan: this.rowSpan,
          cellClassRules: {
        ...
        {
          headerName: '总赠送' + this.$q.localStorage.getItem('onlystore_store_local').storeBaseConfig.consume_base_integralUnit + '期数',
          field: 'invoice_code',
          width: 150,
          rowSpan: this.rowSpan,
          cellClassRules: {
        ...
        {
          headerName: '赠送' + this.$q.localStorage.getItem('onlystore_store_local').storeBaseConfig.consume_base_integralUnit + '期数',
