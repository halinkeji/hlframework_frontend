...
export default {
  ...
  methods: {
    ...
    getAddressInfo (val) {
      if (val.province) {
        this.dataFrom.province = val.province
      }
      if (val.city) {
        this.dataFrom.city = val.city
      }
      if (val.district) {
        this.dataFrom.district = val.district
      }
      if (val.province_code) {
        this.dataFrom.province_code = val.province_code
      }
      if (val.city_code) {
        this.dataFrom.city_code = val.city_code
      }
      if (val.district_code) {
        this.dataFrom.district_code = val.district_code
      }
      if (val.address) {
        this.dataFrom.address = val.address
      }
      if (val.lat) {
        this.dataFrom.lat = val.lat
      }
      if (val.lng) {
        this.dataFrom.lng = val.lng
      }
    }
  }
}
