                ...
                <div class="col-md-6 col-12 row q-col-gutter-sm">
                  <div class="col-12">
                    <q-input
                      label="充次套餐名称"
                      outlined
                      v-model="recPackageInfo.grp_name"
                      dense
                      lazy-rules
                      :rules="[(val) => !!val || '套餐名称是必填的']"
                    >
                    </q-input>
                  </div>
                  ...
                  <!-- <div class="col-md-6 col-12 q-pl-xs">
                    <q-select
                      ...
                      emit-value
                      map-options
                      v-model="recPackageInfo.grp_property"
                      :options="[
                        { label: '否', value: '0' },
                        { label: '是', value: '1' },
                      ]"
                  ...
                  <div class="col-12">
                    <q-item class="full-width">
                      ...
                      <q-item-section>
                        <q-option-group
                          v-model="recPackageInfo.grp_timeType"
                    ...
                    <div class="row q-gutter-sm" v-if="parseInt(recPackageInfo.grp_timeType) == 3">
                      <div class="col">
                        <q-input outlined v-model="recPackageInfo.grp_startTime" label="开始时间" dense lazy-rules :error="false" readonly>
                      ...
                      <div class="col">
                        <q-input outlined v-model="recPackageInfo.grp_endTime" label="结束时间" dense lazy-rules :error="false" readonly>
                          <template v-slot:prepend>
                            <q-icon name="event" class="cursor-pointer">
                              <q-menu square :offset="[12, 10]" transition-show="jump-down" transition-hide="jump-up">
                    ...
                    <div class="row q-gutter-sm" v-if="parseInt(recPackageInfo.grp_timeType) == 2">
                      <div class="col">
                        <q-input v-model="recPackageInfo.grp_startTime" outlined label="即日起:" dense @change="changeStartTime"> </q-input>
                      </div>
                      <div class="col">
                        <q-select
                          outlined
                  ...
                  <div class="col-md-2 col-12 q-pl-sm">
                    <hl-upload
                      ...
                      @input="
                        (val) => {
                          $nextTick(() => {
                            recPackageInfo.grp_coverImage = val;
                          });
                        }
                      "
