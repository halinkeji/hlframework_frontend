...
export default {
    ...
    return {
      ...
      columnDefs: [
        // 表格列数据
        {
          ...
          field: 'wc_channel',
          valueGetter: (p) => {
            return this.channelObject[p.data.api_channel]
          }
        },
        {
          headerName: '渠道标识',
        ...
        },
        {
          ...
          field: 'make',
          filter: false,
          cellRendererFramework: 'AgLogOperate',
          width: 180
        }
      ],
      defaultColDef: {
  ...
  methods: {
    ...
    getList () {
      ...
      this.$store
        .dispatch('wuliuapi/getLogDataList', obj)
        .then((res) => {
          if (res.code == 200) {
