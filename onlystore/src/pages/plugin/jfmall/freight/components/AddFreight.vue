                ...
                <div class="row q-mt-md full-width" v-if="detailFrom.length > 0">
                  <div class="row text-center full-width">
                    ...
                    <div class="col-2 q-pa-xs">
                      首费（{{ $q.localStorage.getItem('onlystore_store_local').storeBaseConfig.consume_base_moneyUnit }}）
                    </div>
                    <div class="col-2 q-pa-xs">续件数（件）</div>
                    <div class="col-2 q-pa-xs">
                      续费（{{ $q.localStorage.getItem('onlystore_store_local').storeBaseConfig.consume_base_moneyUnit }}）
                    </div>
                  </div>
                  <q-separator />
