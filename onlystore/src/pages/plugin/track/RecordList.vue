  ...
  <div class="fit column no-wrap justify-between items-stretch content-stretch no-scroll">
    <div class="col-shrink bg-white q-px-xs q-pb-md q-gutter-x-xs row">
      <div class="col-md-2 col-12">
        <q-input v-if="!currentMemberId" label="可搜索:会员卡号/手机号/真实姓名/昵称" outlined v-model="member" dense />
      </div>

      <div class="col-md-2 col-12">
        <q-input label="可搜索:日志标题" outlined v-model="searchQuery" dense />
      </div>

      <q-btn color="primary" unelevated label="搜索" @click="getListData" />
      <q-btn color="warning" unelevated label="重置" @click="restButton" />

      <q-btn color="primary" unelevated label="新增" v-if="currentMemberId" @click="setTrackData(currentMemberId, null)" />
      <q-space />
    </div>
