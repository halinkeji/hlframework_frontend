      ...
      <div class="col-shrink q-pa-sm full-height bg-white q-mt-xs" v-if="scalesTab == 'dingjian'">
        <q-scroll-area class="fit full-height">
            ...
            <div class="row justify-center">
              <q-list bordered class="col-4">
                <q-item clickable>
                  <q-item-section>
                    <q-item-label
                      >称重结果：<span class="text-h6 text-weight-bold">{{ currentNumber }}</span
                      >KG</q-item-label
                    >
          ...
          <div class="col-shrink full-height flex flex-center bg-white" v-else>
            <q-card flat>
              <q-card-section class="text-h6 text-red"> 设备ID获取失败 </q-card-section>
              <q-card-section>
    ...
    getWeighing () {
      ...
      try {
        ...
        this.serial_port.on('data', (data) => {
          ...
          console.log('num', num)
          // this.weightType = 2
          switch (parseInt(that.weighingConfigInfo.psc_brand)) {
            case '1':
              // 大华计算格式
