            ...
            <div class="row q-my-sm q-mt-md">
              <div class="col-8 col-md-3 q-ml-md">
                ...
                <hl-upload
                  ...
                  @input="(val)=>{ $nextTick(()=>{ dataFrom.avatar = val })}"
              ...
              <div class="col-8 col-md-6 q-ml-md">
                ...
                <hl-upload
                  ...
                  @input="(val)=>{ $nextTick(()=>{ dataFrom.qrcode = val })}"
                  currentTitle="公众号二维码"
                  currentDescription="建议尺寸比例1:1"
                  />
              </div>
...
export default {
  ...
  computed: {
    ...
    manageEntranceUrl () {
      ...
      const system_local = this.$q.localStorage.getItem('onlystore_system_local')
      if (account_info && system_local) {
        return system_local.systemInfo.site_url + '/m/onlystore/manage/index?id=' + account_info.lib_id
      }
    }
  },
  created () {},
  ...
  methods: {
    ...
    getNoticeUrl () {
      ...
      const system_local = this.$q.localStorage.getItem('onlystore_system_local')
      if (account_info && system_local) {
        this.notice_url = system_local.systemInfo.site_url + '/onlystore/wechat/default/wechat-event?id=' + account_info.lib_id
      }
    }
  }
}
