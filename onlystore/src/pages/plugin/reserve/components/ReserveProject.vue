<template>
  <div class="fit column no-wrap justify-between items-stretch content-stretch no-scroll">
    ...
    <reserve-log ref="reserveLogRef" v-if="reserveLogStatus" @dataList="getDataList" />
  </div>
</template>
<script>
...
export default {
  name: 'ReserveProject',
  components: { AgOperating, AddReserveProject, ReserveLog },
  data () {
    return {
      components: { AgOperating, AddReserveProject, ReserveLog },
  ...
  methods: {
    ...
    // 显示预约详情弹窗
    showReserveLog (id) {
      this.reserveLogStatus = true
      this.$nextTick(() => {
        this.$refs.reserveLogRef.getList(id)
      })
    },
    // 分页
