                ...
                <div class="col-6 q-pr-md q-gutter-y-xs">
                  ...
                  >
                    <template v-slot:append>
                      ...
                      <span class="text-subtitle2 ">{{ $q.localStorage.getItem('onlystore_store_local').storeBaseConfig.consume_base_moneyUnit }}</span>
                    </template>
                    <template v-slot:after>
                          ...
                          <q-item>
                            <q-item-section>
                              ...
                              <q-item-label>
                                ...
                                <span class="text-orange"> {{ $q.localStorage.getItem('onlystore_store_local').storeBaseConfig.consume_base_moneyUnit }}</span>
                              </q-item-label>
                              <q-item-label>
                                佣金比例：
                              ...
                              <q-item-label>
                                赠送{{ $q.localStorage.getItem('onlystore_store_local').storeBaseConfig.consume_base_balanceUnit }}：
                                <span class="text-h6 text-orange text-weight-bold">{{ item.pmp_give_balance }}</span>
                                <span class="text-orange"> {{ $q.localStorage.getItem('onlystore_store_local').storeBaseConfig.consume_base_moneyUnit }}</span>
                              </q-item-label>
                              <q-item-label>
                                赠送{{ $q.localStorage.getItem('onlystore_store_local').storeBaseConfig.consume_base_integralUnit }}：
