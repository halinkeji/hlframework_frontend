      ...
      >
        ...
        <q-card-section>
          <q-item-label class="row q-gutter-y-md">
            ...
            <div class="col col-md-3 col-sm-6 col-xs-12">
              {{ $q.localStorage.getItem('onlystore_store_local').storeBaseConfig.consume_base_balanceUnit }}支付:<span class="text-body1">{{ formatAmount(invoiceData.sc_rechargePaymentCount) }}</span>
            </div>

            <div class="col col-md-3 col-sm-6 col-xs-12">
              {{ $q.localStorage.getItem('onlystore_store_local').storeBaseConfig.consume_base_integralUnit }}支付:<span class="text-body1">{{ formatAmount(invoiceData.sc_pointPaymentCount) }}</span>
            </div>
            <div class="col col-md-3 col-sm-6 col-xs-12">
