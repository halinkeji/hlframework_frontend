  ...
  <div class="fit column no-wrap justify-between items-stretch content-stretch no-scroll">
    <div class="col-shrink bg-white q-px-sm q-pb-md">
      <div class="q-gutter-x-xs row  ">
        <q-input class="col-12 col-md-2 q-mt-sm" clearable label="组别名称" outlined v-model="search" dense />
        ...
        <q-btn color="primary" class=" q-mt-sm" unelevated label="新增组别" v-if="authorityMeta('addGroup')" @click="editData(0)" />
        <q-btn
          color="red"
          class=" q-mt-sm"
          unelevated
