<template>
  <q-page class="fit">
    <div class="fit column no-wrap justify-between items-stretch content-stretch no-scroll">
      <div class="col-shrink bg-white q-px-xs q-pt-md">
      ...
      <q-separator />
      <div class="col-shrink full-height bg-grey-2 q-pb-sm">
        <div class="fit column no-wrap justify-between items-stretch content-stretch no-scroll">
          ...
          <div class="col-shrink full-height bg-grey-2 q-my-xs">
      ...
      <div class="col-shrink bg-white q-pb-md text-center q-gutter-sm">
        ...
        <q-btn unelevated size="md" class="q-px-xl" color="grey" label="返回" @click="$router.back(-1)" />
      </div>
    </div>
  </q-page>
</template>
