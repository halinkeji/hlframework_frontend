    ...
    uploadInit (typeData) {
      if (typeData) {
        ...
        if (Cookies.get('loggedIn')) {
          ...
          headersData.push({
            name: 'StoreId',
            value: LocalStorage.getItem('myonestore_account_info').store_id
          })
          headersData.push({
            name: 'UserId',
            value: LocalStorage.getItem('myonestore_account_info').user_id
          })
          headersData.push({
            name: 'Authorization',
            value: `Bearer ${accessToken}`
          ...
          headersData.push({
            name: 'ApplyId',
            value: LocalStorage.getItem('myonestore_account_info').apply_id
          })
          headersData.push({
            name: 'LibId',
            value: LocalStorage.getItem('myonestore_account_info').lib_id
          })
