<template>
 ...
 <q-td key="chud_goo_name" :props="props">
                    ...
                    {{ $q.localStorage.getItem('myonestore_store_local').storeBaseConfig.consume_base_moneySymbol }}  {{ props.row.chud_goo_price }}
                    </q-td>
                    <q-td key="chud_memberPrice" :props="props">
                      {{ $q.localStorage.getItem('myonestore_store_local').storeBaseConfig.consume_base_moneySymbol }} {{ props.row.chud_memberPrice }}
                    </q-td>
                    <q-td key="chud_consumeNumber" :props="props">
                      {{ props.row.chud_consumeNumber }}
                    </q-td>
                    <q-td key="chud_totalPrice" :props="props">
                   {{ $q.localStorage.getItem('myonestore_store_local').storeBaseConfig.consume_base_moneySymbol }}  {{ props.row.chud_totalPrice }}
                    </q-td>
                  </q-tr>
           </template>
