<template>
  <div class="fit column no-wrap justify-between items-stretch content-stretch no-scroll">
          ...
          <template v-slot:item="props">
            <div class="q-pa-xs col-xs-12 col-sm-6 col-md-2">
              <q-card flat bordered @click="triggerOperate(props.row)">
                ...
                <q-badge color="red" rounded floating v-else-if="props.row.goo_goodsOrService == 3">
                  套
                </q-badge>
                <q-card-section class="q-pa-xs" style="font-size:10px">
                  ...
                  <q-item-label class="text-primary row">
                    ...
                    <div v-if="props.row.goo_goodsOrService == 3">
                      按实际
                    </div>
    ...
    <weigh-components v-if="weighDialogStatus" @cancelWeighResult="weighDialogStatus = false" @confirmWeighResult="addingGoodsBut" ref="weighRef" />

    <weigh-spec-components
      v-if="weighSpecDialogStatus"
      @cancelWeighResult="weighSpecDialogStatus = false"
      ref="weighSpecRef"
      @confirmWeighResult="addingGoodsBut"
    />

    <spec-components v-if="specDialogStatus" ref="SpecDialogRef" @confirmWeighResult="addingGoodsBut" />
  </div>
</template>
