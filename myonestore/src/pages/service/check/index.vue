  ...
  <q-page class="fit">
    <div class="fit column  no-wrap justify-between items-stretch content-stretch no-scroll">
      ...
      <div class="col-shrink bg-white q-pb-md q-gutter-md  q-mt-xs text-center">
        ...
        <q-btn unelevated class="q-px-xl bg_cinnabar text-white" label="核销" @click="rewardLabel" v-if="countCardInfo && countCardInfo.id" :disable="!markCode" size="lg" />
        <q-btn unelevated class="q-px-xl bg_cinnabar text-white" label="查询" v-else :disable="!markCode" size="lg" @click="countCardInquirenCheck" />
      </div>
...
export default {
  ...
  methods: {
    ...
    rewardLabel () {
      ...
      this.$nextTick(() => {
        this.countCardInfo.mrc_deductcount = 1
        this.$refs.labelData.openStaffLabel([this.countCardInfo], 'checkDeductCount')
      })
    },
    getRewardLabel (val) {
