    ...
    <div class="fit column no-wrap justify-between items-stretch content-stretch no-scroll">
      <div class="col-shrink q-px-xs q-pb-md">
        <div class="row q-col-gutter-md q-pa-sm">
          ...
          <div class="col-6 col-md-3">
            <q-card flat bordered class="text-white  q-mt-sm">
              ...
              <q-separator />
              <div class="text-h4 text-grey-8 text-center q-my-lg">
                {{ $q.localStorage.getItem('myonestore_store_local').storeBaseConfig.consume_base_moneySymbol }}{{ formatAmount(erpTotal.clientMoney) }}/{{ $q.localStorage.getItem('myonestore_store_local').storeBaseConfig.consume_base_moneySymbol }}{{ formatAmount(erpTotal.clientArrears) }}
              </div>
            </q-card>
          </div>
          <div class="col-6 col-md-3">
            <q-card flat bordered class="text-white  q-mt-sm">
              ...
              <q-separator />
              <div class="text-h4 text-grey-8 text-center q-my-lg">
                {{ $q.localStorage.getItem('myonestore_store_local').storeBaseConfig.consume_base_moneySymbol }}{{ formatAmount(erpTotal.supplierMoney) }}/{{ $q.localStorage.getItem('myonestore_store_local').storeBaseConfig.consume_base_moneySymbol }}{{ formatAmount(erpTotal.supplierArrears) }}
              </div>
            </q-card>
          </div>
          ...
          <div class="col-6 col-md-3">
            <q-card flat bordered class="text-white  q-mt-sm">
              ...
              <q-separator />
              <div class="text-h4 text-grey-8 text-center q-my-lg">
                {{ formatAmount(erpTotal.inNumber) }}/{{ $q.localStorage.getItem('myonestore_store_local').storeBaseConfig.consume_base_moneySymbol }}{{ formatAmount(erpTotal.inMoney) }}
              </div>
            </q-card>
          </div>
          <div class="col-6 col-md-3">
            <q-card flat bordered class="text-white  q-mt-sm">
              ...
              <q-separator />
              <div class="text-h4 text-grey-8 text-center q-my-lg">
                {{ formatAmount(erpTotal.saleNumber) }}/{{ $q.localStorage.getItem('myonestore_store_local').storeBaseConfig.consume_base_moneySymbol }}{{ formatAmount(erpTotal.saleMoney) }}
              </div>
            </q-card>
          </div>
          <div class="col-6 col-md-3">
            <q-card flat bordered class="text-white  q-mt-sm">
              ...
              <q-separator />
              <div class="text-h4 text-grey-8 text-center q-my-lg">
                {{ formatAmount(erpTotal.comsumeNumber) }}/{{ $q.localStorage.getItem('myonestore_store_local').storeBaseConfig.consume_base_moneySymbol }}{{ formatAmount(erpTotal.consumeMoney) }}
              </div>
            </q-card>
          </div>
          <div class="col-6 col-md-3">
            <q-card flat bordered class="text-white  q-mt-sm">
              ...
              <q-separator />
              <div class="text-h4 text-grey-8 text-center q-my-lg">
                {{ formatAmount(erpTotal.comsumeReturnNumber) }}/{{ $q.localStorage.getItem('myonestore_store_local').storeBaseConfig.consume_base_moneySymbol
        ...
        <div class="row q-mt-md q-mx-sm text-blue-8 text-subtitle1">
          <div class="col-md-3 col-12 q-py-xl text-center cursor-pointer box" style="border:1px dashed #b2b2b2" @click="$router.push({ name: 'erpIn' })">
            <q-icon name="las la-dolly-flatbed" size="65px" />
            <div class="q-mt-sm">
              采购入库
            </div>
          </div>
          <div class="col-md-3 col-12 q-py-xl text-center cursor-pointer box" style="border:1px dashed #b2b2b2" @click="$router.push({ name: 'sale' })">
            <q-icon name="las la-shipping-fast" size="65px" />
            <div class="q-mt-sm">
              销货出库
            </div>
          </div>
          <div class="col-md-3 col-12 q-py-xl text-center cursor-pointer box" style="border:1px dashed #b2b2b2" @click="$router.push({ name: 'erpNumber' })">
            <q-icon name="las la-boxes" size="65px" />
            <div class="q-mt-sm">
              商品库存
            </div>
          </div>
          <div class="col-md-3 col-12 q-py-xl text-center cursor-pointer box" style="border:1px dashed #b2b2b2" @click="$router.push({ name: 'erpChange' })">
            <q-icon name="las la-clipboard-check" size="65px" />
            <div class="q-mt-sm">
              库存盘点
            </div>
          </div>
          <div class="col-md-3 col-12 q-py-xl text-center cursor-pointer box" style="border:1px dashed #b2b2b2" @click="$router.push({ name: 'erpRepayment' })">
            <q-icon name="las la-money-check" size="65px" />
            <div class="q-mt-sm">
              收款单
            </div>
          </div>
          <div class="col-md-3 col-12 q-py-xl text-center cursor-pointer box" style="border:1px dashed #b2b2b2" @click="$router.push({ name: 'erpPayment' })">
            <q-icon name="las la-money-check-alt" size="65px" />
            <div class="q-mt-sm">
              付款单
            </div>
          </div>
          <div class="col-md-3 col-12 q-py-xl text-center cursor-pointer box" style="border:1px dashed #b2b2b2" @click="$router.push({ name: 'supplier' })">
            <q-icon name="las la-cubes" size="65px" />
            <div class="q-mt-sm">
              供货商管理
            </div>
          </div>
          <div class="col-md-3 col-12 q-py-xl text-center cursor-pointer box" style="border:1px dashed #b2b2b2" @click="$router.push({ name: 'client' })">
