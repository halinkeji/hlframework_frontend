  ...
  <q-dialog @hide="hideNowPage" v-model="showDialog" persistent>
    ...
    >
      <div class="fit column no-wrap justify-between items-stretch content-stretch no-scroll">
        ...
        <div class="col-shrink bg-white q-px-xs q-pb-md row">
          <q-tabs v-model="couponType" @input="changeTabData" dense class="text-grey" active-color="primary" indicator-color="primary" align="justify" narrow-indicator>
            <q-tab name="local" label="本地卡券" />
            <q-tab name="market" label="推广卡券" />
          </q-tabs>
        </div>
    ...
    return {
      ...
      columnDefs: [
        ...
        },
        {
          ...
          field: 'store.name',
          width: this.nowpx(0.2) + 'px',
          cellRendererFramework: 'CouponMarket'
