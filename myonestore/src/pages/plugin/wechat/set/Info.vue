...
export default {
  ...
  computed: {
    ...
    manageEntranceUrl () {
      ...
      const system_local = this.$q.localStorage.getItem('myonestore_system_local')
      if (account_info && system_local) {
        return system_local.systemInfo.site_url + '/m/myonestore/manage/index?id=' + account_info.lib_id
      }
    }
  },
  created () {},
  ...
  methods: {
    ...
    getNoticeUrl () {
      ...
      const system_local = this.$q.localStorage.getItem('myonestore_system_local')
      if (account_info && system_local) {
        this.notice_url = system_local.systemInfo.site_url + '/myonestore/wechat/default/wechat-event?id=' + account_info.lib_id
      }
    }
  }
}
