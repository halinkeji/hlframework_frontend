            ...
            <div class="col-md-4 col-12 q-pr-md q-mt-md">
              <q-card bordered flat>
                ...
                <div class="q-ma-md">
                  ...
                  = 1{{ $q.localStorage.getItem('myonestore_store_local').storeBaseConfig.consume_base_moneyUnit }}）换算可抵现总金额（100 × (1÷30)) =
                  3.33 {{ $q.localStorage.getItem('myonestore_store_local').storeBaseConfig.consume_base_moneyUnit }}）。 设置范围为大于等于1。
                </div>
                <q-input
                  outlined
                  bottom-slots
