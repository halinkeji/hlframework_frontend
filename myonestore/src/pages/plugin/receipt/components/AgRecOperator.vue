        ...
        <q-card-section>
          <q-form ref="itemDataRef" class="q-gutter-md">
            ...
            <div class="row items-center">
              ...
              <div class="col-8 col-md-6 q-ml-md ">
                <div class="col-12 col-md-6 q-mt-sm q-px-sm text-h6">{{ $q.localStorage.getItem('myonestore_store_local').storeBaseConfig.consume_base_moneySymbol }}{{ itemData.pr_total_amount }}</div>
              </div>
            </div>
            <div class="row items-center">
