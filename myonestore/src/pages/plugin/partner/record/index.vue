<template>
  <div class="fit column no-wrap justify-between items-stretch content-stretch no-scroll">
    <div class="col-shrink bg-white q-px-xs q-pb-md q-gutter-x-xs row">
      ...
      <q-btn @click="getList" color="primary" class="q-mt-sm col-12 col-md-1 " unelevated label="搜索" />
      <q-btn @click="resetButton" color="grey-6" class="q-mt-sm col-12 col-md-1 " unelevated label="重置" />
      <q-btn @click="exportBut()" color="red" class="q-mt-sm col-12 col-md-1 " unelevated label="导出" />
    </div>
...
export default {
  ...
  methods: {
    ...
    getList () {
      ...
      this.$store
        .dispatch('partner/getRecordList', obj)
        .then((res) => {
          if (res.code == 200) {
