    ...
    <div class="col-shrink bg-white full-height ">
      <q-form ref="invoiceDataRef" class="q-gutter-md">
        ...
        <div class="row">
          ...
          <q-input outlined dense class=" col-12 col-md-4 q-mb-sm q-px-sm" v-model="merchantFrom.prefix_invoice_deductMoney" :label="`${$q.localStorage.getItem('myonestore_store_local').storeBaseConfig.consume_base_balanceUnit}扣费单据前缀`" />
          <q-input outlined dense class=" col-12 col-md-4 q-mb-sm q-px-sm" v-model="merchantFrom.prefix_invoice_addPoints" :label="`增加${$q.localStorage.getItem('myonestore_store_local').storeBaseConfig.consume_base_integralUnit}单据前缀`" />
          <q-input outlined dense class=" col-12 col-md-4 q-mb-sm q-px-sm" v-model="merchantFrom.prefix_invoice_deductPoint" :label="`${$q.localStorage.getItem('myonestore_store_local').storeBaseConfig.consume_base_integralUnit}扣除单据前缀`" />
