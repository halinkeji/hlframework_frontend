  ...
  <q-page class="fit">
    <div class="fit column no-wrap justify-between items-stretch content-stretch no-scroll">
      <div class="col-shrink bg-white q-px-xs q-py-sm text-subtitle2">
        ...
        会员{{ $q.localStorage.getItem('myonestore_store_local').storeBaseConfig.consume_base_integralUnit }}消费报表
      </div>
          ...
          <div class="q-mt-sm">
            <div class="q-mt-sm q-pa-md bg-white">
              <div class="full-width text-weight-bold q-mb-md">
                消费{{ $q.localStorage.getItem('myonestore_store_local').storeBaseConfig.consume_base_integralUnit }}TOP排行榜
  ...
  data () {
    return {
      ...
      columnDefs: [
        ...
        {
          headerName: this.$q.localStorage.getItem('myonestore_store_local').storeBaseConfig.consume_base_integralUnit,
  ...
  methods: {
    drawLine () {
      ...
      memberGiveCharts.setOption({
        ...
        series: [
          {
            name: '消费' + this.$q.localStorage.getItem('myonestore_store_local').storeBaseConfig.consume_base_integralUnit,
    ...
    exportBut () {
      ...
      this.gridOptions.api.exportDataAsCsv({
        fileName: date + '-消费' + this.$q.localStorage.getItem('myonestore_store_local').storeBaseConfig.consume_base_integralUnit + 'TOP排行榜'
      })
    }
  }
}
