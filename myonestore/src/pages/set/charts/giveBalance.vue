  ...
  <q-page class="fit">
    <div class="fit column no-wrap justify-between items-stretch content-stretch no-scroll">
      <div class="col-shrink bg-white q-px-xs q-py-sm text-subtitle2">
        ...
        赠送会员{{ $q.localStorage.getItem('myonestore_store_local').storeBaseConfig.consume_base_balanceUnit }}报表
      </div>
          ...
          <div class="q-mt-sm">
            <div class="q-mt-sm q-pa-md bg-white">
              <div class="full-width text-weight-bold q-mb-md">
                赠送会员{{ $q.localStorage.getItem('myonestore_store_local').storeBaseConfig.consume_base_balanceUnit }}TOP排行榜
  ...
  methods: {
    drawLine () {
      ...
      memberGiveCharts.setOption({
        ...
        series: [
          {
            name: '赠送会员' + this.$q.localStorage.getItem('myonestore_store_local').storeBaseConfig.consume_base_balanceUnit,
    ...
    exportBut () {
      ...
      this.gridOptions.api.exportDataAsCsv({
        fileName: date + '-赠送会员' + this.$q.localStorage.getItem('myonestore_store_local').storeBaseConfig.consume_base_balanceUnit + 'TOP排行榜'
      })
    }
  }
}
