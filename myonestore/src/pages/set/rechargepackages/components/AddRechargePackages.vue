            ...
            <div class="col-8 col-md-3 q-px-xs">
              ...
              >
                <template v-slot:append>
                  ...
                  <span style="font-size: 14px">{{ returnRecharge }}{{ $q.localStorage.getItem('myonestore_store_local').storeBaseConfig.consume_base_balanceUnit }}/期</span>
                </template>
              </q-input>
            </div>
           <div class="col-8 col-md-3 q-px-xs">
            ...
            <div class="col-8 col-md-3 q-px-xs">
              ...
              >
                <template v-slot:append>
                  <q-separator dark color="grey" class="q-mx-sm" vertical />
                  <span style="font-size: 14px">{{ returnPoint }}{{ $q.localStorage.getItem('myonestore_store_local').storeBaseConfig.consume_base_integralUnit }}/期</span>
                </template>
              </q-input>
            </div>
            ...
            <div class="q-mt-lg">
              合 计 : <span class="text-h6 text-negative"> {{ rechargeSum }} </span> {{ $q.localStorage.getItem('myonestore_store_local').storeBaseConfig.consume_base_balanceUnit }}，赠 送
              <span class="text-h6 text-negative"> {{ rechargeFrom.rp_give_points }} </span>{{ $q.localStorage.getItem('myonestore_store_local').storeBaseConfig.consume_base_integralUnit }}
            </div>
          </q-form>
        </div>
