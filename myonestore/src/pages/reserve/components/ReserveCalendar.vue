                    ...
                    <div class="row q-col-gutter-sm" v-if="!selectTimeStatus">
                      <div class="col-auto" v-for="(item, key) in resourceData">
                        <q-btn
                          ...
                          :color="
                            currentReserveItem.prd_time_hour + ':' + currentReserveItem.prd_time_minute == item.time_hour_minute ? 'color_cinnabar' : 'dark'
                          "
                      ...
                      <div class="col-3 " v-for="(item, key) in userData">
                        ...
                        >
                          <q-avatar class="q-mt-sm" v-if="item.coverImage && item.coverImage.path" size="md">
                            <q-img :src="`${$q.localStorage.getItem('myonestore_system_local').attach_url}` + item.coverImage.path"  :ratio="1" >
