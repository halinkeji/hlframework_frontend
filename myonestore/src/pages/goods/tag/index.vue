    ...
    <div class="fit column no-wrap justify-between items-stretch content-stretch no-scroll">
      <div class="col-shrink bg-white q-px-xs q-pb-md">
        <div class="q-gutter-x-xs row ">
          <q-input class=" col-12 col-md-2 q-mt-sm" clearable outlined v-model="searchName" label="标签名称" dense />

          <q-btn color="primary" class=" q-mt-sm" unelevated label="搜索" @click="getGoodsTagList" />
          ...
          <q-btn color="red" class="q-mt-sm" unelevated :disable="dataListSelections.length > 0 ? false : true" label="批量删除" v-if="authorityMeta('delAll')" @click="delAll()" />
        </div>
      </div>
