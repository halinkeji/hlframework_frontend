    ...
    <q-form ref="packageDataRef" class="q-gutter-md fit">
      <div class="fit column no-wrap justify-between items-stretch content-stretch no-scroll">
        <div class="col-shrink bg-white q-px-xs q-pb-md q-mb-xs">
          ...
          <div class="row q-pt-sm q-px-sm" v-show="currentPage == '2'">
            <q-input
              ...
              label="套餐售价"
              class="col-4"
              v-model="goodsPackageDataForm.goo_price"
              dense
          ...
          <div style="overflow-y: scroll;" class="fit full-height">
            <q-card flat class="q-pa-sm">
              <div class="row q-mt-md">
                ...
                <div class="col-md-6 col-12 q-pr-md">
                  <q-select
                    ...
                    outlined
                    dense
                    v-model="goodsPackageDataForm.goodsUnit_id"
                    :options="googsUnitData"
                    label="单位"
                  />
                </div>
              </div>
                  ...
                  <q-input v-model="goodsPackageDataForm.goo_name" outlined label="名称" dense :rules="[(val) => !!val || '名称是必填项']">
                    <template v-slot:after>
                      <q-btn
                        ...
                        class="full-width q-pt-xs q-px-xs"
                      />
                    </template>
                  </q-input>
                </div>
              ...
              <div class="row q-mt-xs">
                <div class="col-md-6 col-12">
                  <div class="row q-pr-md">
                    <div class="col-md-8 col-12">
                      <q-input
                        v-model="goodsPackageDataForm.goo_code"
                        outlined
                        bottom-
                        label="条码"
                        dense
                        lazy-rules
                        :rules="[(val) => !!val || '条码是必填项']"
                      >
                      </q-input>
                    </div>
                ...
                <div class="col-md-6 col-12 q-pr-md">
                  <q-input v-model="goodsPackageDataForm.goo_pinYin" outlined label="助记码" dense :rules="[(val) => !!val || '助记码是必填项']">
                  </q-input>
                </div>
              </div>
              <div class="row q-mt-xs">
                <div class="col-md-6 col-12">
                  <hl-upload
                    ...
                    @input="
                      (val) => {
                        $nextTick(() => {
                          goodsPackageDataForm.goo_cover_image = val;
                        });
                      }
                    "
                ...
                <div class="col-md-6 col-12">
                  <hl-upload
                    ...
                    @input="
                      (val) => {
                        $nextTick(() => {
                          goodsPackageDataForm.goo_loop_image = val;
                        });
                      }
                    "
                    currentDescription="建议尺寸比例1:1"
        ...
        <div class="col-shrink bg-white q-pt-sm q-pb-md q-gutter-sm text-center" :class="currentPage == '1' ? 'q-mt-xs' : ''">
          <q-btn
            :disable="goodsPackageData.length == 0 || !goodsPackageDataForm.goo_price"
            unelevated
            class="q-px-xl"
            color="primary"
            @click="saveBut()"
