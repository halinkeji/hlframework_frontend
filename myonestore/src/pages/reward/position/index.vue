<template>
  <div class="fit column no-wrap justify-between items-stretch content-stretch no-scroll">
    <div class="col-shrink bg-white q-px-xs q-pb-md row q-gutter-x-sm">
      ...
      <q-btn @click="addData" color="primary" class=" col-12 col-md-1 q-mt-sm" unelevated  label="新增" />
      <q-btn :disable="dataListSelections.length > 0 ? false : true" @click="delAll" color="red" class="col-12 col-md-1 q-mt-sm" unelevated  label="批量删除" />
    </div>
