...
export function getAllPositionData ({ commit }, params) {
  return new Promise((resolve, reject) => {
    api
      .get('v3/reward-position/all-data', { params })
      .then(response => {
        resolve(response)
      })
      .catch(error => {
...
export function getUserDataLists ({ commit }, item) {
  return new Promise((resolve, reject) => {
    api
      .get('v3/reward-user/lists', { params: item })
      .then(response => {
        resolve(response)
      })
      .catch(error => {
...
export function getItemData ({ commit }, params) {
  return new Promise((resolve, reject) => {
    api.get('v3/reward-position/get-config-item', { params })
      .then(response => {
        resolve(response)
      })
      .catch(error => {
...
export function setItemData ({ commit }, params) {
  return new Promise((resolve, reject) => {
    api.post('v3/reward-position/set-config-item', params)
      .then(response => {
        resolve(response)
      })
      .catch(error => {
