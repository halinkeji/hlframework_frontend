...
export function addSaleDetail ({ commit }, item) {
  return new Promise((resolve, reject) => {
    api
      .post('v3/erp-sale/addsaledetail', item)
      .then(response => {
        resolve(response)
      })
      .catch(error => {
...
export function setSaleDetail ({ commit }, item) {
  return new Promise((resolve, reject) => {
    api
      .post('v3/erp-sale/setsaledetail', item)
      .then(response => {
        resolve(response)
      })
      .catch(error => {
...
export function getSaleDetail ({ commit }, item) {
  return new Promise((resolve, reject) => {
    api
      .get('v3/erp-sale/outdata', { params: item })
      .then(response => {
        resolve(response)
      })
      .catch(error => {
...
export function getErpOut ({ commit }, item) {
  return new Promise((resolve, reject) => {
    api
      .get('v3/erp-sale/erpout', { params: item })
      .then(response => {
        resolve(response)
      })
      .catch(error => {
...
export function settleInvoice ({ commit }, parasm) {
  return new Promise((resolve, reject) => {
    api.post('v3/erp-sale/settle', parasm)
      .then(response => {
        resolve(response)
      })
      .catch(error => {
