...
module.exports = function (ctx) {
  return {
    ...
    pwa: {
      ...
      manifest: {
        name: 'hlframework frontend web myonestore',
        short_name: 'hlframework frontend web myonestore',
        description: 'hlframework frontend web myonestore',
        display: 'standalone',
    ...
    electron: {
      ...
      builder: {
        ...
        appId: 'hlframework_frontend_web_myonestore'
