...
module.exports = function (ctx) {
  return {
    ...
    build: {
      ...
      env: ctx.dev
        ? {
            BASE_URL_API: '' // dev 开发环境
          }
        : {
            BASE_URL_API: 'hlj0207I7uAX2IHb8Z' // prod 生产环境
          },
      // transpile: false,
    ...
    pwa: {
      ...
      manifest: {
        name: 'hlframework frontend web myouka',
        short_name: 'hlframework frontend web myouka',
        description: 'hlframework frontend web myouka',
        display: 'standalone',
    ...
    electron: {
      ...
      builder: {
        ...
        appId: 'hlframework_frontend_web_myouka'
