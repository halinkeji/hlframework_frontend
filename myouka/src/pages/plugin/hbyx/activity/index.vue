    ...
    return {
      ...
      columnDefs: [
        ...
        },
        {
          headerName: '随机金额区间',
          valueGetter: (p) => {
            return p.data.pha_random_amount_min + this.$q.localStorage.getItem('myouka_store_local').storeBaseConfig.consume_base_moneyUnit + '-' + p.data.pha_random_amount_max + this.$q.localStorage.getItem('myouka_store_local').storeBaseConfig.consume_base_moneyUnit
          },
          width: this.nowpx(0.1) + 'px'
        },
