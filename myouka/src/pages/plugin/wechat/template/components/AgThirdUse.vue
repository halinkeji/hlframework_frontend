            ...
            <div class="col-md-6 col-12">
              ...
              <q-card flat style="border:1px solid #26a69a " class="q-mt-sm ">
                ...
                <div class="q-mt-sm q-pa-md">
                  ...
                  <div>
                    获得{{ $q.localStorage.getItem('myouka_store_local').storeBaseConfig.consume_base_integralUnit }}：keyword2.DATA
                  </div>
                  <div>
                    消费门店：keyword3.DATA
                  </div>
                  ...
                  <div>
                    当前{{ $q.localStorage.getItem('myouka_store_local').storeBaseConfig.consume_base_integralUnit }}：keyword5.DATA
                  </div>
                  <div>
                    remark.DATA
                  </div>
