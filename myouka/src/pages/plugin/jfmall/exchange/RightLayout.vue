                ...
                <q-img
                  :src="
                    props.row.coverImage && props.row.coverImage.id
                      ? $q.localStorage.getItem('system_local').attach_url + props.row.coverImage.path
                      : ''
                  "
                  :ratio="1"
                  class="full-width"
                  ...
                  <div class="text-orange" v-else>
                    ...
                    <span v-else>
                      <span class="text-dark text-caption">
                        原价:{{ $q.localStorage.getItem('store_local').storeBaseConfig.consume_base_moneySymbol }}
                      </span>
