    ...
    <div class="fit column no-wrap justify-between items-stretch content-stretch no-scroll">
      ...
      <div class="col-shrink q-pa-sm full-height bg-white q-mt-xs">
        <q-scroll-area class="fit full-height">
          <q-form ref="wechatPayRef" v-if="is_main_store || (mainPayConfig && parseInt(mainPayConfig.is_common) != 1) ">
            ...
            <div class="row q-my-sm">
              <div class="col-8 col-md-6 q-ml-md">
                <q-input
                  ...
                  label=" 公众账号ID(appid)"
                  :rules="[(val) => !!val || '必填项']"
                  v-model="wxpayData.app_id"
                  maxlength="50"
                  placeholder=" 公众账号ID(appid)"
                >
            ...
            <div class="row q-my-sm">
              <div class="col-8 col-md-6 q-ml-md">
                <q-input
                  ...
                  label="商户支付密钥key"
                  :rules="[(val) => !!val || '必填项']"
                  v-model="wxpayData.app_key"
                  maxlength="50"
                  placeholder="(本公众号/服务商)商户支付密钥key"
                >
                  <template v-slot:hint>
              ...
              <div class="row q-my-sm">
                <div class="col-8 col-md-6 q-ml-md">
                  <q-input
                    ...
                    label="公众账号ID(appid)"
                    :rules="[(val) => !!val || '必填项']"
                    v-model="wxpayData.sub_appid"
                    placeholder="(特约子商户)公众账号ID(sub_appid)"
                  >
                    <template v-slot:hint>
              ...
              <div class="row q-my-sm">
                <div class="col-8 col-md-6 q-ml-md">
                  <q-input
                    ...
                    label=" 商户号(mchid)"
                    :rules="[(val) => !!val || '必填项']"
                    v-model="wxpayData.sub_mch_id"
                    placeholder="(特约子商户)商户号(mchid)"
                  >
      ...
      this.$store
        ...
        .then((res) => {
          if (res.code == 200) {
            ...
            this.wxpayData = sonPayConfig && sonPayConfig.id
              ? sonPayConfig
              : {
                  app_id: '',
                  app_secret: '',
            ...
            this.wxpayData.is_common = parseInt(this.wxpayData.is_common)
          }
        })
    },
    // 提交
