          ...
          <q-scroll-area class="fit full-height">
            <q-form ref="titletemRef">
              <div class="row items-center">
                <div class="col-12 ">
                  <span class="row justify-center text-h5"> 未开票总计金额：{{ itemData.pr_invoice_amount }}{{ $q.localStorage.getItem('myouka_store_local').storeBaseConfig.consume_base_moneyUnit }}</span>
                </div>
              </div>
