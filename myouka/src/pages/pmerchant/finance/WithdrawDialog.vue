        ...
        <div class="row col-shrink bg-white q-px-xs q-pb-md q-gutter-sm">
          ...
          <div class="col">
            <q-item class="bg-grey-2">
              ...
              <q-item-section>
                <q-item-label class="text-subtitle1 text-weight-bold text-primary text-right">{{ formatAmount(minWithdrawAmount) }}<span class="text-caption text-black">{{ $q.localStorage.getItem('myouka_store_local').storeBaseConfig.consume_base_moneyUnit }}</span> </q-item-label>
              </q-item-section>
            </q-item>
          </div>
          ...
          <div class="col">
            <q-item class="bg-grey-2">
              ...
              <q-item-section>
                <q-item-label class="text-subtitle1 text-weight-bold text-primary text-right">{{ formatAmount(handleWithdrawAmount) }}<span class="text-caption text-black">{{ $q.localStorage.getItem('myouka_store_local').storeBaseConfig.consume_base_moneyUnit }}</span> </q-item-label>
              </q-item-section>
            </q-item>
          </div>
           ...
           <div class="col">
            <q-item class="bg-grey-2">
              ...
              <q-item-section>
                <q-item-label class="text-subtitle1 text-weight-bold text-primary text-right">{{ formatAmount(withdrawForm.pdw_arrival_amount) }}<span class="text-caption text-black">{{ $q.localStorage.getItem('myouka_store_local').storeBaseConfig.consume_base_moneyUnit }}</span> </q-item-label>
              </q-item-section>
            </q-item>
          </div>
          ...
          <div class="col">
            <q-item class="bg-grey-2">
              ...
              <q-item-section>
                ...
                }}<span class="text-caption text-black">{{ $q.localStorage.getItem('myouka_store_local').storeBaseConfig.consume_base_moneyUnit }}</span> </q-item-label>
              </q-item-section>
            </q-item>
          </div>
