    ...
    <div class="fit column no-wrap justify-between items-stretch content-stretch no-scroll">
      <div class="col-shrink bg-white q-px-xs q-pb-md">
        <q-tabs v-model="tab" indicator-color="primary" @input="changeTab" active-color="primary" dense align="left" inline-label class="bg-white">
          ...
          <q-tab name="supermodel" icon="las la-sitemap" v-if="authorityMeta('supermodel')" label="油站经营模式"> </q-tab>
...
import OilConsume from './components/OilConsume.vue'
...
import ErpSet from './components/ErpSet.vue' // 参数设置
import SuperModel from './components/Supermodel.vue' // 油站经营模式
import PluginModel from './components/PluginModel.vue' // 油站经营模式
import MemberSet from './components/MemberSet.vue' // 会员设置
import PaySet from './components/PaySet.vue' // 支付设置
import OtherSet from './components/OtherSet.vue' // 支付设置
export default {
  name: 'set',
  components: {
    IndexInfo,
