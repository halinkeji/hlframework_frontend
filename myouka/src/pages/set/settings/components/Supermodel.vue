      ...
      <q-scroll-area class="fit full-height">
        <q-form ref="modelConfigRef" class="row q-my-sm">
          <div class="col-8" v-if="is_main_store">
            <q-select label="设置油站" v-model="selectStoreData" @input="getItem" option-value="id" option-label="name"  emit-value map-options dense outlined :options="libInStoreList" />
          </div>
          <div class="col-8" v-if="selectStoreData">
            <q-list separator padding>
              <q-item>
                <q-item-section>
                  ...
                  <q-item-label caption>开启后，总部可根据经营实际情况，调配油站为连锁经营模式、加盟经营模式、直营+加盟混合经营模式。</q-item-label>
                </q-item-section>
              ...
              <q-item>
                <q-item-section>
                  <q-item-label>{{ $q.localStorage.getItem('myouka_store_local').storeBaseConfig.consume_base_integralUnit }}使用模式</q-item-label>
                  <q-item-label caption>启用后，油站只可使用当前油站内产生的>{{ $q.localStorage.getItem('myouka_store_local').storeBaseConfig.consume_base_integralUnit }}。默认禁用，油站可使用会员产生的全部>{{ $q.localStorage.getItem('myouka_store_local').storeBaseConfig.consume_base_integralUnit }}。</q-item-label>
                </q-item-section>
                <q-item-section side top>
              ...
              <q-item>
                <q-item-section>
                  <q-item-label>{{ $q.localStorage.getItem('myouka_store_local').storeBaseConfig.consume_base_balanceUnit }}使用模式</q-item-label>
                  <q-item-label caption>启用后，油站只可使用当前油站内产生的>{{ $q.localStorage.getItem('myouka_store_local').storeBaseConfig.consume_base_balanceUnit }}。默认禁用，油站可使用会员产生的全部>{{ $q.localStorage.getItem('myouka_store_local').storeBaseConfig.consume_base_integralUnit }}。</q-item-label>
                </q-item-section>
                <q-item-section side top>
              ...
              <q-item>
                <q-item-section>
                  ...
                  <q-item-label caption>启用后，油站只可使用自建公告。禁用后（默认禁用），油站可查看总部公告与使用自建公告。</q-item-label>
                </q-item-section>
                <q-item-section side top>
              ...
              <q-item>
                <q-item-section>
                  ...
                  <q-item-label caption>启用后，油站的积分折扣规则各自独立使用。禁用后油站均使用总部统一设置的积分规则折扣</q-item-label>
                </q-item-section>
                <q-item-section side top>
              ...
              <q-item>
                <q-item-section>
                  ...
                  <q-item-label caption>启用后，油站的消费设置各自独立使用。禁用后，油站使用总部统一设置的消费设置</q-item-label>
                </q-item-section>
                <q-item-section side top>
            ...
            <q-item>
                <q-item-section>
                  ...
                  <q-item-label caption>启用后，油站的支付设置各自独立使用。禁用后，油站使用总部统一设置的支付设置</q-item-label>
                </q-item-section>
                <q-item-section side top>
              ...
              <q-item>
                <q-item-section>
                  ...
                  <q-item-label caption>启用后，油站的充值套餐各自独立使用。禁用后，油站使用总部统一设置的充值套餐</q-item-label>
                </q-item-section>
                <q-item-section side top>
              ...
              <q-item>
                <q-item-section>
                  ...
                  <q-item-label caption>启用后，油站的会员标签各自独立使用。禁用后，油站使用总部统一设置的会员标签</q-item-label>
                </q-item-section>
                <q-item-section side top>
              ...
              <q-item>
                <q-item-section>
                  ...
                  <q-item-label caption>启用后，油站的商品标签各自独立使用。禁用后，油站使用总部统一设置的商品标签</q-item-label>
                </q-item-section>
                <q-item-section side top>
              ...
              <q-item>
                <q-item-section>
                  ...
                  <q-item-label caption>启用后，油站可独立添加自有商品，且油站可以编辑总部商品在本店的售价、状态等参数。禁用后，油站仅可使用总部授权提供的商品。</q-item-label>
                </q-item-section>
                <q-item-section side top>
              ...
              <q-item>
                <q-item-section>
                  ...
                  <q-item-label caption>启用后，油站只可使用自有套餐。禁用后（默认禁用），油站可使用总部套餐与自有套餐。</q-item-label>
                </q-item-section>
                <q-item-section side top>
              ...
              <q-item-section>
                  ...
                  <q-item-label caption>默认禁用，禁用后次卡可在任意油站使用（示例：会员在A店购的次卡可在任意店使用），启用后油站次卡各使用各的（示例：会员在A店购买的次卡只能在A店使用）。</q-item-label>
                </q-item-section>
                <q-item-section side top>
              ...
              <q-item-section>
                  ...
                  <q-item-label caption>默认禁用，禁用后时卡可在任意油站使用（示例：会员在A店购的时卡可在任意店使用），启用后油站时卡各使用各的（示例：会员在A店购买的时卡只能在A店使用）。</q-item-label>
                </q-item-section>
                <q-item-section side top>
              ...
              <q-item>
                <q-item-section>
                  ...
                  <q-item-label caption>启用后，油站只可使用自有供货商。禁用后（默认禁用），油站可使用总部供货商与自有供货商。</q-item-label>
                </q-item-section>
                <q-item-section side top>
              ...
              <q-item>
                <q-item-section>
                  ...
                  <q-item-label caption>启用后，油站只可使用自有客户。禁用后（默认禁用），油站可使用总部客户与自有客户。</q-item-label>
                </q-item-section>
                <q-item-section side top>
              ...
              <q-item>
                <q-item-section>
                  ...
                  <q-item-label caption>启用后，油站只可使用自有预警规则。禁用后（默认禁用），油站可使用总部预警规则与自有预警规则。</q-item-label>
                </q-item-section>
                <q-item-section side top>
