            ...
            <q-list separator padding>
              <q-item>
                <q-item-section>
                  ...
                  <q-item-label caption>启用后，油站可独立设置会员日营销规则。禁用后（默认禁用），使用总部统一管理。</q-item-label>
                </q-item-section>
              ...
              <q-item>
                <q-item-section>
                  ...
                  <q-item-label caption
                    >启用后，油站只可使用自建卡券，其他油站或总部的卡券均不可在该油站进行使用核销。默认禁用，各油站通用总部创建的卡券。</q-item-label
                  >
                </q-item-section>
                <q-item-section side top>
              ...
              <q-item>
                <q-item-section>
                  ...
                  <q-item-label caption>启用后，油站只能使用自用满额营销，其他油站不可使用。默认禁用，使用总部与当前油站统一创建。</q-item-label>
                </q-item-section>
                <q-item-section side top>
              ...
              <q-item>
                <q-item-section>
                  ...
                  <q-item-label caption>启用后，油站可独立设置功能配置。禁用后（默认禁用），使用总部统一管理。</q-item-label>
                </q-item-section>
                <q-item-section side top>
