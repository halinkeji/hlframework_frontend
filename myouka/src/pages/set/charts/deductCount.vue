    ...
    drawLine () {
      ...
      goodsCharts.setOption({
        ...
        series: [
          {
            name: '扣除计次',
            data: this.chartsData.deductCountData ? this.chartsData.deductCountData : [],
            type: 'line',
