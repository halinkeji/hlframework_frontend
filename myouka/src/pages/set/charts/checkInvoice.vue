                ...
                <div class="row q-col-gutter-sm">
                  <div class="col">
                    <q-card flat bordered>
                      ...
                      <q-card-actions class="bg-primary text-white" align="center">
                        <div class="q-py-sm">
                     +充值{{ $q.localStorage.getItem('myouka_store_local').storeBaseConfig.consume_base_balanceUnit }}
                        </div>
                      </q-card-actions>
                    </q-card>
                  </div>
                  <div class="col">
                    <q-card flat bordered>
                      ...
                      <q-card-actions class="bg-primary text-white" align="center">
                        <div class="q-py-sm">
                      +赠送{{ $q.localStorage.getItem('myouka_store_local').storeBaseConfig.consume_base_balanceUnit }}
                        </div>
                      </q-card-actions>
                    </q-card>
                  </div>
                  <div class="col">
                    <q-card flat bordered>
                      ...
                      <q-card-actions class="bg-primary text-white" align="center">
                        <div class="q-py-sm">
                        -使用{{ $q.localStorage.getItem('myouka_store_local').storeBaseConfig.consume_base_balanceUnit }}
                        </div>
                      </q-card-actions>
                    </q-card>
                  </div>
                  <div class="col">
                    <q-card flat bordered>
                      ...
                      <q-card-actions class="bg-primary text-white" align="center">
                        <div class="q-py-sm">
                          新增{{ $q.localStorage.getItem('myouka_store_local').storeBaseConfig.consume_base_integralUnit }}
                        </div>
                      </q-card-actions>
                    </q-card>
                  </div>
                  <div class="col">
                    <q-card flat bordered>
                      ...
                      <q-card-actions class="bg-primary text-white" align="center">
                        <div class="q-py-sm">
                          减少{{ $q.localStorage.getItem('myouka_store_local').storeBaseConfig.consume_base_integralUnit }}
                        </div>
                      </q-card-actions>
                    </q-card>
                  </div>
    ...
    return {
      ...
      columns: [
        ...
        },
        {
          ...
          label: '充值' + this.$q.localStorage.getItem('myouka_store_local').storeBaseConfig.consume_base_balanceUnit,
          align: 'center',
          field: 'rechargeMoneyTotal'
        },
        {
          name: 'giveMoneyTotal',
          label: '赠送' + this.$q.localStorage.getItem('myouka_store_local').storeBaseConfig.consume_base_balanceUnit,
          align: 'center',
          field: 'giveMoneyTotal'
        },
        {
          name: 'useMoneyTotal',
          label: '会员消费使用' + this.$q.localStorage.getItem('myouka_store_local').storeBaseConfig.consume_base_balanceUnit,
          align: 'center',
          field: 'useMoneyTotal'
        },
        {
          name: 'pushIntegralTotal',
          label: '新增' + this.$q.localStorage.getItem('myouka_store_local').storeBaseConfig.consume_base_integralUnit,
          align: 'center',
          field: 'pushIntegralTotal'
        },
        {
          name: 'useIntegralTotal',
          label: '减少' + this.$q.localStorage.getItem('myouka_store_local').storeBaseConfig.consume_base_integralUnit,
          align: 'center',
