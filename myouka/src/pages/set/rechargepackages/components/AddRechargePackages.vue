        ...
        <div class="col-shrink q-pa-sm full-height bg-white q-mt-xs">
          <q-form ref="rechargeDataRef" class="row">
              ...
              >
                <template v-slot:append>
                  ...
                  <span style="font-size: 14px"
                    >{{ returnRecharge }}{{ $q.localStorage.getItem('myouka_store_local').storeBaseConfig.consume_base_balanceUnit }}/期</span
                  >
                </template>
              </q-input>
            </div>
            ...
            <div class="col-8 col-md-3 q-px-xs">
              ...
              >
                <template v-slot:append>
                  <q-separator dark color="grey" class="q-mx-sm" vertical />
                  <span style="font-size: 14px"
                    >{{ returnPoint }}{{ $q.localStorage.getItem('myouka_store_local').storeBaseConfig.consume_base_integralUnit }}/期</span
                  >
                </template>
              </q-input>
            </div>
            ...
            <div class="q-mt-lg">
              ...
              {{ $q.localStorage.getItem('myouka_store_local').storeBaseConfig.consume_base_balanceUnit }}，赠 送
