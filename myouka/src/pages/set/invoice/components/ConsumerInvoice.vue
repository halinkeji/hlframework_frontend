      ...
      <q-card flat class="q-mb-md">
        <div class="row q-col-gutter-xs items-center">
          ...
          <div class="col-12 col-md-4" v-if="is_main_store">
            <q-select label="查询油站" use-chips v-model="selectStoreData" option-value="id" option-label="name" multiple emit-value map-options dense outlined :options="libInStoreList" />
          </div>
