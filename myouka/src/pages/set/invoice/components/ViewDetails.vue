        ...
        <div class="fit column no-wrap justify-between items-stretch content-stretch no-scroll">
          ...
          <div class="col-shrink q-pa-sm full-height bg-white">
            <q-scroll-area class="fit full-height">
              ...
              <div class="q-mt-sm" v-if="invoiceData.myoukaOilConsumeInvoiceDetail && invoiceData.myoukaOilConsumeInvoiceDetail.length > 0">
                <q-table
                  title="加油详情"
                  :data="invoiceData.myoukaOilConsumeInvoiceDetail"
                  :columns="oilConsumeData"
                  row-key="name"
                  flat
                  hide-bottom
                  bordered
                  ...
                  <template v-slot:body="props">
                    <q-tr :props="props">
                      ...
                      <q-td key="cid_goo_price" :props="props">
                        <span v-if="parseInt(props.row.cid_packageId) > 0" class="text-red">[套]</span>
                        {{ $q.localStorage.getItem('myouka_store_local').storeBaseConfig.consume_base_moneySymbol }} {{ props.row.cid_goo_price }}
                      </q-td>
                      <q-td key="cid_sellingPrice" :props="props">
                        <span v-if="parseInt(props.row.cid_packageId) > 0" class="text-red">[套]</span>
                        {{ $q.localStorage.getItem('myouka_store_local').storeBaseConfig.consume_base_moneySymbol }} {{ props.row.cid_sellingPrice }}
                      </q-td>
                      <q-td key="cid_memberPrice" :props="props">
                        <span v-if="parseInt(props.row.cid_packageId) > 0" class="text-red">[套]</span>
                        {{ $q.localStorage.getItem('myouka_store_local').storeBaseConfig.consume_base_moneySymbol }} {{ props.row.cid_memberPrice }}
                      </q-td>
              ...
              <div class="q-mt-sm" v-if="invoiceData.pointsCountRecord && invoiceData.pointsCountRecord.length > 0">
                <q-table
                  :title="`${$q.localStorage.getItem('myouka_store_local').storeBaseConfig.consume_base_integralUnit}详情`"
              ...
              <div class="q-mt-sm" v-if="invoiceData.moneyCountRecord && invoiceData.moneyCountRecord.length > 0">
                <q-table
                  :title="`${$q.localStorage.getItem('myouka_store_local').storeBaseConfig.consume_base_balanceUnit}详情`"
...
export default {
  ...
  data () {
    return {
      ...
      integralData: [
        {
          label: '变更' + this.$q.localStorage.getItem('myouka_store_local').storeBaseConfig.consume_base_integralUnit,
          align: 'center',
          field: 'pcr_pointsCount'
        },
        {
          align: 'center',
          label: this.$q.localStorage.getItem('myouka_store_local').storeBaseConfig.consume_base_integralUnit + '来源',
          field: 'pcr_pointsCountSource'
        },
        {
          label: this.$q.localStorage.getItem('myouka_store_local').storeBaseConfig.consume_base_integralUnit + '状态',
          align: 'center',
      ...
      storedData: [
        {
          label: '变更' + this.$q.localStorage.getItem('myouka_store_local').storeBaseConfig.consume_base_balanceUnit,
          align: 'center',
          field: 'mcr_moneyCount'
        },
        {
          align: 'center',
          label: this.$q.localStorage.getItem('myouka_store_local').storeBaseConfig.consume_base_balanceUnit + '来源',
          field: 'mcr_moneyCountSource'
        },
        {
          label: this.$q.localStorage.getItem('myouka_store_local').storeBaseConfig.consume_base_balanceUnit + '状态',
          align: 'center',
      ...
      consumeBasisColumn: [
        ...
        {
          label: '获得' + this.$q.localStorage.getItem('myouka_store_local').storeBaseConfig.consume_base_integralUnit,
          align: 'left',
          field: 'sc_getPoint'
        }
      ],
      consumPayColumn: [
        {
          label: this.$q.localStorage.getItem('myouka_store_local').storeBaseConfig.consume_base_balanceUnit + '支付',
          align: 'left',
        ...
        {
          align: 'left',
          label: this.$q.localStorage.getItem('myouka_store_local').storeBaseConfig.consume_base_integralUnit + '支付',
      ...
      oilConsumeData: [
        ...
        },
        {
          label: '汽油储值支付',
          align: 'center',
          field: 'rcid_gasoline_pay',
          format: this.formatAmount
        },
        {
          label: '柴油储值支付',
          align: 'center',
          field: 'rcid_diesel_oil_pay',
          format: this.formatAmount
        },
        {
          align: 'center',
          label: '天然气储值支付',
          field: 'rcid_natural_gas_pay',
          format: this.formatAmount
        },
        {
          align: 'center',
          label: '新能源储值支付',
          field: 'rcid_new_energy_pay',
          format: this.formatAmount
        }
      ],
      invoiceId: '',
  ...
  methods: {
    ...
    getViewData (id) {
      ...
      this.invoiceId = id
      if (this.$q.localStorage.getItem('myouka_store_local') && this.$q.localStorage.getItem('myouka_store_local').openPayment) {
        this.paymentChannel = this.$q.localStorage.getItem('myouka_store_local').openPayment
      }
      if (id > 0) {
        const obj = {
          id: id
