<template>
  <q-page class="fit">
      ...
      <div class="col-shrink q-pa-sm full-height bg-white">
        <q-scroll-area class="fit full-height">
          <q-form ref="takeDataRef">
            <!-- <q-btn color="orange" @click="turnStatus = true" unelevated class="q-mb-sm" label="选择借回单据" size="md" /> -->
    ...
    <oil-record ref="takeRef" :type="'turn_return_out'" v-if="turnStatus" @getRecord="getSelectedOilData" />
  </q-page>
</template>
<script>
        ...
        if (success) {
          ...
          this.$q
            ...
            .onOk(() => {
              ...
              this.$store.dispatch('turnoil/setDebtTakeOil', data).then((res) => {
                if (res.code == 200) {
                  this.$q.notify({
                    message: '成功',
                    caption: '取回成功',
