  ...
  <q-page class="fit">
    <div class="fit column no-wrap justify-between items-stretch content-stretch no-scroll">
            ...
            <tr v-for="(item, mainkey) in takeOilData">
              ...
              <td class="text-body1 q-pa-none">
                <div v-if="parseInt(item.retrun_type) == 1">
                  ...
                  <q-btn flat color="primary" dense label="请选择单据" @click="openOilRecord('borrow_return_out', item.id)" />
                </div>
      ...
      <div class="col-shrink bg-white q-pb-md text-center q-gutter-sm">
        ...
        <q-btn unelevated label="取消" type="reset" :to="{ name: 'oilDebt' }" color="grey" class="q-px-xl" />
      </div>
...
export default {
  ...
  methods: {
    ...
    getSelectedTypeOilData (data) {
      ...
      if (this.operateType == 'borrow_return_out') {
        this.getSelectOpenData(data)
      } else if (this.operateType == 'turn_return_out') {
