<template>
  <div class="fit column no-wrap justify-between items-stretch content-stretch no-scroll">
    ...
    <div class="col-shrink bg-white q-px-xs q-py-sm text-subtitle2 q-pb-xl">
      <div class="row">
        <div class="col-4 q-pa-md" v-for="(item, key) in integralData">
    ...
    <div class="col-shrink bg-white q-px-xs q-py-sm text-subtitle2 q-mb-xs full-height row justify-center">
      <div class="col-6">
        <div id="integralCharts" class="pie-service"></div>
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    getSummaryList () {
      ...
      this.$store
        .dispatch('shift/getIntegralCount', obj)
        .then((res) => {
          if (res.code == 200) {
            this.integralData = res.data ? res.data : []
    ...
    showChart (value) {
      this.chartPie = echarts.init(document.getElementById('integralCharts'), 'macarons')
