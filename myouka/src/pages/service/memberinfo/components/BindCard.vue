...
export default {
  ...
  methods: {
    ...
    init (val) {
      ...
      if (this.$q.localStorage.getItem('myouka_store_local').storeMemberConfig) {
        this.storeMemberConfig = this.$q.localStorage.getItem('myouka_store_local').storeMemberConfig
      }
      if (val && val.id) {
