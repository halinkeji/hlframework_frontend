    ...
    <div class="fit column no-wrap justify-between items-stretch content-stretch no-scroll">
      <div class="col-shrink bg-white q-px-xs q-pb-md  q-pt-sm">
        <div class="row q-gutter-x-sm">
          <q-input class="col-12 col-md-2" label="请输入员工名称/联系电话" outlined v-model="searchQuery" dense />
    ...
    return {
      ...
      columnDefs: [
        ...
        },
        {
          ...
          width: this.nowpx(0.1) + 'px',
          valueGetter: (p) => {
            if (parseInt(p.data.pru_status) == 1) {
              return '正常'
            } else if (parseInt(p.data.pru_status) == 0) {
              return '关闭'
            } else if (parseInt(p.data.pru_status) == 2) {
              return '休息'
            }
          }
        },
