        ...
        <q-scroll-area class="fit full-height">
          <q-form ref="memberDataRef" class="row">
            <div :class="!$route.query.memberId ? 'col-8' : 'col-12'">
              <q-card flat class="q-pa-sm q-gutter-md">
...
export default {
  ...
  created () {
    ...
    if (LocalStorage.getItem('myouka_store_local').storeMemberConfig) {
      this.storeMemberConfig = LocalStorage.getItem('myouka_store_local').storeMemberConfig
    }
  },
  methods: {
    changeMemberMobile () {
