      ...
      <template v-slot:list="scope">
        <div class="row">
          <div class="col-2 q-ma-sm" v-for="file in scope.files">
            <q-img :src="file.__img.src" style="width: 100%" :ratio="1" >
              <q-btn
                size="12px"
                flat
                dense
...
export default {
  ...
  methods: {
        ...
        .then((res) => {
          if (res.code == 200) {
            ...
            setTimeout(() => {
              ...
              this.$emit('changeUploadBtn', false)
              this.$nextTick(() => {
    ...
    // },
    addedShow () {
      this.$emit('changeUploadBtn', true)
    },
...
<style >
.uploader-height .q-uploader__list{
