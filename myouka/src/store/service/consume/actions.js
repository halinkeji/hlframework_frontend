...
// 获取商品列表
export function getSpecification ({ commit }, item) {
  return new Promise((resolve, reject) => {
    api
      .get('v3/consume/home', { params: item })
      .then(response => {
        resolve(response)
      })
      .catch(error => {
...
export function getShoppingCartList ({ commit }, item) {
  return new Promise((resolve, reject) => {
    api
      .get('v3/consume/cart', { params: item })
      .then(response => {
        resolve(response)
      })
      .catch(error => {
...
// 获取挂单列表
export function getHangUpList ({ commit }, item) {
  return new Promise((resolve, reject) => {
    api
      .get('v3/consume/hang', { params: item })
      .then(response => {
        resolve(response)
      })
      .catch(error => {
...
// 获取商品套餐列表
export function getPackage ({ commit }, item) {
  return new Promise((resolve, reject) => {
    api
      .get('v3/consume/package', { params: item })
      .then(response => {
        resolve(response)
      })
      .catch(error => {
