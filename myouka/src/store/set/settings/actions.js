...
export function setOnlyParams ({ commit }, params) {
  return new Promise((resolve, reject) => {
    api
      .post('v3/settings/set-params', params)
      .then((response) => {
        resolve(response)
      })
      .catch((error) => {
...
export function getUseStatus ({ commit }, params) {
  return new Promise((resolve, reject) => {
    api
      .get('v3/settings/use-status', { params })
      .then((response) => {
        resolve(response)
      })
      .catch((error) => {
...
export function getFieldConfigData ({ commit }, params) {
  return new Promise((resolve, reject) => {
    api
      .get('v3/expand-field', { params })
      .then((response) => {
        resolve(response)
      })
      .catch((error) => {
...
export function editFieldConfigData ({ commit }, params) {
  return new Promise((resolve, reject) => {
    api
      .post('v3/expand-field/create', params)
      .then((response) => {
        resolve(response)
      })
      .catch((error) => {
...
export function getRegSite ({ commit }, params) {
  return new Promise((resolve, reject) => {
    api
      .get('v3/expand-field/get-reg-site', { params })
      .then((response) => {
        resolve(response)
      })
      .catch((error) => {
