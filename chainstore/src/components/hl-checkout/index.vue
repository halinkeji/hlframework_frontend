                  ...
                  <q-item class="text-center">
                    <q-item-section avatar>
                      ...
                      <q-avatar v-if="memberInfo.coverImage && memberInfo.coverImage.id" text-color="white">
                        <img :src="$q.localStorage.getItem('chainstore_system_local').attach_url + memberInfo.coverImage.path" />
                      </q-avatar>
                    ...
                    <q-item-section>
                      <q-item-label caption lines="1">{{
                        $q.localStorage.getItem('chainstore_store_local').storeBaseConfig.consume_base_balanceUnit
                      }}</q-item-label>
                      <q-item-label class="text-h5">{{ formatAmount(memberInfo.mem_memberMoneyCount) }} </q-item-label>
                    </q-item-section>
                    <q-item-section>
                      <q-item-label caption lines="1">{{
                        $q.localStorage.getItem('chainstore_store_local').storeBaseConfig.consume_base_integralUnit
                      }}</q-item-label>
                ...
                <div class="row q-col-gutter-xs q-mt-xs">
                  <div class="col-md-6 col-12" v-if="zfkMainInfo.useBalance > 0">
                    <q-item class="bg-white q-my-xs rounded-borders q-pa-sm">
                      <q-item-section>
                        <q-item-label>
                          主卡{{ $q.localStorage.getItem('chainstore_store_local').storeBaseConfig.consume_base_balanceUnit }}:
                        ...
                        <q-item-label caption
                          >开启使用主卡{{ $q.localStorage.getItem('chainstore_store_local').storeBaseConfig.consume_base_balanceUnit }}</q-item-label
                        >
                      </q-item-section>
                  ...
                  <div class="col-md-6 col-12" v-if="zfkMainInfo.useIntegral > 0">
                    <q-item class="bg-white q-my-xs rounded-borders q-pa-sm">
                      <q-item-section>
                        <q-item-label>
                          主卡{{ $q.localStorage.getItem('chainstore_store_local').storeBaseConfig.consume_base_integralUnit }}:
                  ...
                  <q-card-section class="row q-pa-xs">
                    <div class="col-3 text-center" v-for="(v, k) in paymentMethodData">
                      <div @click="selectPaymentMethod(v, k)">
                        <q-img
                          :src="v.iconImage && v.iconImage.id ? $q.localStorage.getItem('chainstore_system_local').attach_url + v.iconImage.path : ''"
                          ratio="1"
                          width="60px"
                          :class="{
                ...
                <q-card flat square class="full-width text-h6">
                  <div class="row justify-between q-py-xs">
                    ...
                    <div class="col-4 text-right q-pr-md">
                      {{ $q.localStorage.getItem('chainstore_store_local').storeBaseConfig.consume_base_moneySymbol }}{{ sc_handleMoneyCount }}
                    </div>
                  </div>
                  ...
                  <div class="row justify-between q-py-xs" v-if="sc_rulePaymentCount">
                    ...
                    <div class="col-4 text-red text-right q-pr-md">
                      -{{ $q.localStorage.getItem('chainstore_store_local').storeBaseConfig.consume_base_moneySymbol }}{{ sc_rulePaymentCount }}
                    </div>
                  </div>
                  <div class="row justify-between q-py-xs" v-if="hyryxPaymentCount">
                    <div class="col-4 q-pl-md">会员日优惠</div>
                    <div class="col-4 text-red text-right q-pr-md">
                      -{{ $q.localStorage.getItem('chainstore_store_local').storeBaseConfig.consume_base_moneySymbol }}{{ hyryxPaymentCount }}
                    </div>
                  </div>
                  ...
                  <div class="row justify-between q-py-xs" v-if="sc_couponPaymentCount">
                    ...
                    <div class="col-4 text-red text-right q-pr-md">
                      -{{ $q.localStorage.getItem('chainstore_store_local').storeBaseConfig.consume_base_moneySymbol }}{{ sc_couponPaymentCount }}
                    </div>
                  </div>
                  ...
                  <div class="row justify-between q-py-xs" v-if="sc_rounding_amount">
                    ...
                    <div class="col-4 text-red text-right q-pr-md">
                      -{{ $q.localStorage.getItem('chainstore_store_local').storeBaseConfig.consume_base_moneySymbol }}{{ sc_rounding_amount }}
                    </div>
                  </div>
                  <div class="row justify-between q-py-xs" v-if="sc_change_amount">
                    <div class="col-4 q-pl-md">现金找零</div>
                    <div class="col-4 text-red text-right q-pr-md">
                      {{ $q.localStorage.getItem('chainstore_store_local').storeBaseConfig.consume_base_moneySymbol }}{{ sc_change_amount }}
                    </div>
                  </div>
                  ...
                  <div class="row justify-between q-py-xs">
                    ...
                    <div class="col-4 text-right q-pr-md">
                      {{ $q.localStorage.getItem('chainstore_store_local').storeBaseConfig.consume_base_moneySymbol }}{{ sc_realMoneyCount }}
                    </div>
                  </div>
                </q-card>
                          ...
                          <q-item-section>
                            ...
                            <q-item-label caption>
                              折扣: <span class="text-subtitle1 text-red">{{ formatAmount(scope.opt.ic_discount_ratio) }}</span> 折 ，{{
                                $q.localStorage.getItem('chainstore_store_local').storeBaseConfig.consume_base_integralUnit
                              }}比例: 1{{ $q.localStorage.getItem('chainstore_store_local').storeBaseConfig.consume_base_moneyUnit }} =
                  ...
                  <div class="row justify-between">
                    ...
                    >
                      ...
                      <div class="text-red text-body2" v-if="v.key == 'rechargePay'">
                        <!-- 总{{ $q.localStorage.getItem('chainstore_store_local').storeBaseConfig.consume_base_balanceUnit }} :{{ $q.localStorage.getItem('chainstore_store_local').storeBaseConfig.consume_base_moneySymbol }}
                        {{ memberInfo.mem_memberMoneyCount }}  -->
                        获赠:{{ useMoneyGivePoint }}{{ $q.localStorage.getItem('chainstore_store_local').storeBaseConfig.consume_base_integralUnit }}
                      </div>
                      <div class="text-red text-body2" v-if="v.key == 'pointPay'">
                        <!-- 已用{{ $q.localStorage.getItem('chainstore_store_local').storeBaseConfig.consume_base_integralUnit }}：{{ useDiscountPoint }}， -->
                        ...
                        {{ $q.localStorage.getItem('chainstore_store_local').storeBaseConfig.consume_base_integralUnit }})
                        <!-- (总{{ $q.localStorage.getItem('chainstore_store_local').storeBaseConfig.consume_base_integralUnit }} ： {{ memberInfo.mem_memberPointsCount }}) -->
                      </div>
                      <div class="q-mt-sm text-body2" v-if="v.key == 'cashPay'">
                        <div class="text-red text-body2">
                          实收:{{ $q.localStorage.getItem('chainstore_store_local').storeBaseConfig.consume_base_moneySymbol }}
                          {{ formatAmount(sc_real_payment_cash) }}，
                          <span v-if="formatAmount(formatAmount(sc_real_payment_cash) - formatAmount(v.value)) > 0">
                            找零:{{ $q.localStorage.getItem('chainstore_store_local').storeBaseConfig.consume_base_moneySymbol }}
...
export default {
  ...
  methods: {
    checkoutPageReceive (consumeType, money, member_id, return_param = {}, couponInfo = null) {
      ...
      this.storeBaseConfig = this.$q.localStorage.getItem('chainstore_store_local').storeBaseConfig
