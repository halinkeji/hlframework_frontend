      ...
      <div class="row items-center" v-if="$q.screen.gt.md">
        ...
        <div class="col-12 col-md-7" v-if="userData.id">
          <div class="row q-pa-xs q-mt-sm">
            ...
            <div class="col-6 col-md-3">
              <q-chip square color="blue-1" text-color="blue-8">
                总{{ $q.localStorage.getItem('chainstore_store_local').storeBaseConfig.consume_base_integralUnit }}：{{
            ...
            <div class="col-6 col-md-3">
              <q-chip square color="blue-1" text-color="blue-8">
                总{{ $q.localStorage.getItem('chainstore_store_local').storeBaseConfig.consume_base_balanceUnit }}：{{
          ...
          <q-item>
            <q-item-section avatar>
              <q-avatar v-if="userData.coverImage && userData.coverImage.id" text-color="white">
                <img :src="$q.localStorage.getItem('chainstore_system_local').attach_url + userData.coverImage.path" />
              </q-avatar>
...
export default {
  ...
  mounted () {
    this.focusInput()
    this.openPlugins = this.$q.localStorage.getItem('chainstore_plugins_local').openPlugins
