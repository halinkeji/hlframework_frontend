    ...
    >
      <div class="fit column no-wrap justify-between items-stretch content-stretch no-scroll">
        <div class="col-shrink bg-white row q-px-xs q-pb-md">
          <div class="text-subtitle1">用户信息</div>
          <q-space />
            ...
            <q-form ref="modifyRef">
              ...
              <div class="q-pa-sm row q-col-gutter-sm">
                <div class="col-md-6 col-12">
                  ...
                  <q-input bottom-slots dense v-model="userInfo.piu_number" class="text-subtitle1" readonly> </q-input>
                </div>

                <div class="col-md-6 col-12">
                  <div class="text-body2 q-pa-xs">姓名 <span class="text-negative">*</span></div>
                  <q-input readonly bottom-slots v-model="userInfo.piu_name" dense :rules="[(val) => !!val || '请填写姓名']">

                  </q-input>
                </div>
                <div class="col-md-6 col-12">
                  <div class="text-body2 q-pa-xs">联系电话 <span class="text-negative">*</span></div>
                  <q-input readonly bottom-slots v-model="userInfo.piu_phone_number" dense :rules="[(val) => !!val || '请填写联系电话']"> </q-input>
                </div>

                <!-- <q-select readonly dense v-model="userInfo.piu_age" :options="ageOptions"  label="年龄" emit-value map-options /> -->

                <div class="col-md-6 col-12">
                  <div class="text-body2 q-pa-xs">年龄 <span class="text-negative">*</span></div>
                  <q-input readonly bottom-slots v-model="userInfo.piu_age" dense :rules="[(val) => !!val || '请填写年龄']">
                ...
                <div class="col-md-6 col-12">
                  ...
                  <q-input readonly bottom-slots v-model="userInfo.piu_card_id" dense :rules="[(val) => !!val || '请填写身份证号']">
                ...
                <div class="col-md-6 col-12">
                  ...
                  <q-input readonly v-model="userInfo.piu_address" dense lazy-rules :rules="[(val) => !!val || '请填写联系地址']">
                ...
                <div class="col-md-6 col-12">
                  ...
                  <q-input readonly bottom-slots type="textarea" v-model="userInfo.piu_medical_history">

                  </q-input>
                </div>
                <div class="col-md-6 col-12">
                  <div class="text-body2 q-pa-xs">备注</div>
                  <q-input readonly bottom-slots type="textarea" v-model="userInfo.piu_note">
                ...
                <q-card-section>
                  <div class="row q-col-gutter-sm items-center" v-for="(item, key) in userInfo.piu_urgent">
                    <div class="col-auto">
                      ...
                      <q-input readonly bottom-slots v-model="item.name" dense :rules="[(val) => !!val || '请填写紧急联系人姓名']"> </q-input>
                    </div>

                    <div class="col-auto">
                      <div class="text-body2 q-pa-xs">联系方式</div>
                      <q-input readonly bottom-slots dense v-model="item.model"> </q-input>
                    </div>

                    <div class="col-auto">
                      <div class="text-body2 q-pa-xs">与用户关系</div>
                      <q-input readonly bottom-slots dense v-model="item.link"> </q-input>
                    </div>
