<template>
  <div>
    <q-dialog @hide="hideNowPage" v-model="showDialog">
      ...
      <q-card
        :style="{
          width: this.$q.screen.width * 0.32 + 'px',
          'min-width': this.$q.screen.width * 0.32 + 'px'
        }"
        class="q-pa-md"
      >
          ...
          <div class="row">
            <div class="col-8">
              ...
              <div class="q-pr-xl q-mt-xs">
                <q-input
                  outlined
                  dense
                  v-model="typeData.prt_name"
                  label="分类名称"
                  lazy-rules
                  :rules="[val => (val && !!val) || '请填写名称']"
                />
              </div>
              <div class="q-mb-md">
                <q-input
                  class="q-pr-xl q-mt-xs"
                  outlined
                  dense
                  v-model="typeData.prt_description"
                  label="分类描述"
                  type="textarea"
                  rows="3"
                />
            ...
            <div class="q-mb-lg col-4 text-center">
              <hl-upload
                ...
                @input="(val)=>{ $nextTick(()=>{ typeData.prt_cover_image = val })}"
                currentTitle="分类图"
