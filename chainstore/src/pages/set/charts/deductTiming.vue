...
export default {
  ...
  methods: {
    ...
    drawLine () {
      ...
      goodsCharts.setOption({
        ...
        series: [
          {
            name: '扣除计时',
            data: this.chartsData.deductTimingData ? this.chartsData.deductTimingData : [],
            type: 'line',
            color: 'rgb(25,255,0)',
            smooth: true,
            showSymbol: false,
    ...
    getchartsData () {
      ...
      this.$store
        .dispatch('charts/getChartsDeductTimingData', params)
        .then((res) => {
          if (res.code == 200) {
