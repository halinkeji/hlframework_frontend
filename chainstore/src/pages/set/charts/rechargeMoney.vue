              ...
              <div class="q-px-sm col-2 q-pt-sm" v-for="(item, key) in chartsData.payData" :key="key">
                <q-card flat bordered>
                  <q-card-section align="center">
                    <div class="text-h5">
                      {{ $q.localStorage.getItem('chainstore_store_local').storeBaseConfig.consume_base_moneySymbol }}{{ item.amount }}
                    </div>
                  </q-card-section>
                  <q-separator />
    ...
    return {
      ...
      columnDefs: [
        ...
        },
        {
          headerName: '金额',
          valueGetter: (p) => {
            return this.$q.localStorage.getItem('chainstore_store_local').storeBaseConfig.consume_base_moneySymbol + p.data.sc_realMoneyCount
          },
