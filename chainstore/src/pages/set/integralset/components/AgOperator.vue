<template>
  <div>
    <q-btn color="primary" class="q-mx-sm" unelevated label="修改" v-if="authorityMeta('edit') && editStatus" @click="buttonShow" />
    <q-btn color="red" unelevated label="删除" v-if="authorityMeta('del') && editStatus" @click="confirmDeleteRecord" />
  </div>
</template>
