  ...
  data () {
    return {
      ...
      columnDefs: [
        ...
        {
          headerName: '总赠送' + this.$q.localStorage.getItem('chainstore_store_local').storeBaseConfig.consume_base_integralUnit,
          field: 'invoice_code',
          width: 150,
          rowSpan: this.rowSpan,
          cellClassRules: {
        ...
        {
          headerName: '总赠送' + this.$q.localStorage.getItem('chainstore_store_local').storeBaseConfig.consume_base_integralUnit + '期数',
          field: 'invoice_code',
          width: 150,
          rowSpan: this.rowSpan,
          cellClassRules: {
        ...
        {
          headerName: '赠送' + this.$q.localStorage.getItem('chainstore_store_local').storeBaseConfig.consume_base_integralUnit + '期数',
