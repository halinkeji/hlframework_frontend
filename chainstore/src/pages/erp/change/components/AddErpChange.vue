    ...
    <div class="fit column no-wrap justify-between items-stretch content-stretch no-scroll">
      <div class="col-shrink bg-white q-px-xs q-pb-md">
        <div class="q-gutter-x-xs row">
          ...
          <q-btn color="green" class="q-mt-sm" unelevated label="条码添加" :disable="searchCode" @click="addItemData(searchCode)" />
          <q-btn color="primary" class="q-mt-sm" unelevated label="选择商品" @click="selectBut" />
          <q-btn
            color="red"
            class="q-mt-sm q-mx-sm"
            :disable="changeData.length > 1 ? false : true"
            unelevated
            label="清空盘点列表"
