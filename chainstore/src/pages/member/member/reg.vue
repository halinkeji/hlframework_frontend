...
export default {
  ...
  created () {
    ...
    if (LocalStorage.getItem('chainstore_store_local').storeMemberConfig) {
      this.storeMemberConfig = LocalStorage.getItem('chainstore_store_local').storeMemberConfig
    }
    if (LocalStorage.getItem('chainstore_plugins_local').openPlugins) {
