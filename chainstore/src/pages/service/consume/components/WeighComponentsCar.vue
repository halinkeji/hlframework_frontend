      ...
      >
        <q-form ref="consumeFormRef">
          ...
          <q-card-section>
            ...
            <div class="text-caption text-grey">单价（{{ $q.localStorage.getItem('chainstore_store_local').storeBaseConfig.consume_base_moneyUnit }}/千克）</div>
          </q-card-section>
    ...
    init (val, type) {
      ...
      setTimeout(() => {
        if (that.$refs.consumeNumberRef) {
          ...
          const systemLocal = LocalStorage.getItem('chainstore_plugins_local')
