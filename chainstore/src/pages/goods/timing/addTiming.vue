            ...
            <div class="row">
              <div class="col-md-6 col-12 row">
                <div class="col-md-8 col-12">
                  <q-input label="套餐名称" class="q-mt-md" outlined v-model="dataForm.gtg_name" dense lazy-rules :rules="[(val) => !!val || '套餐名称是必填的']"> </q-input>
                </div>
                ...
                <div class="q-pa-sm col-12">
                  ...
                  <div class=" row q-gutter-md" v-if="dataForm.gtg_time_type == '3'">
                    <q-input outlined v-model="dataForm.gtg_time_start" label="开始时间" dense readonly lazy-rules :error="false" class="q-mt-xs q-mr-lg">
                    ...
                    <q-input outlined v-model="dataForm.gtg_time_end" label="结束时间" dense readonly lazy-rules :error="false" class="q-mt-xs">
                      <template v-slot:prepend>
                        <q-icon name="event" class="cursor-pointer">
                          <q-menu square :offset="[12, 10]" transition-show="jump-down" transition-hide="jump-up">
                  ...
                  <div class="q-gutter-md" v-if="dataForm.gtg_time_type == '2'">
                    <div class="row">
                      <q-input
                        outlined
                        bottom-slots
                      ...
                      <q-select outlined class="q-ml-md col-md-4 col-5" dense v-model="dataForm.gtg_time_end" :options="timeType" label="内有效" emit-value map-options />
                    </div>
                  </div>
                </div>
              </div>
  ...
  methods: {
    ...
    updateTime () {
      if (this.dataForm.gtg_time_type == 3) {
        this.dataForm.gtg_time_start = this.$q_date.formatDate(new Date(), 'YYYY-MM-DD')
        this.dataForm.gtg_time_end = this.$q_date.formatDate(new Date(), 'YYYY-MM-DD')
