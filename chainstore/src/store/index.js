...
import infoqr from './plugin/infoqr' 
import czzs from './plugin/czzs'
import tradeContract from './plugin/trade/contract' 
import tradeInfo from './plugin/trade/info' 
import tradeSet from './plugin/trade/set' 
import tradeRecharge from './plugin/trade/recharge' 
import tradeDebt from './plugin/trade/debt'
