  ...
  <div class="full-width text-center">
    <div class="q-mt-xs">
      <q-avatar size="100px" color="grey-3" v-if="avatarImage && avatarImage.path">
        <q-img :src="$q.localStorage.getItem('sspacechainstore_system_local').attach_url + avatarImage.path" width="100%" :ratio="1">
      ...
      >
        ...
        <q-card-section v-if="defaultAvatarGroup && defaultAvatarGroup.length > 0">
          ...
          <div class="row q-gutter-sm">
            ...
            >
              <q-img :src="$q.localStorage.getItem('sspacechainstore_system_local').attach_url + item.path" width="100px" height="100px">
...
export default {
  ...
  created () {
    const systemLocal = LocalStorage.getItem('sspacechainstore_system_local')
