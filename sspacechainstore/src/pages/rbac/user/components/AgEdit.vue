<template>
  <div class="row q-gutter-sm">
    <q-btn
      ...
      v-if="parseInt(params.data.store_id) > 0 && parseInt(params.data.status) >= 0 && authorityMeta('client')"
    >
    ...
    <q-btn
      ...
      v-if="parseInt(params.data.store_id) > 0 && parseInt(params.data.status) >= 0 && authorityMeta('info')"
    >
    ...
    <q-btn
      ...
      v-if="parseInt(params.data.store_id) > 0 && parseInt(params.data.status) >= 0 && authorityMeta('extend')"
    >
    ...
    <q-btn
      ...
      flat
      icon="las la-store"
      v-if="parseInt(params.data.store_id) > 0 && parseInt(params.data.status) >= 0 && authorityMeta('bindStore')"
    >
