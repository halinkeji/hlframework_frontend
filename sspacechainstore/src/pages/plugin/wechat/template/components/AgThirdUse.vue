<template>
  <div>
    <div class="row q-gutter-sm">
      <q-btn unelevated color="primary" label="编辑" @click="add = true" />
      <q-dialog v-model="add" persistent>
        <q-card style="width: 1200px; max-width: 80vw;" class="q-px-md q-py-sm">
          <q-toolbar class="q-px-none">
            <q-toolbar-title class="text-subtitle1">修改模板</q-toolbar-title>
            <q-btn flat round dense icon="close" v-close-popup size="12px" />
          </q-toolbar>
          <div class="row q-mt-sm q-col-gutter-md ">
            <div class="col-md-6 col-12">
              <div class="row items-center">
                <div class="col-2">模板名称<span class="text-red q-ml-xs">*</span></div>
                <div class="col-10">
                  <q-input outlined bottom-slots v-model="name" dense :rules="[(val) => !!val || '模板名称是必填项']" class="q-pb-none"> </q-input>
                </div>
              </div>
              <div class="row items-center q-mt-lg">
                <div class="col-2">模板消息ID<span class="text-red q-ml-xs">*</span></div>
                <div class="col-10">
                  <q-input outlined bottom-slots v-model="message" dense :rules="[(val) => !!val || '模板消息ID是必填项']" class="q-pb-none"> </q-input>
                </div>
              </div>
              <div class="row items-center q-mt-lg">
                <div class="col-2">
                ...
                <div class="col-10">
                  <q-input outlined class="bg-white" v-model="title" dense bottom-slots square>
              ...
              <div class="row items-center q-mt-lg">
                ...
                <div class="col-10" v-if="a == 1">
                  <div class="row q-mt-sm">
                    <div class="col-12">
                      <q-input outlined bottom-slots v-model="key1" dense class="q-pb-none"> </q-input>
                    </div>
                  </div>
                  <div class="row q-mt-sm">
                    <div class="col-12">
                      <q-input outlined class="bg-white" v-model="choose1" dense bottom-slots square>
                        <template v-slot:prepend>
                          <q-icon name="ion-color-palette" class="cursor-pointer">
                            <q-menu>
                  ...
                  <div class="row q-mt-sm">
                    <div class="col-12">
                      <q-input outlined bottom-slots v-model="key2" dense class="q-pb-none"> </q-input>
                    </div>
                  </div>
                  <div class="row q-mt-sm">
                    <div class="col-12">
                      <q-input outlined class="bg-white" v-model="choose2" dense bottom-slots square>
                        <template v-slot:prepend>
                          <q-icon name="ion-color-palette" class="cursor-pointer">
                            <q-menu>
              ...
              <div class="row items-center q-mt-lg">
                ...
                <div class="col-10">
                  <q-input outlined class="bg-white" v-model="end" dense bottom-slots square>
                    <template v-slot:prepend>
                      <q-icon name="ion-color-palette" class="cursor-pointer">
                        <q-menu>
              ...
              <div class="row items-center q-mt-lg">
                ...
                <div class="col-7">
                  <q-input outlined bottom-slots v-model="link" dense class="q-pb-none"> </q-input>
                </div>
                <div class="col-3">
                  <q-btn unelevated color="primary" label="选择连接" class="full-height full-width" icon-right=" keyboard_arrow_down ">
                    <q-popup-proxy>
            ...
            <div class="col-md-6 col-12">
              <q-btn unelevated color="amber" label="简易帮助" icon="error" @click="help = true" />
              <!-- 简易帮助弹窗 -->
              <q-dialog v-model="help" persistent>
                <q-card style="width: 400px; max-width: 80vw;" class="q-px-md q-py-sm">
                  <q-toolbar class="q-px-none">
                    <q-toolbar-title class="text-subtitle1">操作帮助</q-toolbar-title>
                    <q-btn flat round dense icon="close" v-close-popup size="12px" />
                  </q-toolbar>
              ...
              <q-card flat style="border:1px solid #26a69a " class="q-mt-sm ">
                ...
                <div class="row q-pa-md">
                  <div class="col-9">
                    <q-input outlined bottom-slots v-model="mbText" label="模板编号" dense class="q-pb-none"> </q-input>
                  </div>
                  <div class="col-3">
                    <q-btn unelevated color="primary" label="快速添加模板" class="full-height full-width" />
                  </div>
                </div>
              </q-card>
              <q-card flat style="border:1px solid #26a69a " class="q-mt-sm ">
                ...
                <div class="row q-pa-md">
                  <div class="col-12">
                    <q-select outlined dense v-model="model" :options="options" label="请选择" />
                  </div>

                  <div class="q-mt-sm">
                    <q-btn unelevated color="green" label="选择模板" @click="a = 1" />
                    <q-btn unelevated color="grey" label="删除模板" class="q-ml-sm" />
                  </div>
                </div>
              </q-card>
              <q-card flat style="border:1px solid #26a69a " class="q-mt-sm ">
                ...
                <div class="row q-pa-md">
                  ...
                  <div class="q-mt-sm">
                    点击变量后会自动插入选择的文本框的焦点位置，在发送给粉丝时系统会自动替换对应变量值<span class="text-red">
              ...
              <q-card flat style="border:1px solid #26a69a " class="q-mt-sm ">
                ...
                <div class="q-mt-sm q-pa-md">
                  ...
                  <div>
                    获得{{ $q.localStorage.getItem('sspacechainstore_store_local').storeBaseConfig.consume_base_integralUnit }}：keyword2.DATA
                  </div>
                  <div>
                    消费门店：keyword3.DATA
                  </div>
                  ...
                  <div>
                    当前{{ $q.localStorage.getItem('sspacechainstore_store_local').storeBaseConfig.consume_base_integralUnit }}：keyword5.DATA
                  </div>
                  <div>
                    remark.DATA
                  </div>
      ...
      <q-btn unelevated color="red" label="删除" />
      <q-btn unelevated color="green" label="校验模板" @click="change = true" />
      <q-dialog v-model="change" persistent>
        <q-card style="width: 800px; max-width: 80vw;" class="q-px-md q-py-sm">
          <q-toolbar class="q-px-none">
            <q-toolbar-title class="text-subtitle1">模板校验</q-toolbar-title>
            <q-btn flat round dense icon="close" v-close-popup size="12px" />
          </q-toolbar>
          <div class="row q-mt-sm q-mb-md">
            <div class="col-2">
              <q-btn unelevated color="primary" label="点击选择会员" class="full-height full-width" @click="choose = true" />
            ...
            <div class="col-8">
              <q-input v-model="hyText" disable standout dense> </q-input>
            </div>
            <div class="col-2">
              <q-btn unelevated color="primary" label="开始校验" class="full-height full-width" />
            </div>
          </div>
        </q-card>
      </q-dialog>
