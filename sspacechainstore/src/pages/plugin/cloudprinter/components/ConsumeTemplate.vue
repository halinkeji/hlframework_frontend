              ...
              <div v-for="(item, index, key) in defaultTemplateParams">
                <div v-if="item.status">
                  <div class="text-center" v-if="index == 'logo' || index == 'qrcode'">
                    <!-- <q-img :src="`${$q.localStorage.getItem('sspacechainstore_system_local').attach_url}` + item.value" width="60px" height="60px">
                  ...
                  <div class="q-my-sm" v-else-if="index == 'goodslist'">
