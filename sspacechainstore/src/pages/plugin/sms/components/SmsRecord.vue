    ...
    <div class="fit column no-wrap justify-between items-stretch content-stretch no-scroll">
      <div class="col-shrink bg-white q-px-xs q-py-sm">
        <div class="q-gutter-x-xs row ">
          ...
          <q-btn color="primary" class="q-mt-sm" unelevated label="搜索" v-if="authorityMeta('search')" @click="getListData" />
          <q-btn color="warning" class="q-mt-sm" unelevated label="重置" v-if="authorityMeta('reset')" @click="resetSearch" />
        </div>
      </div>
