      ...
      <div class="col-4">
        <q-card flat bordered class="text-white  q-mt-sm">
          ...
          <div class="text-h4 text-grey-8 text-center q-my-lg">
            {{ $q.localStorage.getItem('sspacechainstore_store_local').storeBaseConfig.consume_base_moneySymbol }}{{ formatAmount(contractTotal.contractCount) }}
          </div>
        </q-card>
      </div>
      <div class="col-4 ">
        <q-card flat bordered class="text-white  q-mt-sm">
          ...
          <q-separator />
          <div class="text-h4 text-grey-8 text-center q-my-lg">
            {{ $q.localStorage.getItem('sspacechainstore_store_local').storeBaseConfig.consume_base_moneySymbol }}{{ formatAmount(contractTotal.thawMessageCount) }}
          </div>
        </q-card>
      </div>
      <div class="col-4">
  ...
  data () {
    return {
      ...
      columnDefs: [
        ...
        {
          headerName: '合同金额(' + this.$q.localStorage.getItem('sspacechainstore_store_local').storeBaseConfig.consume_base_moneySymbol + ')',
