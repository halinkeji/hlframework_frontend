    ...
    <div class="col-shrink bg-white q-px-xs q-pb-md">
      ...
      <div class="row q-gutter-xs q-my-sm">
        ...
        <q-btn
          @click="refreshButton()"
          color="warning"
          :disabled="memberId > 0 ? false : true"
          class="q-mt-sm col-12 col-md-1 q-mr-sm"
          unelevated
          label="重置"
        />
  ...
  data() {
    return {
      ...
      columnDefs: [
        ...
        {
          headerName: this.$q.localStorage.getItem('sspacechainstore_store_local').storeBaseConfig.consume_base_balanceUnit + '支付',
        ...
        {
          headerName: this.$q.localStorage.getItem('sspacechainstore_store_local').storeBaseConfig.consume_base_integralUnit + '支付',
