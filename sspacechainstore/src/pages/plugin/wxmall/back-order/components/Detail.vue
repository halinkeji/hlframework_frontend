          ...
          <q-scroll-area class="fit full-height">
            <q-list separator >
              ...
              <q-item class="q-mt-sm bg-white full-width">
                <q-item-section avatar>
                  <q-img
                    ...
                    :src="$q.localStorage.getItem('sspacechainstore_system_local').attach_url + refundOrderData.coverImage.path"
                  >
              ...
              <q-item v-if="refundOrderData.goods_selling_point > 0">
                <q-item-section>
                  <q-item-label>{{ $q.localStorage.getItem('sspacechainstore_store_local').storeBaseConfig.consume_base_integralUnit }}</q-item-label>
                </q-item-section>
                <q-item-section side>
              ...
              <q-item v-if="refundOrderData.goods_selling_saving > 0">
                <q-item-section>
                  <q-item-label>{{ $q.localStorage.getItem('sspacechainstore_store_local').storeBaseConfig.consume_base_balanceUnit }}</q-item-label>
                </q-item-section>
                <q-item-section side>
...
export default {
  ...
  methods: {
    ...
    getItem (orderId) {
      ...
      this.$store
        .dispatch('wxMallOrder/backGoodsItem', { detailId: orderId })
        .then((res) => {
          if (res.code == 200) {
