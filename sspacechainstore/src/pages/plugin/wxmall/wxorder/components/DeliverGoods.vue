      ...
      <div class="fit column no-wrap justify-between items-stretch content-stretch no-scroll">
        ...
        <div class="col-shrink q-pa-sm full-height bg-white">
          <q-form ref="orderFormRef">
            <q-input outlined dense v-model="orderForm.wo_wuliu_order" :rules="[val => !!val || '请输入物流单号']" label="物流单号" />
            <q-select
              outlined
              dense
              option-value="value"
              ...
              map-options
              bottom-slots
              v-model="orderForm.wo_wuliu_company"
              :options="$store.state.wxMallOrder.wuliuCompanyOptions"
              label="选择物流公司"
