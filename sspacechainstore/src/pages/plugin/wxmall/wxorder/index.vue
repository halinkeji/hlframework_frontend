...
export default {
  ...
  methods: {
    ...
    getOrder () {
      ...
      this.$store
        .dispatch('wxMallOrder/getData', obj)
        .then((res) => {
          if (res.code == 200) {
    ...
    createWuliuOrder (orderId) {
      ...
      this.$nextTick(() => {
        this.$refs.wuliuCreateOrderRef.init(orderId, 'wxmall')
      })
    }
  }
}
