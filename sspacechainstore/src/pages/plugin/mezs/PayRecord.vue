<template>
  <div class="fit column no-wrap justify-between items-stretch content-stretch no-scroll">
    <div class="col-shrink bg-white q-px-xs q-pb-md row q-gutter-x-xs items-center">
      ...
      <div class="col-4 q-py-sm" v-if="is_main_store">
    ...
    return {
      ...
      columnDefs: [
...

        {
          ...
          width: this.nowpx(0.1) + 'px',
          valueGetter: (p) => {
            return this.$q.localStorage.getItem('sspacechainstore_store_local').storeBaseConfig.consume_base_moneySymbol + p.data.pmr_real_pay_amount
          }
        },
        {
          headerName: '时间',
