    ...
    return {
      ...
      columnDefs: [
        ...
        },
        {
          headerName: '应付金额',
          valueGetter: (p) => {
            return this.$q.localStorage.getItem('sspacechainstore_store_local').storeBaseConfig.consume_base_moneySymbol + p.data.hr_handle_amount
          },
          width: this.nowpx(0.15) + 'px'
        },
        {
          headerName: '实付金额',
          valueGetter: (p) => {
            return this.$q.localStorage.getItem('sspacechainstore_store_local').storeBaseConfig.consume_base_moneySymbol + p.data.hr_real_amount
          },
          width: this.nowpx(0.15) + 'px'
        },
        {
        ...
        },
        {
          headerName: '折扣金额',
          valueGetter: (p) => {
            return this.$q.localStorage.getItem('sspacechainstore_store_local').storeBaseConfig.consume_base_moneySymbol + p.data.hr_discount_amount
          },
          width: this.nowpx(0.15) + 'px'
        },
        {
          headerName: this.$q.localStorage.getItem('sspacechainstore_store_local').storeBaseConfig.consume_base_integralUnit + '倍数',
