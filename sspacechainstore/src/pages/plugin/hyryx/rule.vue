      ...
      <div class="bg-white">
        <q-card flat class="q-py-sm q-px-xs row q-gutter-xs">
          <div class="col-12 col-md-1">
            <q-input outlined dense v-model="ruleName" label="规则名称" />
          </div>
          ...
          <div class="col-12 col-md-1">
            <q-select outlined dense v-model="ruleType" :options="typeOptions" label="规则类型" option-label="label" emit-value map-options />
          </div>
          <div class="col-12 col-md-1">
          ...
          <q-btn unelevated color="primary" dense label="新增" :to="{ name: 'hyryxAddRule' }" class="q-px-md" v-if="authorityMeta('addRule')" />
          <q-btn
            unelevated
            color="red"
...
export default {
  ...
  methods: {
    ...
    getList () {
      ...
      this.$store
        .dispatch('hyryx/getRuleListData', obj)
        .then((res) => {
