        ...
        <div class="row justify-around">
          ...
          <div class="q-gutter-y-sm col-3">
            ...
            <div class="row">
              ...
              <div class="col-6" v-if="memberData.ftr_take_mode == 'balance'">：{{ $q.localStorage.getItem('sspacechainstore_store_local').storeBaseConfig.consume_base_balanceUnit }}</div>
