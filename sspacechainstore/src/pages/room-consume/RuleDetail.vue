<template>
  <q-card flat bordered class="column no-wrap">
    <q-card-section class="row items-center q-py-sm">
      <div class="text-subtitle2 text-weight-bold">计费模式详情</div>
      <q-space />
    </q-card-section>
    ...
    <q-card-section class="full-height">
      <q-form ref="roomGroupDataRef" class="row q-col-gutter-sm">
        ...
        <div class="col-6">
          <q-item class="bg-grey-2">
            <q-item-section>
              <q-item-label caption>开台后：</q-item-label>
            </q-item-section>
            <q-item-section side>
              <q-item-label class="text-dark">
            ...
            <q-item-section>
              <q-item-label class="text-dark">
                ...
                <span v-if="extraAmountConfig && parseInt(extraAmountConfig.userType) == 1">
                  开台后：<span class="text-subtitle2 text-primary">{{ extraAmountConfig.exceedMinutesInner }} </span>分钟之内，按
