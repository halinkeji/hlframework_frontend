            ...
            <template v-slot:item="props">
              <div class="q-pa-xs col-xs-12 col-sm-6 col-md-2">
                <q-card @click="confirmWeighResult(props.row)" flat bordered>
                  <q-img
                  :src="currentGoodsInfo.coverImage && currentGoodsInfo.coverImage.id ? $q.localStorage.getItem('sspacechainstore_system_local').attach_url + currentGoodsInfo.coverImage.path : ''"
                    :ratio="1"
                  class="full-width"
                      >
