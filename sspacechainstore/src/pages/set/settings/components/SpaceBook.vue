      ...
      <div class="col-md-4 col-12 q-pr-md q-mt-md">
        <q-card bordered flat>
          <q-card-section>
            ...
            <q-toggle
              v-model="roomConsumeDataForm.consume_spaceBook_moneyCashSwitch"
              color="green"
              :true-value="'1'"
              :false-value="'0'"
              class="float-right"
              @input="handleSwitchChange(roomConsumeDataForm.consume_spaceBook_moneyCashSwitch, 'consume_spaceBook_moneyCashSwitch')"
            />
          </q-card-section>
          <q-separator />
          <div class="q-ma-md">
          ...
          <q-input
            outlined
            bottom-slots
            v-model="roomConsumeDataForm.consume_spaceBook_moneyCashRatio"
            dense
            :rules="[(val) =>  (val ?  /^(([1-9]{1}\d*)|(0{1}))(\.\d{1,2})?$/.test(val) && val >= 1 && val <= 100 : true) || '请输入正确的数值']"
            class="q-px-md"
            @change="inputChange(roomConsumeDataForm.consume_spaceBook_moneyCashRatio, 'consume_spaceBook_moneyCashRatio')"
          >
          </q-input>
        </q-card>
      </div>
      <div class="col-md-4 col-12 q-pr-md q-mt-md">
        <q-card bordered flat>
          <q-card-section>
            ...
            <q-toggle
              v-model="roomConsumeDataForm.consume_spaceBook_moneyGivePointSwitch"
              color="green"
              :true-value="'1'"
              :false-value="'0'"
              class="float-right"
              @input="handleSwitchChange(roomConsumeDataForm.consume_spaceBook_moneyGivePointSwitch, 'consume_spaceBook_moneyGivePointSwitch')"
            />
          </q-card-section>
          <q-separator />
          <div class="q-ma-md">
          ...
          <q-input
            outlined
            bottom-slots
            v-model="roomConsumeDataForm.consume_spaceBook_moneyGivePointRatio"
            @change="inputChange(roomConsumeDataForm.consume_spaceBook_moneyGivePointRatio, 'consume_spaceBook_moneyGivePointRatio')"
            dense
      ...
      <div class="col-md-4 col-12 q-pr-md q-mt-md">
        <q-card bordered flat>
          <q-card-section>
            ...
            <q-toggle
              v-model="roomConsumeDataForm.consume_spaceBook_pointCashSwitch"
              color="green"
              :true-value="'1'"
              :false-value="'0'"
              class="float-right"
              @input="handleSwitchChange(roomConsumeDataForm.consume_spaceBook_pointCashSwitch, 'consume_spaceBook_pointCashSwitch')"
            />
          </q-card-section>
          <q-separator />
          <div class="q-ma-md">
          ...
          <q-input
            outlined
            bottom-slots
            v-model="roomConsumeDataForm.consume_spaceBook_pointCashRatio"
            dense
            :rules="[(val) =>  (val ?  /^(([1-9]{1}\d*)|(0{1}))(\.\d{1,2})?$/.test(val) && val >= 1 && val <= 100 : true) || '请输入正确的数值']"
            class="q-px-md"
            @change="inputChange(roomConsumeDataForm.consume_spaceBook_pointCashRatio, 'consume_spaceBook_pointCashRatio')"
          >
          </q-input>
        </q-card>
      </div>
      <div class="col-md-4 col-12 q-pr-md q-mt-md">
        <q-card bordered flat>
          <q-card-section>
            ...
            <q-toggle
              v-model="roomConsumeDataForm.consume_spaceBook_pointUseCashSwitch"
              color="green"
              :true-value="'1'"
              :false-value="'0'"
              class="float-right"
              @input="handleSwitchChange(roomConsumeDataForm.consume_spaceBook_pointUseCashSwitch, 'consume_spaceBook_pointUseCashSwitch')"
            />
          </q-card-section>
          <q-separator />
          <div class="q-ma-md">
          ...
          <q-input
            outlined
            bottom-slots
            v-model="roomConsumeDataForm.consume_spaceBook_pointUseCashSRatio"
            dense
            :rules="[(val) => (val ?  /^(0|[1-9]\d*)(.\d{1,2})?$/.test(val) && val >= 1 : true) || '请输入正确的数值' ]"
            class="q-px-md"
            @change="inputChange(roomConsumeDataForm.consume_spaceBook_pointUseCashSRatio, 'consume_spaceBook_pointUseCashSRatio')"
          >
          </q-input>
        </q-card>
      </div>
...
export default {
  ...
  data () {
    return {
      roomConsumeDataForm: {
        consume_spaceBook_pointSwitch: 0,
        consume_spaceBook_pointRatio: '',
        consume_spaceBook_levelSwitch: 0,
        consume_spaceBook_moneyCashSwitch: 0,
        consume_spaceBook_moneyCashRatio: '',
        consume_spaceBook_moneyGivePointSwitch: 0,
        consume_spaceBook_moneyGivePointRatio: '',
        consume_spaceBook_pointCashSwitch: 0,
        consume_spaceBook_pointCashRatio: '',
        consume_spaceBook_pointUseCashSwitch: 0,
        consume_spaceBook_pointUseCashSRatio: ''
      }
    }
  },
  mounted () {
