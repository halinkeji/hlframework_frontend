  ...
  <div class="fit column no-wrap justify-between items-stretch content-stretch no-scroll">
    <div class="col-shrink bg-white full-height ">
      <q-form ref="invoiceDataRef" class="q-gutter-md">
        ...
        <div class="row">
          <q-input outlined dense class=" col-12 col-md-4 q-mb-sm q-px-sm" v-model="merchantFrom.prefix_invoice_roomConsume" label="营业消费单据前缀" />
            <q-input outlined dense class=" col-12 col-md-4 q-mb-sm q-px-sm" v-model="merchantFrom.prefix_invoice_addSpaceTimeCard" label="时卡购买单据前缀" />
              <q-input outlined dense class=" col-12 col-md-4 q-mb-sm q-px-sm" v-model="merchantFrom.prefix_invoice_spaceBook" label="桌台预订单据前缀" />
          ...
          <q-input outlined dense class=" col-12 col-md-4 q-mb-sm q-px-sm" v-model="merchantFrom.prefix_invoice_deductMoney" :label="`${$q.localStorage.getItem('sspacechainstore_store_local').storeBaseConfig.consume_base_balanceUnit}扣费单据前缀`" />
          <q-input outlined dense class=" col-12 col-md-4 q-mb-sm q-px-sm" v-model="merchantFrom.prefix_invoice_addPoints" :label="`增加${$q.localStorage.getItem('sspacechainstore_store_local').storeBaseConfig.consume_base_integralUnit}单据前缀`" />
          <q-input outlined dense class=" col-12 col-md-4 q-mb-sm q-px-sm" v-model="merchantFrom.prefix_invoice_deductPoint" :label="`${$q.localStorage.getItem('sspacechainstore_store_local').storeBaseConfig.consume_base_integralUnit}扣除单据前缀`" />
...
export default {
  ...
  data () {
    return {
      merchantFrom: {
        prefix_invoice_roomConsume: '',
        prefix_invoice_addSpaceTimeCard: '',
        prefix_invoice_spaceBook: '',
