      ...
      <div class="col-md-4 col-12 q-pr-md q-mt-md">
        <q-card bordered flat>
          <q-card-section>
            ...
            <q-toggle
              v-model="roomConsumeDataForm.consume_roomConsume_moneyCashSwitch"
              color="green"
              :true-value="'1'"
              :false-value="'0'"
              class="float-right"
              @input="handleSwitchChange(roomConsumeDataForm.consume_roomConsume_moneyCashSwitch, 'consume_roomConsume_moneyCashSwitch')"
            />
          </q-card-section>
          <q-separator />
          <div class="q-ma-md">
          ...
          <q-input
            outlined
            bottom-slots
            v-model="roomConsumeDataForm.consume_roomConsume_moneyCashRatio"
            dense
            :rules="[(val) =>  (val ?  /^(([1-9]{1}\d*)|(0{1}))(\.\d{1,2})?$/.test(val) && val >= 1 && val <= 100 : true) || '请输入正确的数值']"
            class="q-px-md"
            @change="inputChange(roomConsumeDataForm.consume_roomConsume_moneyCashRatio, 'consume_roomConsume_moneyCashRatio')"
          >
          </q-input>
        </q-card>
      </div>
      <div class="col-md-4 col-12 q-pr-md q-mt-md">
        <q-card bordered flat>
          <q-card-section>
            ...
            <q-toggle
              v-model="roomConsumeDataForm.consume_roomConsume_moneyGivePointSwitch"
              color="green"
              :true-value="'1'"
              :false-value="'0'"
              class="float-right"
              @input="handleSwitchChange(roomConsumeDataForm.consume_roomConsume_moneyGivePointSwitch, 'consume_roomConsume_moneyGivePointSwitch')"
            />
          </q-card-section>
          <q-separator />
          <div class="q-ma-md">
          ...
          <q-input
            outlined
            bottom-slots
            v-model="roomConsumeDataForm.consume_roomConsume_moneyGivePointRatio"
            @change="inputChange(roomConsumeDataForm.consume_roomConsume_moneyGivePointRatio, 'consume_roomConsume_moneyGivePointRatio')"
            dense
      ...
      <div class="col-md-4 col-12 q-pr-md q-mt-md">
        <q-card bordered flat>
          <q-card-section>
            ...
            <q-toggle
              v-model="roomConsumeDataForm.consume_roomConsume_pointCashSwitch"
              color="green"
              :true-value="'1'"
              :false-value="'0'"
              class="float-right"
              @input="handleSwitchChange(roomConsumeDataForm.consume_roomConsume_pointCashSwitch, 'consume_roomConsume_pointCashSwitch')"
            />
          </q-card-section>
          <q-separator />
          <div class="q-ma-md">
          ...
          <q-input
            outlined
            bottom-slots
            v-model="roomConsumeDataForm.consume_roomConsume_pointCashRatio"
            dense
            :rules="[(val) =>  (val ?  /^(([1-9]{1}\d*)|(0{1}))(\.\d{1,2})?$/.test(val) && val >= 1 && val <= 100 : true) || '请输入正确的数值']"
            class="q-px-md"
            @change="inputChange(roomConsumeDataForm.consume_roomConsume_pointCashRatio, 'consume_roomConsume_pointCashRatio')"
          >
          </q-input>
        </q-card>
      </div>
      <div class="col-md-4 col-12 q-pr-md q-mt-md">
        <q-card bordered flat>
          <q-card-section>
            ...
            <q-toggle
              v-model="roomConsumeDataForm.consume_roomConsume_pointUseCashSwitch"
              color="green"
              :true-value="'1'"
              :false-value="'0'"
              class="float-right"
              @input="handleSwitchChange(roomConsumeDataForm.consume_roomConsume_pointUseCashSwitch, 'consume_roomConsume_pointUseCashSwitch')"
            />
          </q-card-section>
          <q-separator />
          <div class="q-ma-md">
          ...
          <q-input
            outlined
            bottom-slots
            v-model="roomConsumeDataForm.consume_roomConsume_pointUseCashSRatio"
            dense
            :rules="[(val) => (val ?  /^(0|[1-9]\d*)(.\d{1,2})?$/.test(val) && val >= 1 : true) || '请输入正确的数值' ]"
            class="q-px-md"
            @change="inputChange(roomConsumeDataForm.consume_roomConsume_pointUseCashSRatio, 'consume_roomConsume_pointUseCashSRatio')"
          >
          </q-input>
        </q-card>
      </div>
...
export default {
  ...
  data () {
    return {
      roomConsumeDataForm: {
        consume_roomConsume_pointSwitch: 0,
        consume_roomConsume_pointRatio: '',
        consume_roomConsume_levelSwitch: 0,
        consume_roomConsume_moneyCashSwitch: 0,
        consume_roomConsume_moneyCashRatio: '',
        consume_roomConsume_moneyGivePointSwitch: 0,
        consume_roomConsume_moneyGivePointRatio: '',
        consume_roomConsume_pointCashSwitch: 0,
        consume_roomConsume_pointCashRatio: '',
        consume_roomConsume_pointUseCashSwitch: 0,
        consume_roomConsume_pointUseCashSRatio: ''
      }
    }
  },
  mounted () {
