...
export default {
  ...
  data () {
    return {
      ...
      columnDefs: [
        ...
        {
          headerName: '变更' + this.$q.localStorage.getItem('sspacechainstore_store_local').storeBaseConfig.consume_base_integralUnit,
        ...
        {
          headerName: this.$q.localStorage.getItem('sspacechainstore_store_local').storeBaseConfig.consume_base_integralUnit + '来源',
        ...
        {
          headerName: this.$q.localStorage.getItem('sspacechainstore_store_local').storeBaseConfig.consume_base_integralUnit + '状态',
  ...
  methods: {
    ...
    exportBut () {
      ...
      this.gridOptions.api.exportDataAsCsv({ fileName: date + '-' + this.$q.localStorage.getItem('sspacechainstore_store_local').storeBaseConfig.consume_base_integralUnit + '记录' })
    },
    pinnedComputed (val) {
      const nowWidth = this.$q.screen.width
      let pinned = val
