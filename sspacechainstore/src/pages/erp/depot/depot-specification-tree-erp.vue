      ...
      <div class="fit column no-wrap justify-between items-stretch content-stretch no-scroll">
        <div class=" q-ml-md q-mt-md">
          ...
          <div class="row ">
            ...
            <q-btn color="primary" class=" q-mt-sm q-mx-md" unelevated @click="getInquireType(goodsModel,this.depotId)">搜索</q-btn>
  ...
  methods: {
    ...
    getInquireType (val, depotId) {
      ...
      const obj = {
        ...
        type: this.goodsModel,
        text: this.searchValue,
        page: this.page.pageIndex,
        pSize: this.page.pageSize
      }
      this.$store
        .dispatch('components/getDepotGoods', obj)
        .then((res) => {
          if (res.code == 200) {
    ...
    sizeChangeHandle (val) {
      ...
      this.getInquireType(this.goodsModel, this.depotId)
    },
    // 当前页
