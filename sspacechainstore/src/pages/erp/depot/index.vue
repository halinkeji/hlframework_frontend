  ...
  <q-page class="fit">
    <div class="fit column no-wrap justify-between items-stretch content-stretch no-scroll">
      <div class="col-shrink bg-white q-px-xs q-pb-md q-pt-sm row q-gutter-xs">
        ...
        <q-btn unelevated color="positive" dense label="仓库调拨" :disable="parseInt($q.localStorage.getItem('sspacechainstore_store_local').storeErpConfig.erp_erp_depotStatus) == 0 ? true : false" :to="{ name: 'erpDepotTurn' }" v-if="authorityMeta('turnButton')" class="q-px-md" />
      </div>
