  ...
  <div class="fit column no-wrap justify-between items-stretch content-stretch no-scroll">
    <div class="col-shrink bg-white q-px-xs q-pb-md">
      <div class="q-gutter-xs row">
        <div class="col">
          <q-input outlined v-model="search" clearable label="单据号/商品名称" dense />
        </div>
        ...
        <q-btn color="primary" size="md" unelevated label="搜索" @click="getList" />
        ...
        <q-btn color="primary" unelevated @click="exportCsv" v-if="authorityMeta('out')" label="导出" :disable="goodsInListData.length == 0" />
      </div>
    </div>
