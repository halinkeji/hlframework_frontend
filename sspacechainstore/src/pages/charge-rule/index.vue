    ...
    <div class="fit column no-wrap justify-between items-stretch content-stretch no-scroll">
      <div class="col-shrink bg-white q-pb-md row q-gutter-sm">
        <div class="col-12 col-md-2">
          <q-input outlined dense v-model="typeData.qcr_name" label="请输入名称" />
        </div>
...
export default {
    ...
    return {
      ...
      columnDefs: [
...

        {
          ...
          field: 'id',
          width: this.nowpx(0.15) + 'px',
          cellRendererFramework: 'RuleDetail'
        },
        {
          headerName: '门店',
          field: 'store.name',
  ...
  methods: {
    getList () {
      ...
      const params = {
        name: this.typeData.qcr_name,
        page: this.page.pageIndex,
        pSize: this.page.pageSize
      }
      this.$store
        .dispatch('chargeRule/getRuleList', params)
        .then((res) => {
          if (res.code == 200) {
