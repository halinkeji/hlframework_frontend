              ...
              <q-card bordered flat>
                ...
                <q-card-section>
                  <div class="text-grey text-caption">
                    <q-icon name="las la-exclamation-circle"  color="grey" /> T + 0 : 消费后的当天即可进行结算，非交易日也可以进行结算（交易日为：周一至周五）。
                  </div>
                   <div class="text-grey text-caption">
                    <q-icon name="las la-exclamation-circle"  color="grey" /> T + 1 : 消费后的第二天可进行结算，必须在交易日才可以进行结算（交易日为：周一至周五）。
                  </div>
