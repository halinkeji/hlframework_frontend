...
export const isLocalStorageTokenExpir = () => {
  const expiredTime = parseInt(
    LocalStorage.getItem('sspacechainstore_accessToken_info').expires
  )
  /* 获取本地时间 */
...
export const isAuthenticated = () => {
  return (
    LocalStorage.getItem('sspacechainstore_loggedIn') &&
    Cookies.get('access_token') ===
      LocalStorage.getItem('sspacechainstore_access_token')
  )
}

export const isCurrentApply = () => {
  const storageAccountInfo = LocalStorage.getItem('sspacechainstore_account_info')
  if (storageAccountInfo && storageAccountInfo.apply_id) {
    if (storageAccountInfo.apply_id != 'sspacechainstore') {
      return false
    }
  }
...
export function setAllLocalStorage () {
  LocalStorage.set('sspacechainstore_access_token', Cookies.get('access_token'))
  LocalStorage.set('sspacechainstore_expires_in', Cookies.get('expires_in'))
  LocalStorage.set('sspacechainstore_refresh_token', Cookies.get('refresh_token'))
  LocalStorage.set('sspacechainstore_token_type', Cookies.get('token_type'))
  LocalStorage.set('sspacechainstore_loggedIn', Cookies.get('loggedIn'))
  LocalStorage.set(
    'sspacechainstore_accessToken_info',
    Cookies.get('accessToken_info')
  )
  LocalStorage.set('sspacechainstore_user_info', Cookies.get('user_info'))
  LocalStorage.set('sspacechainstore_account_info', Cookies.get('account_info'))
