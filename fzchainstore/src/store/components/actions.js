...
let siteUrl = ''
if (LocalStorage.getItem('fzchainstore_system_local')) {
  const systemInfo = LocalStorage.getItem('fzchainstore_system_local').systemInfo
...
export function addCloudGoosdData ({ commit }, params) {
  return new Promise((resolve, reject) => {
    api
      .post('v3/clothing-archives/add-cloud-goosd-data', params)
      .then((response) => {
        resolve(response)
      })
      .catch((error) => {
...
export function getListErpData ({ commit }, item) {
  return new Promise((resolve, reject) => {
    api
      .get('v3/clothing-archives/erp', { params: item })
      .then((response) => {
        resolve(response)
      })
      .catch((error) => {
...
export function getGoodsListData ({ commit }, params) {
  return new Promise((resolve, reject) => {
    api
      .get('v3/clothing-archives/archives', { params })
      .then((response) => {
        resolve(response)
      })
      .catch((error) => {
