...
export function getHangTagTemple({ commit }, params) {
  return new Promise((resolve, reject) => {
    api
      .get('cloudprinter/v1/lable/hangtag')
      .then((response) => {
        resolve(response);
      })
      .catch((error) => {
...
export function getGoodsLableTemplefz({ commit }, params) {
  return new Promise((resolve, reject) => {
    api
      .post('cloudprinter/v1/lable/goods-temple-fz',params )
      .then((response) => {
        resolve(response);
      })
      .catch((error) => {
...
export function getGoodsLableTemple({ commit }, params) {
  return new Promise((resolve, reject) => {
    api
      .get('cloudprinter/v1/lable/goods-temple',{ params })
      .then((response) => {
        resolve(response);
      })
      .catch((error) => {
