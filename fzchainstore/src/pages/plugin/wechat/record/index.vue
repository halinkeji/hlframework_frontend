    ...
    <div class="fit column no-wrap justify-between items-stretch content-stretch no-scroll">
      <div class="col-shrink bg-white q-px-xs q-pb-md">
        <div class="q-gutter-x-xs row q-pl-xs q-px-sm">
          ...
          <q-btn color="primary" class="q-mt-sm" unelevated label="查询" v-if="authorityMeta('search')" @click="getList" />
          <q-btn color="grey-6" class="q-mt-sm" unelevated label="重置" @click="cleanBtn" v-if="authorityMeta('reset')" />
        </div>
      </div>
