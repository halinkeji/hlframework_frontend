...
export default {
  ...
  computed: {
    entranceUrl () {
      ...
      if (account_info && system_local) {
        let url = system_local.systemInfo.site_url + '/m/fzchainstore/?id=' + account_info.lib_id
    ...
    manageEntranceUrl () {
      ...
      const system_local = this.$q.localStorage.getItem('fzchainstore_system_local')
      if (account_info && system_local) {
        return system_local.systemInfo.site_url + '/m/fzchainstore/manage/index?id=' + account_info.lib_id
      }
    }
  },
  created () {},
  ...
  methods: {
    ...
    getNoticeUrl () {
      ...
      const system_local = this.$q.localStorage.getItem('fzchainstore_system_local')
      if (account_info && system_local) {
        this.notice_url = system_local.systemInfo.site_url + '/fzchainstore/wechat/default/wechat-event?id=' + account_info.lib_id
      }
    }
  }
}
