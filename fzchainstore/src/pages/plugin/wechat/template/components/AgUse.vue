...
export default {
  ...
  data () {
    return {
      ...
      options: ['1', '2', '3'],
      modelOne: null,
      optionsOne: ['申请确认通知', '会员消费提醒', this.$q.localStorage.getItem('fzchainstore_store_local').storeBaseConfig.consume_base_integralUnit + '兑换成功通知'],
      modelT: null,
      optionsT: ['申请确认通知', '会员消费提醒', this.$q.localStorage.getItem('fzchainstore_store_local').storeBaseConfig.consume_base_integralUnit + '兑换成功通知'],
      modelFan: null,
