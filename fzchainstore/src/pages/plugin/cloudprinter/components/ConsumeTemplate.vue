              ...
              <div v-for="(item, index, key) in defaultTemplateParams">
                <div v-if="item.status">
                  <!-- <div class="text-center" v-if="index == 'logo' || index == 'qrcode'">
                    <q-img :src="`${$q.localStorage.getItem('fzchainstore_store_local').attach_url}` + item.value" width="60px" height="60px">
                  ...
                  <div class="text-center text-h6" v-if="index == 'title'">
                    {{ item.value }}
                  </div>
                  <div class="text-center" v-else-if="index == 'foot'">
                    {{ item.value }}
                  </div>
                  <div class="q-my-sm" v-else-if="index == 'goodsFzChainlist'">
                  ...
                  <div class="q-my-sm" v-else-if="index == 'countGoodsList'">
                    <div class="text-center">
                      {{ item.value }}
                    </div>
                    <div class="row q-pl-xl">
                  ...
                  <div class="q-my-sm" v-else-if="index == 'countGroupGoodsList'">
                    <div class="text-center">
                      {{ item.value }}
                    </div>
                    <div class="row q-pl-xl">
                  ...
                  <div class="q-my-sm" v-else-if="index == 'deductCountList'">
                    <div class="text-center">
                      {{ item.value }}
                    </div>
                    <div class="row q-pl-xl">
                  ...
                  <div class="q-my-sm" v-else-if="index == 'addDurationDeatail'">
                    <div class="text-center">
                      {{ item.value }}
                    </div>
                    <div class="row q-pl-xl">
                  ...
                  <div class="q-my-sm" v-else-if="index == 'addGroupDurationDeatail'">
                    <div class="text-center">
                      {{ item.value }}
                    </div>
                    <div class="row q-pl-xl">
                  ...
                  <div class="q-my-sm" v-else-if="index == 'deductDurationList'">
                    <div class="text-center">
                      {{ item.value }}
                    </div>
                    <div class="row q-pl-xl">
                ...
                <q-card class="q-mt-sm items-center  q-pa-md" bordered flat>
                  <div class="row items-start">
                    ...
                    <div class="col-3 offset-1">
                      <q-select outlined dense v-model="templateForm.pct_page_width" :options="['58mm', '88mm']" label="纸张" />
                    </div>
                  </div>
                </q-card>
    ...
    return {
      ...
      templateData: {
        ...
        addGroupDuration: {
          ...
          addGroupDurationDeatail: {
            label: '充时详情',
            name: 'addGroupDurationDeatail',
            sort: '5',
            status: 1,
            value: '************充时详情************'
          },
