            ...
            <q-form ref="printerDataRef">
              <div class="row">
                  ...
                  <q-card class="my-card" flat bordered>
                    <q-card-section horizontal>
                      <q-card-section class="q-pt-xs row">
                        <div class="text-subtitle2 q-mt-sm q-mb-xs col-12">吊牌用途：商品吊牌</div>
                        <div class="text-subtitle2 q-mt-sm q-mb-xs col-12">
                          <q-select
                            outlined
                            label="打印机类型"
                            v-model="lableTemplate.ccl_printer_modle"
                            :options="[{ label: '40*100', value: '3' }]"
                            dense
                            emit-value
                            map-options
                          >
                            <template v-slot:before>
                              <span class="text-body2 text-black"> 吊牌纸尺寸： </span>
                            </template>
                          </q-select>
                        </div>
                        <div class="text-subtitle2 q-mt-sm q-mb-xs col-12">
                          <q-input outlined dense v-model="lableTemplate.ccl_printer_number">
                            <template v-slot:before>
                              <span class="text-body2 text-black"> 吊牌打印联数: </span>
                            </template></q-input
                          >
                        </div>
                        <!-- <div class="text-subtitle2 q-mt-sm q-mb-xs col-12">
                          <q-input outlined dense v-model="lableTemplate.ccl_lable_interval">
                            <template v-slot:before>
                              <span class="text-body2 text-black"> 吊牌间隙： </span>
                            </template></q-input
                          >
                        </div> -->
                      </q-card-section>
                ...
                <div class="col-4 q-pl-sm">
                  <q-card class="my-card" flat bordered>
                    ...
                    <q-card-section horizontal>
                      ...
                      <q-separator vertical v-if="sumContent.type"/>
                      <q-card-section>
                        <!-- {{ sumContent.style }} -->
                        ...
                        <q-btn
                          ...
                          color="red"
                          class="q-px-xl"
                          v-if="sumContent.type && templateContent.length > 0"
                        />
                      </q-card-section>
                    </q-card-section>
                  </q-card>
                ...
                <div class="col-4 q-pl-sm">
                  <q-card class="my-card" flat bordered>
                    <q-card-section class="q-pt-xs">
                      <div class="text-h6">吊牌样式</div>
                    </q-card-section>
                    <q-separator />
                    <q-card flat bordered :style="'height: 400px; width: 160px;'" style="margin: 0 auto" class="my-card bg-grey-1 q-pt-lg">
                      <div v-for="(bit, btnKey) in sysemData" :key="btnKey" clasa="q-pt-lg">
...
export default {
  ...
  methods: {
    ...
    getItem() {
      this.$store.dispatch('cloudprinter/getHangTagTemple').then((res) => {
          ...
          this.$store
            ...
            .then((res) => {
              if (res.code == 200) {
                this.$q.notify({
                  message: '成功',
                  caption: `${this.$route.query.id > 0 ? '修改' : '新增'}` + '吊牌模板成功',
