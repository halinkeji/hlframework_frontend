  ...
  <div class="fit column no-wrap justify-between items-stretch content-stretch no-scroll">
    <div class="col-shrink bg-white q-px-sm q-pb-md">
      <div class="row q-gutter-x-sm">
        <q-input class="col-12 col-md-2 q-mt-sm q-mr-xs" label="可搜索会员卡号/会员昵称" outlined v-model="searchData" dense />
        <div class="col-12 col-md-3 q-mt-sm q-mr-xs">
        ...
        <q-btn @click="getCheckinList()" color="primary" class="col-12 col-md-1 q-mt-sm" unelevated label="搜索" />
