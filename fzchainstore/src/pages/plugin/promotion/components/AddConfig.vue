                      ...
                      <div v-else>
                        ...
                        <q-item tag="label" v-ripple>
                          ...
                          <q-item-section>
                            ...
                            <q-item-label caption>
                              选择的商品买满一定数量时执行新价格，例如：原价150元的玉兰油买满2瓶则每瓶特价140元。
                            </q-item-label>
                          </q-item-section>
                        </q-item>
                        ...
                        <q-item tag="label" v-ripple>
                          ...
                          <q-item-section>
                            ...
                            <q-item-label caption>
                              根据指定范围，任意选择N件M元，比如某个类别的商品任意选择3件100元。
                            </q-item-label>
                          </q-item-section>
                        </q-item>
                      </div>
                      ...
                      <div v-else>
                        <q-item tag="label" v-ripple>
                          ...
                          <q-item-section>
                            ...
                            <q-item-label caption>
                              买满一定金额，减一定金额，按倍数减，例如买满100减20，那么买满200减20*2。
                            </q-item-label>
                          </q-item-section>
                        </q-item>
                        <q-item tag="label" v-ripple>
                          ...
                          <q-item-section>
                            ...
                            <q-item-label caption>
                              买满一定金额，减一定金额，固定直减，例如买满100减10，那么买满200还是减10。
                            </q-item-label>
                          </q-item-section>
                        </q-item>
                        <q-item tag="label" v-ripple>
                        ...
                        <q-item tag="label" v-ripple>
                          ...
                          <q-item-section>
                            ...
                            <q-item-label caption>
                              买满一定数量，赠送商品，例如买1个牙膏送赠品A或者B，买2个牙膏送赠品A或者B。
                            </q-item-label>
                          </q-item-section>
                        </q-item>
                        <q-item tag="label" v-ripple>
                          ...
                          <q-item-section>
                            ...
                            <q-item-label caption>
                              买满一定数量的商品送低价商品，如：买5送2，赠送最低价的那2个商品。
                            </q-item-label>
                          </q-item-section>
                        </q-item>
                      </div>
              ...
              <q-card flat bordered square class="rounded-borders q-mt-xs q-pa-sm">
                ...
                <div class="row q-py-lg q-px-md q-col-gutter-md" v-if="dataForm.ppi_discounts_scope == '2'">
                  ...
                  <div class="col-md-12 row q-py-lg q-col-gutter-md">
                    ...
                    <div class="col-md-2 col-12 q-pt-none">
                      <q-select outlined dense v-model="years" :options="yearsData" option-label="cp_name" label="选择年份" />
                    </div>
                    <div class="col-md-2 col-12 q-pt-none">
                      <q-select outlined dense v-model="season" :options="seasonData" option-label="cp_name" label="选择季度" />
                    </div>
                    <div class="col-md-2 col-12 q-pt-none">
                      <q-btn-group unelevated>
                  ...
                  <div class="col-md-12 col-12 q-pt-none">
                    <div class="row" v-for="(item, normIndex) in detailData" :key="normIndex">
                      ...
                      <div class="col-md-1 col-12">
                        <q-input v-model="item.ppd_years_name" outlined bottom-slots dense label="年份" class="q-mt-md" readonly />
                      </div>
                      <div class="col-md-1 col-12 q-mx-sm">
                        <q-input v-model="item.ppd_season_name" outlined bottom-slots dense label="季度" class="q-mt-md" readonly />
                      </div>
  ...
  methods: {
    ...
    getYears () {
      ...
      this.$store
        ...
        .then((res) => {
          if (res.code == 200) {
            this.yearsData = res.data ? res.data : []
          }
        })
        .catch((error) => {})
    },
    getSeason () {
      ...
      this.$store
        ...
        .then((res) => {
          if (res.code == 200) {
            this.seasonData = res.data ? res.data : []
          }
        })
        .catch((error) => {})
    },
    ...
    addTypeDiscounts () {
      ...
      if (type) {
        ...
        if (this.years) {
          newlayout.ppd_years_id = this.years.id
          newlayout.ppd_years_name = this.years.cp_name
          this.years = ''
        }
        if (this.season) {
          newlayout.ppd_season_id = this.season.id
          newlayout.ppd_season_name = this.season.cp_name
          this.season = ''
        }
      ...
      if (data && data.length > 0) {
        ...
        for (let i = 0; i < data.length; i++) {
          if (list.indexOf(parseInt(data[i].id)) == -1) {
            ...
            person.ppd_goods_name = data[i].ca_name
            person.ppd_code = data[i].ca_article_code
            person.ppd_price = data[i].ca_price
            specNewsDataBak.push(person)
          } else {
            this.$q.notify({
              color: 'red',
    ...
    getSelectedGoodsData (data, status = false) {
      ...
      if (data && data.length > 0) {
        ...
        for (let i = 0; i < data.length; i++) {
          if (list.indexOf(parseInt(data[i].id)) == -1) {
            const person = {}
            person.ppd_goods_id = data[i].cad_archives_id
            person.ppd_goods_name = data[i].ca_name
            person.ppd_sep_id = data[i].id
            person.ppd_size_name = data[i].cad_size_name
            person.ppd_color_name = data[i].cad_color_name
            person.ppd_code = data[i].cad_skc_code
            person.ppd_price = data[i].cad_price
