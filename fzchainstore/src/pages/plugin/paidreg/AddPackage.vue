  ...
  <q-dialog @hide="hideNowPage" v-model="showDialog" persistent>
    ...
    >
      <q-card-section class="row items-center q-pa-none q-mb-lg">
        <div class="text-h6">{{ packageData.id > 0 ? '修改' : '新增' }}开卡套餐</div>
        <q-space />
      ...
      <q-form ref="packageDataRef">
        <div class="q-pr-sm">
          <q-banner rounded class="text-white bg-red" dense>
            注意：赠送卡券、次卡、储值、积分时，不填不选则不赠送! 开启会员权益会直接赠送会员级别相关权益！
          </q-banner>
        </div>
        ...
        <div class="q-mt-xs">
          <q-chip outline square color="red" text-color="white">
            赠送储值 {{ packageData.pp_give_balance }} 元，赠送 {{ packageData.pp_give_integral }} 积分
          </q-chip>
        </div>
