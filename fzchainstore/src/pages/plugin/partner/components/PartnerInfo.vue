          ...
          <q-card  flat bordered>
            ...
            <q-card-actions vertical class="text-h6 text-center">
              ...
              <div class="row ">
                ...
                <div class="col-6 ">
                  {{ $q.localStorage.getItem('fzchainstore_store_local').storeBaseConfig.consume_base_moneySymbol }}0.00
                </div>
              </div>
              <div class="row ">
                <div class="col-6 ">
                ...
                <div class="col-6 ">{{ $q.localStorage.getItem('fzchainstore_store_local').storeBaseConfig.consume_base_moneySymbol }}{{ partnerTotalData.incomeTotal }}</div>
              </div>
            </q-card-actions>
