...
export default {
  ...
  mounted () {
    ...
    const systemLocal = this.$q.localStorage.getItem('fzchainstore_system_local')
    if (systemLocal && accountInfo) {
      this.noticeUrl = systemLocal.systemInfo.site_url + '/m/' + accountInfo.apply_id + '/plugins/zzpay/paypage?id=' + accountInfo.lib_id
    }
  },
  computed: {},
  methods: {
