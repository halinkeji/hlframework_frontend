        ...
        },
        {
          ...
          valueGetter: (p) => {
            if (p.data.cou_dateType == 1) {
              return this.$q_date.formatDate(p.data.cou_startTime * 1000, 'YYYY-MM-DD') + ' 至 ' + this.$q_date.formatDate(p.data.cou_endTime * 1000, 'YYYY-MM-DD') + ' 有效'
            } else if (p.data.cou_dateType == 2) {
              if (p.data.cou_startDay == 0) {
                return '领取后当天生效,有效期' + p.data.cou_endDay + '天'
              } else {
                return '领取' + (p.data.cou_startDay == 0 ? '后当天生效' : p.data.cou_startDay + '天后生效') + ',有效期' + p.data.cou_endDay + '天'
              }
            } else {
              return ''
            }
