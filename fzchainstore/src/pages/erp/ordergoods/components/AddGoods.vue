      ...
      <div class="col-shrink bg-white q-px-xs q-pb-md q-gutter-x-xs ">
        <q-form ref="erpInRef">
          <div class="row q-gutter-sm items-start">
            ...
            <div class="col-12 col-md-2" v-if="authorityMeta('code') && orderGoodsData.cep_status == 1 && !patchOrderData.cep_contract_number">
            ...
            <q-btn
              ...
              unelevated
              label="添加商品"
              v-if="authorityMeta('code') && orderGoodsData.cep_status == 1  && !patchOrderData.cep_contract_number"
              :disable="searchValue == '' ? true : false"
              @keyup.enter="addItemData(searchValue)"
              @click="addItemData(searchValue)"
            />

            <q-btn color="primary" @click="selectBut" v-if="authorityMeta('selectGoods') && orderGoodsData.cep_status == 1 && !patchOrderData.cep_contract_number" unelevated label="选择商品" />
            ...
            <q-btn
              ...
              unelevated
              v-if="orderGoodsData.cep_status < 2 && !patchOrderData.cep_contract_number"
              label="清空订货列表"
