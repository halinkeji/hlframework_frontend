    ...
    <div class="fit column no-wrap justify-between items-stretch content-stretch no-scroll">
      <div class="col-shrink bg-white q-px-xs q-pb-md">
        <div class="q-gutter-xs row">
          ...
          <q-btn color="primary" unelevated label="创建直采单" v-if="authorityMeta('detailAdd')" @click="clickCreateOrder" />
...
export default {
  ...
  methods: {
    ...
    getList () {
      ...
      this.$store
        .dispatch('erpDirect/getData', obj)
        .then((res) => {
          if (res.code == 200) {
    ...
    countExport () {
      ...
      this.$store
        .dispatch('exports/getDirectExport', obj)
        .then((res) => {
          if (res.code == 200) {
    ...
    showLogData (val) {
      ...
      this.$nextTick(() => {
        this.$refs.showDataRef.init(val, 14)
      })
    },
    authorityMeta (key) {
      if (this.$route.meta) {
