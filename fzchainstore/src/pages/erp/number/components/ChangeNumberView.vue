<template>
  <div class="fit column no-wrap justify-between items-stretch content-stretch no-scroll">
    <div class="col-shrink bg-white q-px-xs q-pb-md row q-gutter-sm">
      ...
      <div class="col-2">
        <q-input outlined @clear="getConsumData" clearable v-model="orderNumber" label="单据号" dense />
      </div>
...
export default {
  ...
  methods: {
    ...
    getConsumData () {
      ...
      this.$store.dispatch('erpNumber/getChangeData', obj).then((res) => {
        if (res.code == 200) {
