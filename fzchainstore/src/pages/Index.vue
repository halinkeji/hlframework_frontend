        ...
        <div class="row q-px-sm">
          ...
          <div class="row col-md-2 col-12">
            <q-card flat bordered class="full-height full-width">
              ...
              <div class="q-px-md">
                <q-scroll-area style="height: 850px; max-width: 300px">
...
export default {
  ...
  mounted () {
    ...
    // const serviceMenu = LocalStorage.getItem('fzchainstore_left_menu_navigate_local')
  ...
  methods: {
    isEndTime () {
      const storeLocal = this.$q.localStorage.getItem('fzchainstore_store_local')
