        ...
        <div class="q-ml-lg">
          ...
          <div class="row q-my-sm">
            <div class="col-8 col-md-6 q-ml-md">
              <q-input outlined dense label="员工名称" :rules="[(val) => !!val || '必填项']" v-model="dataForm.pru_name" placeholder="请输入员工">
                <template v-slot:hint> 填写员工名称 </template></q-input
              >
            </div>
            <div class="col-8 col-md-5 q-ml-md">
              <q-input
                ...
                placeholder="请输入员工电话"
              >
                <template v-slot:hint> 填写员工电话 </template></q-input
              >
            </div>
          </div>
          ...
          <div class="row q-my-sm">
            ...
            <div class="col-8 col-md-5 q-ml-md">
              <q-select
                outlined
                v-model="dataForm.pru_performance_id"
...
export default {
  ...
  methods: {
    ...
    getPerformance() {
      this.$store
        .dispatch('rewardPerformance/getDataLists')
        .then((res) => {
          if (res.code == 200) {
            if (res.data) {
    ...
    getPosition() {
      this.$store
        .dispatch('rewardPosition/getDataLists')
        .then((res) => {
          if (res.code == 200) {
            if (res.data) {
