...
export default {
  ...
  data() {
    return {
      ...
      columnDefs: [
      {
        ...
        {
          headerName: '店铺名称',
          field: 'rir_srore_name',

          width: this.nowpx(0.1) + 'px',
        },
        {
          headerName: '修改前指标',
          field: 'rir_old_target_amount',
          width: this.nowpx(0.1) + 'px',
        },

        {
          headerName: '修改后指标',
          field: 'rir_new_target_amount',
        ...
        },
        {
          ...
          valueGetter: (p) => {
            return this.$q_date.formatDate(p.data.rir_start_time * 1000, 'YYYY-MM');
          },
  ...
  methods: {
    ...
    getList() {
      ...
      this.$store
        .dispatch('rewardIndicators/getRecordList', obj)
        .then((res) => {
          if (res.code == 200) {
