    ...
    <div class="fit column no-wrap justify-between items-stretch content-stretch no-scroll">
      <div class="col-shrink bg-white q-px-xs q-pb-lg">
        ...
        >
         ...
         <q-tab name="jfmall" label="积分商城" v-if="openPlugins && openPlugins.indexOf('Jfmall') > -1" />
         </q-tabs>
      </div>
      ...
      <div class="col-shrink bg-white  full-height q-mt-xs" v-if="activeTab == 'track'">
        <track-record-list :currentMemberId="memberId" ref="documentManagementRef"></track-record-list>
      </div>
            <div class="col-shrink bg-white  full-height q-mt-xs" v-if="activeTab == 'jfmall'">
        <jfmall-order-record :currentMemberId="memberId" ref="documentManagementRef"></jfmall-order-record>
      </div>
...
import TrackRecordList from 'pages/plugin/track/RecordList.vue'
...
export default {
  ...
  mounted () {},
  created () {
    if (LocalStorage.getItem('fzchainstore_plugins_local').openPlugins) {
