<template>
  ...
  >
    <q-card
      :style="{
        width: this.$q.screen.width * 1 + 'px',
        'min-width': this.$q.screen.width * 1 + 'px',
      }"
      class="fit"
    >
      <div
      ...
      >
        ...
        <div class=" col-shrink bg-white q-pb-md row q-gutter-md items-center  q-px-md ">
          <q-btn class="q-px-xl" unelevated color="primary" @click="getSelectedTabel(true)" size="md" label="选中" />
          <q-btn class="q-px-xl" unelevated color="green" @click="getSelectedTabel(false)" size="md" label="选中并关闭" />
          <q-btn class="q-px-xl" unelevated color="grey" size="md" @click="closeDialog" label="取消" />
