    ...
    <div class="fit column no-wrap justify-between items-stretch content-stretch no-scroll">
      <div class="col-shrink bg-white q-pb-lg">
        <div class="row q-px-sm q-gutter-x-sm items-center">
          ...
          <q-btn @click="selectInvoice()" color="primary" unelevated label="选择" />
          <q-btn @click="clearButton()" color="grey" unelevated label="重置" />
        </div>
      </div>
          ...
          <q-card flat bordered class="q-my-xs">
            ...
            <q-card-section flat>
              <div class="row q-gutter-sm">
                ...
                <q-input clearable outlined v-model="searchFrom.searchNumber" label="商品名称/条码" dense v-if="invoiceType != 'ConsumeRecord'" />
                </div>
                ...
                <div class="col-12 col-md-2" v-if="invoiceType == 'StoreProfits' || invoiceType == 'ConsumeRecord' || invoiceType == 'ConsumeRecords'">
                  <q-select
                    outlined
                    option-value="value"
                    option-label="label"
...
export default {
  ...
  methods: {
    ...
    getGoodsType () {
      ...
      this.$store
        .dispatch('clothingType/getTreeList', obj)
        .then((res) => {
          if (res.code == 200) {
            if (res.data) {
