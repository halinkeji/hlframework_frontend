<template>
  <div class="fit column no-wrap  justify-between items-stretch content-stretch no-scroll">
            ...
            <div class="col-md-10 col-12">
              ...
              <div class="row">
                ...
                <div class="col-md-6 col-12 q-pl-sm">
                  ...
                  <q-input outlined bottom-slots v-model="dataFrom.contact_moblie" dense lazy-rules :rules="[(val) => !!val || '请填写手机号']">
                  </q-input>
    ...
    <div class="col-shrink bg-white q-py-sm text-center q-mt-xs q-gutter-sm">
      ...
      <q-btn class="q-px-xl" unelevated color="grey" label="返回" :to="{ name: 'merchantManage' }" />
    </div>
...
export default {
  ...
  created () {
    this.nowStoreId = parseInt(this.$route.query.sId)
    if (this.nowStoreId > 0) {
      this.getItemData()
    }
  },
  methods: {
