<template>
  <div class="fit column no-wrap justify-between items-stretch content-stretch no-scroll">
    <div class="col-shrink bg-white q-px-xs q-pb-md">
      <q-card flat class="q-mb-md">
        <div class="row q-gutter-sm">
          ...
          <div class="col-12 col-md-1" v-if="!memberId">
          ...
          <q-btn @click="consumeExport()" v-if="searchFrom.member_id == 0" color="red" unelevated label="导出" />
          <q-btn @click="consumeDetailExport()" v-if="searchFrom.member_id == 0" color="positive" unelevated label="导出详情" />
        </div>
        <div class="row q-gutter-sm">
    ...
    <return-all-goods ref="returnAllGoods" v-if="returnAllGoodsStatus"></return-all-goods>
...
export default {
  ...
  methods: {
    ...
    exchangeBut (id) {
      ...
      this.$nextTick(() => {
        setTimeout(() => {
          this.$refs.exchangeGoods.getViewData(id)
        }, 200)
      })
    },
    revokeOrderBut (data) {
