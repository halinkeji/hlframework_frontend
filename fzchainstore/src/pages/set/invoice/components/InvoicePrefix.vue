      ...
      <div class="col-shrink bg-white q-pa-sm full-height bg-grey-2">
        <q-form ref="invoiceDataRef" class="q-gutter-md">
          <div class="row">
            ...
            <q-input outlined dense class=" col-12 col-md-4 q-mt-lg q-px-sm" v-model="merchantFrom.prefix_invoice_addDuration" label="增加计时单据前缀" />
            <q-input outlined dense class=" col-12 col-md-4 q-mt-lg q-px-sm" v-model="merchantFrom.prefix_invoice_addGroupDuration" label="套餐充时单据前缀" />
            <q-input outlined dense class=" col-12 col-md-4 q-mt-lg q-px-sm" v-model="merchantFrom.prefix_invoice_deductDuration" label="计时消费单据前缀" />
            ...
            <q-input outlined dense class=" col-12 col-md-4 q-mt-lg q-px-sm" v-model="merchantFrom.prefix_invoice_erpTransfer" label="ERP调拨单据前缀" />
          </div>
        </q-form>
      </div>
