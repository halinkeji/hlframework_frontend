            ...
            <q-list separator bordered padding>
              ...
              <q-item>
                <q-item-section>
                  ...
                  <q-item-label caption>默认消费：1 {{ $q.localStorage.getItem('fzchainstore_store_local').storeBaseConfig.consume_base_moneyUnit }} = 1 成长值。（示例：输入 3 ，则 1 {{ $q.localStorage.getItem('fzchainstore_store_local').storeBaseConfig.consume_base_moneyUnit }} = 3 成长值） </q-item-label>
                </q-item-section>
                <q-item-section side>
                  <q-input
                    outlined
