      ...
      <div class="col-shrink bg-white q-px-xs q-pb-md">
        <q-card flat class="q-pa-sm">
          <div class="row  q-gutter-x-sm">
            <q-input clearable class="col-12 col-md-2 " label="请输入公告标题" outlined v-model="searchQuery" dense />

            <q-btn @click="getList(1)" color="primary" class="col-12 col-md-1" unelevated v-if="authorityMeta('search')" label="搜索" />
            <q-btn @click="clearnBut()" color="warning" class=" col-12 col-md-1" unelevated v-if="authorityMeta('reset')" label="重置" />
            <q-btn @click="addNewData(0)" color="primary" class=" col-12 col-md-1" unelevated v-if="authorityMeta('add')" label="新增" />
            <q-btn
