    ...
    >
      <div class="fit column no-wrap justify-between items-stretch content-stretch no-scroll">
        ...
        <div class="col-shrink bg-white q-pb-md row q-gutter-md items-center  q-px-md">
          <q-btn class="q-px-xl" unelevated color="primary" @click="getSelectedTabel(true)" label="选中"  size="lg" />
          <q-btn class="q-px-xl" unelevated color="green" @click="getSelectedTabel(false)" size="lg" label="选中并关闭" />
          <q-btn class="q-px-xl" unelevated color="grey" size="lg" @click="closeDialog" label="取消" />
            <q-space />
          <hl-pagination
