<template>
  <q-card flat>
    <q-input outlined :bottom-slots="parseInt(bottomSlots) == 1 ? false : true" dense readonly v-model="inputData" :placeholder="textName">
      <q-menu>
...
export default {
  props: ['dataList', 'list_width', 'textName', 'inputLabel', 'inputValue', 'showValue', 'bottomSlots'],
  components: {
    itemMenu
  },
  data () {
