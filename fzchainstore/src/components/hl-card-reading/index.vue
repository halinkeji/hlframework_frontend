          ...
          <div class="row q-pa-xs q-mt-sm">
            ...
            <div class="col-6 col-md-3">
              <q-chip square color="blue-1" text-color="blue-8">
                级别：{{ userData.memberLevel ? userData.memberLevel.mcl_level_name : '无等级' }}
              </q-chip>
            </div>
            <div class="col-6 col-md-3">
              <q-chip square color="blue-1" text-color="blue-8">
            ...
            <div class="col-6 col-md-3">
              <q-chip square color="blue-1" text-color="blue-8">
                总{{ $q.localStorage.getItem('fzchainstore_store_local').storeBaseConfig.consume_base_integralUnit }}：{{
                  userData.mem_memberPointsCount > 0 ? userData.mem_memberPointsCount : '0'
                }}
              </q-chip>
            </div>
            <div class="col-6 col-md-3">
              <q-chip square color="blue-1" text-color="blue-8">
                总{{ $q.localStorage.getItem('fzchainstore_store_local').storeBaseConfig.consume_base_balanceUnit }}：{{
                  userData.mem_memberMoneyCount > 0 ? userData.mem_memberMoneyCount : '0'
                }}
              </q-chip>
            </div>
            <div class="col-6 col-md-3">
              <q-chip square color="blue-1" text-color="blue-8">
                总次数：{{ userData.mem_memberNumberCount > 0 ? userData.mem_memberNumberCount : '0' }}
              </q-chip>
            </div>
          </div>
        </div>
          ...
          <q-item>
            <q-item-section avatar>
              <q-avatar v-if="userData.coverImage && userData.coverImage.id" text-color="white">
                <img :src="$q.localStorage.getItem('fzchainstore_store_local').attach_url + userData.coverImage.path" />
              </q-avatar>
...
export default {
  ...
  mounted () {
    this.focusInput()
    this.openPlugins = this.$q.localStorage.getItem('fzchainstore_store_local').openPlugins
