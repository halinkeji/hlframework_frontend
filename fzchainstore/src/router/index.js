...
const currentRouterData = LocalStorage.getItem('fzchainstore_router_local')
  ...
  store()
    ...
    .then((res) => {
      if (res.data) {
        ...
        // 写入左侧菜单
        LocalStorage.set('fzchainstore_left_menu_navigate_local', menu)
        store().commit('settings/SET_MENUData', menu)

        // 写入业务菜单
        LocalStorage.set('fzchainstore_business_menu_navigate_local', businessMenu)
