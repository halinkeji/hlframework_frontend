      ...
      <q-form ref="specFormRef">
        <q-card-section horizontal>
          <q-card-section class="q-pa-sm">
            <div v-if="dishesData.goo_cover_image">
              <q-img :src="dishesData.goo_cover_image" :ratio="16 / 10" />
            </div>
            <div v-else-if="!dishesData.goo_cover_image">
              <q-img :ratio="16 / 10">
                ...
                <q-card bordered flat>
                  <q-card-section class="q-pa-xs">
                    <div class="text-subtitle2 text-center">
                      {{ item.fsm_name }} <q-badge rounded v-if="parseInt(item.fsm_required) == 1" color="positive"> 必选 </q-badge> <q-badge rounded v-if="parseInt(item.fsm_multiple) == 1" color="positive"> 可多选 </q-badge>
                    </div>
                  </q-card-section>
                  <q-separator />
                  <q-card-section class="q-pa-sm">
                    <div v-if="item.sonItem && parseInt(item.fsm_multiple) == 1" class="row">
