        ...
        <q-scroll-area class="fit full-height">
          <div class="row">
            <div class="col-8 q-pa-sm">
                <q-form ref="memberDataRef" class="row q-col-gutter-sm">
...
export default {
  ...
  created () {
    ...
    if (LocalStorage.getItem('cyonestore_store_local').storeMemberConfig) {
      this.storeMemberConfig = LocalStorage.getItem('cyonestore_store_local').storeMemberConfig
    }
  },
  methods: {
    changeMemberMobile () {
