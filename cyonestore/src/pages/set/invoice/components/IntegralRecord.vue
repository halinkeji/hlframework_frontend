    ...
    <div class="col-shrink bg-white q-px-xs q-pb-xs">
      <q-card flat class=" q-mb-md">
        <div class="row">
          ...
          <q-input class="col-12 col-md-2 q-mt-sm q-mr-sm" clearable v-if="!memberId" label="请输入会员卡号|电话号|姓名" outlined v-model="searchFrom.memberText" dense />
...
export default {
  ...
  data () {
    return {
      ...
      columnDefs: [
        ...
        {
          headerName: '变更' + this.$q.localStorage.getItem('cyonestore_store_local').storeBaseConfig.consume_base_integralUnit,
        ...
        {
          headerName: this.$q.localStorage.getItem('cyonestore_store_local').storeBaseConfig.consume_base_integralUnit + '来源',
        ...
        {
          headerName: this.$q.localStorage.getItem('cyonestore_store_local').storeBaseConfig.consume_base_integralUnit + '状态',
  ...
  methods: {
    ...
    exportBut () {
      ...
      this.gridOptions.api.exportDataAsCsv({ fileName: date + '-' + this.$q.localStorage.getItem('cyonestore_store_local').storeBaseConfig.consume_base_integralUnit + '记录' })
    }
  }
}
</script>
