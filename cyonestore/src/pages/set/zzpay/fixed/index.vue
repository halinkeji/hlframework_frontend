<template>
    <div class="fit column no-wrap justify-between items-stretch content-stretch no-scroll">
      <div class="col-shrink bg-white q-px-xs q-py-sm row q-gutter-xs">
        ...
        <q-btn @click="showPopup()" color="primary"  unelevated  label="新增" />
        <q-btn @click="deleteAll()" :disable="dataListSelections.length > 0 ? false : true" color="red"  unelevated label="批量删除" />
      </div>
