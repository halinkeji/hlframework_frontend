<template>
  <q-page class="fit">
    ...
    >
      <div
        class="col-shrink bg-white "
        :class="{ 'q-pb-lg': parseInt(activeName) == 0 ? true : false }"
      >
        <q-tabs
          v-model="activeName"
          class="bg-white"
      ...
      <div
        class="col-shrink bg-white q-px-xs full-height bg-grey-2"
      ...
      <div
        class="col-shrink bg-white full-height bg-grey-2"
        v-if="parseInt(activeName) == 1"
      >
    ...
    return {
      ...
      columnDefs: [
        ...
        },
        {
          headerName:
            '赠送' +
            this.$q.localStorage.getItem('cyonestore_store_local').storeBaseConfig.consume_base_balanceUnit,
          field: 'rp_give_money',
          width: this.nowpx(0.1) + 'px'
        },
        {
          headerName:
            '赠送' +
            this.$q.localStorage.getItem('cyonestore_store_local')
