        ...
        <div class="row">
         ...
         <q-input
          ...
          <q-input
            ...
            :label="`${$q.localStorage.getItem('cyonestore_store_local').storeBaseConfig.consume_base_balanceUnit}扣费单据前缀`"
          />
          <q-input
            outlined
            dense
            ...
            :label="`增加${$q.localStorage.getItem('cyonestore_store_local').storeBaseConfig.consume_base_integralUnit}单据前缀`"
          />
          <q-input
            outlined
            dense
            ...
            :label="`${$q.localStorage.getItem('cyonestore_store_local').storeBaseConfig.consume_base_integralUnit}扣除单据前缀`"
          />
