            ...
            <q-item>
              ...
              <q-item-section side>
                <span class="text-h6 text-deep-orange" v-if="parseInt(item.pp_type) == 2"
                  >{{ $q.localStorage.getItem('cyonestore_store_local').storeBaseConfig.consume_base_moneySymbol }} {{ item.pp_selling_price }}</span
                >
                <span v-else> 免费 </span>
              </q-item-section>
...
export default {
  ...
  created () {
    this.openPlugins = LocalStorage.getItem('cyonestore_plugins_local').openPlugins
