                ...
                <div class="col-6 q-pr-sm">
                  <q-input outlined dense v-model="packageData.pmp_market_amount" label="佣金" hint="下级会员消费时，他的上级可获得的固定佣金" :rules="[(val) => /^(\d+|\d+\.\d{1,2})$/.test(val) || '请输入正确的佣金']">
                    <template v-slot:append>
                      ...
                      <span class="text-subtitle2 ">{{ $q.localStorage.getItem('cyonestore_store_local').storeBaseConfig.consume_base_moneySymbol }}</span>
                    </template>
                  </q-input>
                </div>
                <div class="col-6 q-pl-sm">
              ...
              <div class="row q-mt-xs">
                <div class="col-6 q-pr-sm">
                  <q-input
                    ...
                    :rules="[(val) => /^(\d+|\d+\.\d{1,2})$/.test(val) || '请输入正确的赠送' + $q.localStorage.getItem('cyonestore_store_local').storeBaseConfig.consume_base_balanceUnit]"
                  />
                </div>
                <div class="col-6 q-pl-sm">
                  <q-input
                    ...
                    :rules="[(val) => /^(\d+|\d+\.\d{1,2})$/.test(val) || '请输入正确的赠送' + `${$q.localStorage.getItem('cyonestore_store_local').storeBaseConfig.consume_base_integralUnit}`]"
                  />
                </div>
              </div>
