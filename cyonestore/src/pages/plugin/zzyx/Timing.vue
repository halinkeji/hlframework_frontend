...
<script>
import TimingAgOperate from './components/TimingAgOperate'
export default {
  name: 'zzyxTiming',
  components: {
    TimingAgOperate
    ...
    return {
      ...
      columnDefs: [
        ...
        },
        {
          ...
          cellRendererFramework: 'TimingAgOperate'
        }
      ],
      page: {
        pageIndex: 1,
  ...
  methods: {
    getList () {
      ...
      this.$store
        .dispatch('zzyx/getTimingListData', obj)
        .then((res) => {
          this.timingData = res.data ? res.data.list : []
