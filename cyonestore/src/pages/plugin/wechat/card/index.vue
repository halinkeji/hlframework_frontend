                  ...
                  :style="{
                    backgroundImage:
                      parseInt(cardFormInfo.mc_bg_type) == 1
                        ? `url('${$q.localStorage.getItem('cyonestore_system_local').systemInfo.site_url}/attachment/${cardFormInfo.mc_bg_img_local}')`
                        : '',
                  ...
                  <q-item>
                    <q-item-section avatar>
                      <q-avatar class="bg-grey">
                        <q-img :src="`${$q.localStorage.getItem('cyonestore_system_local').attach_url}` + cardFormInfo.mc_logo_url">
                ...
                <q-card flat bordered class="bg-white q-px-md q-pb-md">
                  ...
                  <div class="row q-mt-lg text-subtitle1 q-pl-md items-center">
                    ...
                    <div class="col-12 col-md-6">
                      <div>
                        <q-img
                          :src="`${$q.localStorage.getItem('cyonestore_system_local').attach_url}` + cardFormInfo.mc_logo_url"
                    ...
                    <div class="col-12 col-md-6">
                      ...
                      <div v-if="parseInt(cardFormInfo.mc_bg_type) == 1">
                        <div>
                          <q-img
                            :src="
                              `${$q.localStorage.getItem('cyonestore_system_local').systemInfo.site_url}` +
                              '/attachment/' +
                  ...
                  <q-item>
                    <q-item-section>
                      <q-item-label
                        >是否开启{{ $q.localStorage.getItem('cyonestore_store_local').storeBaseConfig.consume_base_integralUnit
                        }}<span class="text-red">(不可修改)</span></q-item-label
                      >
                      <q-item-label caption>
                        微信卡包内微信会员卡{{ $q.localStorage.getItem('cyonestore_store_local').storeBaseConfig.consume_base_integralUnit }}与系统{{
                          $q.localStorage.getItem('cyonestore_store_local').storeBaseConfig.consume_base_integralUnit
                        }}同步，开启跳转链接
                      </q-item-label>
                    </q-item-section>
                  ...
                  <q-item>
                    <q-item-section>
                      <q-item-label
                        >是否开启{{ $q.localStorage.getItem('cyonestore_store_local').storeBaseConfig.consume_base_balanceUnit }}
                        <span class="text-red">(不可修改)</span>
                      </q-item-label>
                      <q-item-label caption>
                        微信卡包内微信会员卡{{ $q.localStorage.getItem('cyonestore_store_local').storeBaseConfig.consume_base_balanceUnit }}与系统{{
...
export default {
  ...
  created () {
    ...
    const lib_id = LocalStorage.getItem('cyonestore_account_info').lib_id
    ...
    if (account_info && system_local) {
      this.mc_member_link = system_local.systemInfo.site_url + '/m/cyonestore?id=' + lib_id
      this.cardFormInfo.mc_center_data.url = this.mc_member_link
      this.cardFormInfo.mc_level_link = system_local.systemInfo.site_url + '/m/cyonestore/level?id=' + lib_id
      this.cardFormInfo.mc_coupon_link = system_local.systemInfo.site_url + '/m/cyonestore/hlcoupon?id=' + lib_id
    }
  },
  computed: {},
  methods: {
