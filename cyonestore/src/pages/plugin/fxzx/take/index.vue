...
export default {
  ...
  data () {
    return {
      ...
      fxzxLevelList: [],
      takeModeOptions: [
        { value: 'balance', label: this.$q.localStorage.getItem('cyonestore_store_local').storeBaseConfig.consume_base_balanceUnit },
        ...
        },
        {
          ...
          valueGetter: (p) => {
            if (p.data.ftr_take_mode == 'balance') {
              return this.$q.localStorage.getItem('cyonestore_store_local').storeBaseConfig.consume_base_balanceUnit
