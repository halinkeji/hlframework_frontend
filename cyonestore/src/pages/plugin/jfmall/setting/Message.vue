            ...
            <div class="col-7">
              ...
              <div class="row">
                <q-item class="full-width">
                  <q-item-section>
                    <q-input outlined v-model="settingForm.js_comment_item.one" dense label="评分项一" />
                  </q-item-section>
                </q-item>

                <q-item class="full-width">
                  <q-item-section>
                    <q-input outlined v-model="settingForm.js_comment_item.two" dense label="评分项二" />
                  </q-item-section>
                </q-item>

                <q-item class="full-width">
                  <q-item-section>
                    <q-input outlined v-model="settingForm.js_comment_item.three" dense label="评分项三" />
                  </q-item-section>
                </q-item>
              </div>
            </div>
...
export default {
  ...
  methods: {
    ...
    getItem () {
      this.$store.dispatch('jfSetting/getItem', null).then((res) => {
        if (parseInt(res.code) == 200) {
          ...
          this.$nextTick(() => {
            this.setCommentItem(res.data.js_comment_item || {})
          })
        }
      })
    },
    setCommentItem (commentItem) {
      ...
      this.settingForm.js_comment_item = currentCommentItem
    },
