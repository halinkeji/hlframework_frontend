      ...
      <div style="overflow-y: scroll" class="fit full-height">
        <q-card flat class="q-pa-sm">
          <q-form ref="dataFrom" class="row q-gutter-sm">
            ...
            <div class="col-12" v-if="!(companyForm && companyForm.id)">
              <q-banner inline-actions rounded class="text-white bg-positive">
                ...
                <template v-slot:action>
                  <q-btn @click="openDialog" unelevated color="orange" label="认证" />
                </template>
              </q-banner>
            </div>
...
export default {
  ...
  methods: {
    ...
    createKeyString () {
      this.dataFrom.pwa_encoding_aes_key = this.randomString(32)
    },
