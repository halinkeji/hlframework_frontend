            ...
            <q-item class="q-mt-sm">
              ...
              <q-item-section side class="q-mb-md">
                <q-btn
                  ...
                  color="red"
                  dense
                  @click="deleteSpecification(item, key)"
        ...
        <q-item>
          ...
          <q-item-section side>
            <q-checkbox
              true-value="1"
              false-value="0"
              v-model="dishesData.fl_is_limit_time"
            />
          </q-item-section>
        </q-item>
      </q-list>
      ...
      <q-card-section>
        <q-item   v-for="(item, key) in limitTimeDiscount" :key="key">
          ...
          <q-item-section>
            <q-input
              ...
              :rules="[
                val =>
                  /^(\d+|\d+\.\d{1,2})$/.test(val) || '请输入时间段内限制数量'
              ]"
            >
          ...
          <q-item-section>
            <q-input
              outlined
              dense
              v-model="item.tld_discount_price"
              :rules="[
                val => /^(\d+|\d+\.\d{1,2})$/.test(val) || '请输入时间段内价格'
              ]"
            >
              <template v-slot:prepend>
        ...
        <div class="q-mt-sm">
          <q-btn
            ...
            @click="addRule"
            label="新增规则"
            :disable="dishesData.fl_is_limit_time == 1 ? false : true"
          />
        </div>
      </q-card-section>
    </q-card>
