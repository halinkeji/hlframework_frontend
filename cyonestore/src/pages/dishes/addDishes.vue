          ...
          <q-form ref="dishesRef">
            <div v-show="tab == '1'" class="fit">
              <div class="row q-mb-xs q-col-gutter-sm">
                ...
                <div class="col-12 col-md-6 ">
                  <q-input outlined dense v-model="dishesData.goo_code"  label="编码" lazy-rules :rules="[(val) => !!val || '请输入编码']">
                    <template v-slot:after>
                ...
                <div class="col-12 col-md-6 ">
                  <q-input outlined dense v-model="dishesData.goo_nick"  label="简称" />
                </div>

                <div class="col-12 col-md-6 ">
                  <q-input outlined dense v-model="dishesData.goo_pinYin"  label="助记码" lazy-rules :rules="[(val) => !!val || '请输入助记码']" />
                </div>
                ...
                <div class="col-12 col-md-3 ">
                  <q-select outlined dense v-model="dishesData.goo_status" :options="statusOptions" label="状态" emit-value map-options />
                </div>
