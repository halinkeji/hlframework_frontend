<template>
  <div class="row q-gutter-sm">
    <q-btn unelevated round color="primary" icon="las la-edit" @click="showPopup">
      <q-tooltip>
        修改
      </q-tooltip>
    </q-btn>

    <q-btn unelevated round color="red" icon="las la-trash-alt" @click="delDesk">
      <q-tooltip>
        删除
      </q-tooltip>
    </q-btn>

    <q-btn unelevated round color="orange" icon="las la-link" @click="copyXcxUrl">
      <q-tooltip>
        小程序入口链接
      </q-tooltip>
    </q-btn>

    <q-btn unelevated round color="positive" icon="las la-qrcode" @click="clickWxappQrcode">
      <q-tooltip>
        下载小程序桌号码
      </q-tooltip>
    </q-btn>
    ...
    <q-dialog v-model="qrcodeDialog" persistent>
      <q-card>
        <q-card-section>
          <div class="text-h6">{{ params.data.dp_name }}</div>
        </q-card-section>
...
export default {
  ...
  methods: {
    ...
    downloadQrcode () {
      ...
      const filename = this.params.data.dp_name
