...
export function getDeskLinkData ({ commit }, params) {
  return new Promise((resolve, reject) => {
    api
      .get('v3/fast-food/get-desk-link-data', { params })
      .then(response => {
        resolve(response)
      })
      .catch(error => {
...
export function setDeskCarMember ({ commit }, item) {
  return new Promise((resolve, reject) => {
    api
      .post('v3/fast-food/update-car', item)
      .then(response => {
        resolve(response)
      })
      .catch(error => {
...
export function placeAnOrder ({ commit }, item) {
  return new Promise((resolve, reject) => {
    api
      .post('v3/fast-food/place-an-order', item)
      .then(response => {
        resolve(response)
      })
      .catch(error => {
...
export function delAllDeskCar ({ commit }, item) {
  return new Promise((resolve, reject) => {
    const apiUrl = 'v3/fast-food/alldel'
    api
      .post(apiUrl, item)
      .then(response => {
        resolve(response)
...
export function getDeskCarList ({ commit }, item) {
  return new Promise((resolve, reject) => {
    api.post('v3/fast-food/lists', item)
      .then(response => {
        resolve(response)
      })
      .catch(error => {
...
export function getUserList ({ commit }, item) {
  return new Promise((resolve, reject) => {
    api.post('v3/fast-food/user-lists', item)
      .then(response => {
        resolve(response)
      })
      .catch(error => {
...
export function setPrinterCheck ({ commit }, item) {
  return new Promise((resolve, reject) => {
    api.post('v3/fast-food/printer', item)
      .then(response => {
        resolve(response)
      })
      .catch(error => {
...
export function getCarItem ({ commit }, params) {
  return new Promise((resolve, reject) => {
    api
      .get('v3/fast-food/view-car', { params })
      .then(response => {
        resolve(response)
      })
      .catch(error => {
...
export function clearCart ({ commit }, item) {
  return new Promise((resolve, reject) => {
    api
      .post('v3/fast-food/clear-cart', item)
      .then(response => {
        resolve(response)
      })
      .catch(error => {
...
export function clearDesk ({ commit }, item) {
  return new Promise((resolve, reject) => {
    api
      .post('v3/fast-food/clear-desk', item)
      .then(response => {
        resolve(response)
      })
      .catch(error => {
...
export function getDeskSettleDetail ({ commit }, params) {
  return new Promise((resolve, reject) => {
    api
      .post('v3/fast-food/get-desk-settle-detail', params)
      .then(response => {
        resolve(response)
      })
      .catch(error => {
