...
let siteUrl = ''
if (LocalStorage.getItem('cyonestore_system_local')) {
  const systemInfo = LocalStorage.getItem('cyonestore_system_local').systemInfo
...
export function addCloudGoosdData ({ commit }, params) {
  return new Promise((resolve, reject) => {
    api
      .post('v3/food-lists/add-cloud-goosd-data', params)
      .then((response) => {
        resolve(response)
      })
      .catch((error) => {
...
export function getListData ({ commit }, params) {
  return new Promise((resolve, reject) => {
    api
      .get('v3/food-lists/component-goods', { params })
      .then((response) => {
        resolve(response)
      })
      .catch((error) => {
