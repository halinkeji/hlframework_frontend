...
module.exports = function (ctx) {
  return {
    ...
    pwa: {
      ...
      manifest: {
        name: 'hlframework frontend web cyonestore',
        short_name: 'hlframework frontend web cyonestore',
        description: 'hlframework frontend web cyonestore',
        display: 'standalone',
    ...
    electron: {
      ...
      builder: {
        ...
        appId: 'hlframework_frontend_web_cyonestore'
