  ...
  <q-dialog v-model="activePrompt" full-height full-width>
    ...
    >
      <div class="fit column no-wrap justify-between items-stretch content-stretch no-scroll">
            ...
            <q-card flat bordered class="my-card">
              ...
              <q-card-section class="q-pt-none">
                <div class="row">
                  ...
                  <div class="col-4" v-if="orderType == 'check'">
                    ...
                    <br />
                    盘点类型： <span v-if="infoData.cec_check_type == 1">全盘</span>
                    <span v-if="infoData.cec_check_type == 2">抽盘</span>
                    <span v-if="infoData.cec_check_type == 2">分类盘点</span>
                  </div>

                  <div class="col-5 text-center">
                    单据号：
                    <span v-if="orderType == 'order'">
                      {{ infoData.ceo_order_number }}
                    </span>
                    <span v-if="orderType == 'transfer' || orderType == 'transferOut' || orderType == 'transferIn'">
                      {{ infoData.cet_order_number }}
                    </span>
                    <span v-if="orderType == 'check'">
                      {{ infoData.cec_order_number }}
                    </span>
                    <span v-else>
              ...
              <q-card-section class="q-pt-lg">
                <div class="row" v-if="orderType == 'change'">
                  ...
                  <div class="col-3">
                    店铺信息：{{ $q.localStorage.getItem('lschainstore_store_local').storeInfo.name }}
                    <br />
        ...
        <hl-local-printer ref="localPrinterRef" :margin="'10px 0px 10px 0px '" />
