      ...
      <div class="row items-center " v-if="$q.screen.gt.md">
        ...
        <div class="col-12 col-md-7" v-if="userData.id">
          <div class="row q-pa-xs q-mt-sm">
            ...
            <div class="col-6 col-md-3">
              <q-chip square color="blue-1" text-color="blue-8">
                总{{ $q.localStorage.getItem('lschainstore_store_local').storeBaseConfig.consume_base_integralUnit }}：{{ userData.mem_memberPointsCount > 0 ? userData.mem_memberPointsCount : '0' }}
                </q-chip>
            </div>
            <div class="col-6 col-md-3">
              <q-chip square color="blue-1" text-color="blue-8">
                总{{ $q.localStorage.getItem('lschainstore_store_local').storeBaseConfig.consume_base_balanceUnit }}：{{ userData.mem_memberMoneyCount > 0 ? userData.mem_memberMoneyCount : '0' }}
                </q-chip>
            </div>
            <div class="col-6 col-md-3">
          ...
          <q-item>
            <q-item-section avatar>
              <q-avatar v-if="userData.coverImage && userData.coverImage.id" text-color="white">
                <img :src="$q.localStorage.getItem('lschainstore_system_local').attach_url + userData.coverImage.path" />
              </q-avatar>
...
export default {
  ...
  data () {
    return {
      ...
      rfid2: '1',
      rfid3: '1',
      readJsUrl: 'http://localhost:8008/YOWOCloudRFIDReader.js',
  ...
  mounted () {
    this.focusInput()
    this.openPlugins = this.$q.localStorage.getItem('lschainstore_plugins_local').openPlugins
