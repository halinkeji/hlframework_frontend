...
export function getWarningRules ({ commit }, item) {
  return new Promise((resolve, reject) => {
    api
      .get('v3/erp-number/rules', { params: item })
      .then((response) => {
        resolve(response)
      })
      .catch((error) => {
...
export function getStore ({ commit }, item) {
  return new Promise((resolve, reject) => {
    api
      .get('v3/erp-number/storelist', { params: item })
      .then((response) => {
        resolve(response)
      })
      .catch((error) => {
...
export function getNumberLog ({ commit }, item) {
  return new Promise((resolve, reject) => {
    api
      .get('v3/erp-number/number-log', { params: item })
      .then((response) => {
        resolve(response)
      })
      .catch((error) => {
