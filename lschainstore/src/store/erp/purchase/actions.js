...
export function addGoodsBuf ({ commit }, item) {
  return new Promise((resolve, reject) => {
    api
      .post('v3/erp-purchase/addbuf', item)
      .then((response) => {
        resolve(response)
      })
      .catch((error) => {
...
export function getGoodsBuf ({ commit }, item) {
  return new Promise((resolve, reject) => {
    api
      .get('v3/erp-purchase/buttfer', { params: item })
      .then((response) => {
        resolve(response)
      })
      .catch((error) => {
...
export function editButtfer ({ commit }, item) {
  return new Promise((resolve, reject) => {
    api
      .post('v3/erp-purchase/editbut', item)
      .then((response) => {
        resolve(response)
      })
      .catch((error) => {
