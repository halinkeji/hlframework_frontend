...
export function getCountExport ({ commit }, item) {
  return new Promise((resolve, reject) => {
    api
      .get('v3/file/count-export', { params: item })
      .then((response) => {
        resolve(response)
      })
      .catch((error) => {
...
export function getCountRechargExport ({ commit }, item) {
  return new Promise((resolve, reject) => {
    api
      .get('v3/file/count-recharg-export', { params: item })
      .then((response) => {
        resolve(response)
      })
      .catch((error) => {
...
export function getTimeExport ({ commit }, item) {
  return new Promise((resolve, reject) => {
    api
      .get('v3/file/time-export', { params: item })
      .then((response) => {
        resolve(response)
      })
      .catch((error) => {
