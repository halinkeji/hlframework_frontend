...
export function getData ({ commit }, item) {
  return new Promise((resolve, reject) => {
    api
      .get('v3/reward/position', { params: item })
      .then(response => {
        resolve(response)
      })
      .catch(error => {
...
export function getUser ({ commit }, item) {
  return new Promise((resolve, reject) => {
    api
      .get('v3/reward/reward-user', { params: item })
      .then(response => {
        resolve(response)
      })
      .catch(error => {
...
export function setUserData ({ commit }, item) {
  return new Promise((resolve, reject) => {
    let apiUrl = 'v3/reward/reward-user/'
    apiUrl +=
      parseInt(item.id) > 0 ? 'update?id=' + parseInt(item.id) : 'create'
    const requestType = parseInt(item.id) > 0 ? 'put' : 'post'
    api[requestType](apiUrl, item)
...
export function getUserDataLists ({ commit }, item) {
  return new Promise((resolve, reject) => {
    api
      .get('v3/reward/reward-user/lists', { params: item })
      .then(response => {
        resolve(response)
      })
      .catch(error => {
...
export function getUserLists ({ commit }, item) {
  return new Promise((resolve, reject) => {
    api
      .get('v3/reward/reward-user/list-data', { params: item })
      .then(response => {
        resolve(response)
      })
      .catch(error => {
...
export function addUserData ({ commit }, item) {
  return new Promise((resolve, reject) => {
    api
      .post('v3/reward/reward-user/adduse', item)
      .then(response => {
        resolve(response)
      })
      .catch(error => {
...
export function delUserData ({ commit }, item) {
  return new Promise((resolve, reject) => {
    api
      .post('v3/reward/reward-user/deleteall', item)
      .then(response => {
        resolve(response)
      })
      .catch(error => {
...
export function getUserList ({ commit }, item) {
  return new Promise((resolve, reject) => {
    api
      .post('v3/reward/reward-user/userlist', item)
      .then(response => {
        resolve(response)
      })
      .catch(error => {
...
export function getUserItem ({ commit }, itemId) {
  return new Promise((resolve, reject) => {
    api
      .get('v3/reward/reward-user/view?id=' + itemId)
      .then(response => {
        resolve(response)
      })
      .catch(error => {
...
export function getSetdata ({ commit }, itemId) {
  return new Promise((resolve, reject) => {
    api
      .get('v3/reward/reward-user/setdata')
      .then(response => {
        resolve(response)
      })
      .catch(error => {
...
export function getRecordList ({ commit }, item) {
  return new Promise((resolve, reject) => {
    api
      .get('v3/reward/record/recordlists', { params: item })
      .then(response => {
        resolve(response)
      })
      .catch(error => {
...
export function getDataLists ({ commit }, item) {
  return new Promise((resolve, reject) => {
    api
      .get('v3/reward/position/lists', { params: item })
      .then(response => {
        resolve(response)
      })
      .catch(error => {
...
export function getStoreRecordList ({ commit }, item) {
  return new Promise((resolve, reject) => {
    api
      .get('v3/reward/record/store-recordlists', { params: item })
      .then(response => {
        resolve(response)
      })
      .catch(error => {
...
export function getExport ({ commit }, item) {
  return new Promise((resolve, reject) => {
    api
      .get('v3/reward/record/store-export', { params: item })
      .then((response) => {
        resolve(response)
      })
      .catch((error) => {
