...
export function getProperty ({ commit }, params) {
  return new Promise((resolve, reject) => {
    const apiUrl = 'v3/goods/property'
    api.get(apiUrl, { params })
      .then(response => {
        resolve(response)
      })
...
export function checkCodeGoods ({ commit }, params) {
  return new Promise((resolve, reject) => {
    const apiUrl = 'v3/goods/check-code'
    api.post(apiUrl, params)
      .then(response => {
        resolve(response)
      })
...
export function setConfig ({ commit }, params) {
  return new Promise((resolve, reject) => {
    const apiUrl = 'v3/goods/set-config'
    api.post(apiUrl, params)
      .then(response => {
        resolve(response)
      })
