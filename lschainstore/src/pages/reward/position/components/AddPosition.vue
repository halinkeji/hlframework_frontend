        ...
        <div class="q-ml-lg">
          ...
          <div class="row q-my-sm">
            <div class="col-8 col-md-6 q-ml-md">
              <q-input outlined dense label="职位名称" :rules="[(val) => !!val || '必填项']" v-model="dataForm.prp_name" placeholder="请输入职位">
                <template v-slot:hint> 填写职位名称 </template></q-input
              >
            </div>
          ...
          <div class="row q-my-sm">
            <div class="col-8 col-md-6 q-ml-md">
              <q-input
                ...
                placeholder="请输入基础工资"
              >
                <template v-slot:hint> 填写职位基础工资 </template>
          ...
          <div class="row q-my-sm">
            <div class="col-8 col-md-6 q-ml-md">
              <q-input
                ...
                placeholder="请输入开卡奖励"
              >
                <template v-slot:hint> 填写开卡奖励(/位) </template>
                <template slot="append">{{ $q.localStorage.getItem('lschainstore_store_local').storeBaseConfig.consume_base_moneyUnit }}</template>
              </q-input>
            </div>
          </div>
          ...
          <div class="row q-my-sm">
            <div class="col-8 col-md-6 q-ml-md">
              ...
              >
                <template v-slot:hint> 填写消费分红百分比 </template>
