...
export default {
  ...
  created () {
    ...
    if (LocalStorage.getItem('lschainstore_store_local').storeMemberConfig) {
      this.storeMemberConfig = LocalStorage.getItem('lschainstore_store_local').storeMemberConfig
    }
  },
  methods: {
    changeMemberMobile () {
