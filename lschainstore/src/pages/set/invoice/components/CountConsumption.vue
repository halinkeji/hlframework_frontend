<template>
  <div class="fit column no-wrap justify-between items-stretch content-stretch no-scroll">
    ...
    <div class="col-shrink bg-white q-px-xs full-height bg-grey-2">
      <ag-grid-vue
        ref="agGridTable"
        class="ag-theme-balham ag-grid-table count-table-view hl_header_center hl_content_center full-height"
...
export default {
  ...
  mounted() {
    let columnDefs = [
      ...
      },
      {
        ...
        cellClassRules: {
          'cell-span-count-view': function (p) {
            if (p.value) {
              return true;
            }
          },
  ...
  methods: {
    ...
    countExport() {
      ...
      this.$store
        .dispatch('exports/getCountExport', obj)
        .then((res) => {
          if (res.code == 200) {
...
<style>
.count-table-view .cell-span-count-view {
  background: white;
