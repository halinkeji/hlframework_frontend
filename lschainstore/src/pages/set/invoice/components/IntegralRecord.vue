  ...
  <div class="fit column no-wrap justify-between items-stretch content-stretch no-scroll">
    <div class="col-shrink bg-white q-px-xs q-pb-md">
      ...
      <div class="row q-my-sm">
        ...
        <q-btn @click="countExport()" v-if="searchFrom.member_id == 0" color="red" class="q-px-md q-mr-xs" unelevated label="导出" />
      </div>
    </div>
...
export default {
  ...
  data() {
    return {
      ...
      columnDefs: [
        ...
        {
          headerName: '变更' + this.$q.localStorage.getItem('lschainstore_store_local').storeBaseConfig.consume_base_integralUnit,
        ...
        {
          headerName: this.$q.localStorage.getItem('lschainstore_store_local').storeBaseConfig.consume_base_integralUnit + '来源',
        ...
        {
          headerName: this.$q.localStorage.getItem('lschainstore_store_local').storeBaseConfig.consume_base_integralUnit + '状态',
  ...
  methods: {
    ...
    countExport() {
      ...
      this.$store
        .dispatch('exports/getPointExport', obj)
        .then((res) => {
          if (res.code == 200) {
    ...
    exportBut() {
      ...
      this.gridOptions.api.exportDataAsCsv({
        fileName: date + '-' + this.$q.localStorage.getItem('lschainstore_store_local').storeBaseConfig.consume_base_integralUnit + '记录',
      });
    },
    pinnedComputed(val) {
      const nowWidth = this.$q.screen.width;
