  ...
  data() {
    return {
      ...
      columnDefs: [
        ...
        {
          headerName: '变更' + this.$q.localStorage.getItem('lschainstore_store_local').storeBaseConfig.consume_base_balanceUnit,
        ...
        {
          headerName: this.$q.localStorage.getItem('lschainstore_store_local').storeBaseConfig.consume_base_balanceUnit + '来源',
        ...
        {
          headerName: this.$q.localStorage.getItem('lschainstore_store_local').storeBaseConfig.consume_base_balanceUnit + '状态',
  ...
  methods: {
    ...
    exportBut() {
      ...
      this.gridOptions.api.exportDataAsCsv({
        fileName: date + '-' + this.$q.localStorage.getItem('lschainstore_store_local').storeBaseConfig.consume_base_balanceUnit + '记录',
      });
    },
    pinnedComputed(val) {
      const nowWidth = this.$q.screen.width;
