  ...
  <div class="fit column no-wrap justify-between items-stretch content-stretch no-scroll">
    <div class="col-shrink bg-white q-px-xs q-pb-md">
      ...
      <div class="row q-my-sm">
        ...
        <q-btn @click="countExport()" v-if="searchFrom.member_id == 0" color="red" class="q-px-md q-mr-sm" unelevated label="导出" />
      </div>
    </div>
    <div class="col-shrink q-px-xs full-height bg-grey-2">
      <ag-grid-vue
        ref="agGridTable"
        class="ag-theme-balham ag-grid-table recharge-time-table-view hl_header_center hl_content_center full-height"
...
export default {
  ...
  mounted() {
    let columnDefs = [
        ...
        },
      {
        ...
        cellClassRules: {
          'cell-span-recharge-time-view': function (p) {
            if (p.value) {
              return true;
            }
          },
  ...
  methods: {
    ...
    countExport() {
      ...
      this.$store
        .dispatch('exports/getTimeExport', obj)
        .then((res) => {
          if (res.code == 200) {
...
<style>
.recharge-time-table-view .cell-span-recharge-time-view {
  background: white;
