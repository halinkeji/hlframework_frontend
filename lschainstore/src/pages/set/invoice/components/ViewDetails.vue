  ...
  <div>
    <q-dialog @hide="hideNowPage" v-model="viewDetails" persistent>
      ...
      <div class="col-shrink q-pa-sm full-height bg-white">
        ...
        <div class="q-mt-sm" v-if="invoiceData.lsConsumeInvoiceDetail && invoiceData.lsConsumeInvoiceDetail.length > 0">
          <q-table
            title="消费详情"
            :data="invoiceData.lsConsumeInvoiceDetail"
            :columns="consumeData"
            row-key="id"
            hide-bottom
            flat
              ...
              <q-tr :props="props">
                ...
                <q-td key="cid_consumeNumber" :props="props">
                 ...
                 <q-td key="cid_goo_price" :props="props">
                  <span v-if="parseInt(props.row.cid_packageId) > 0" class="text-red">[套]</span>
                  {{ $q.localStorage.getItem('lschainstore_store_local').storeBaseConfig.consume_base_moneySymbol }}     {{ props.row.cid_goo_price }}
                </q-td>
                <q-td key="cid_sellingPrice" :props="props">
                  <span v-if="parseInt(props.row.cid_packageId) > 0" class="text-red">[套]</span>
                 {{ $q.localStorage.getItem('lschainstore_store_local').storeBaseConfig.consume_base_moneySymbol }} {{ props.row.cid_sellingPrice }}
                </q-td>
                <q-td key="cid_totalPrice" :props="props">
                  <span v-if="parseInt(props.row.cid_packageId) > 0" class="text-red">[套]</span>
                 {{ $q.localStorage.getItem('lschainstore_store_local').storeBaseConfig.consume_base_moneySymbol }} {{ props.row.cid_totalPrice }}
                </q-td>
                ...
                <q-td key="cid_memberPrice" :props="props">
                  <span v-if="parseInt(props.row.cid_packageId) > 0" class="text-red">[套]</span>
                {{ $q.localStorage.getItem('lschainstore_store_local').storeBaseConfig.consume_base_moneySymbol }}  {{ props.row.cid_memberPrice }}
                </q-td>

                <q-td key="cid_totalPrices" :props="props">
                  <span v-if="parseInt(props.row.cid_packageId) > 0" class="text-red">[套]</span>
                {{ $q.localStorage.getItem('lschainstore_store_local').storeBaseConfig.consume_base_moneySymbol }}  {{ formatAmount(formatAmount(props.row.cid_consumeNumber * props.row.cid_goo_price) - formatAmount(props.row.cid_consumeNumber * props.row.cid_sellingPrice))}}
                </q-td>
              </q-tr>
            </template>
          </q-table>
  ...
  data () {
    return {
      ...
      consumeBasisColumn: [
        ...
        {
          label: '获得' + this.$q.localStorage.getItem('lschainstore_store_local').storeBaseConfig.consume_base_integralUnit,
          align: 'left',
          field: 'sc_getPoint'
        }
      ],
      consumPayColumn: [
        {
          label: this.$q.localStorage.getItem('lschainstore_store_local').storeBaseConfig.consume_base_balanceUnit + '支付',
          align: 'left',
        ...
        {
          align: 'left',
          label: this.$q.localStorage.getItem('lschainstore_store_local').storeBaseConfig.consume_base_integralUnit + '支付',
