  ...
  <div class="fit column no-wrap justify-between items-stretch content-stretch no-scroll">
    <q-card flat class="q-pa-sm q-mb-md">
      <div class="row col-shrink bg-white q-px-xs q-pb-md">
        ...
        <q-btn @click="countExport()" v-if="searchFrom.member_id == 0" color="red" class="q-mt-sm col-12 col-md-1 q-mr-sm" unelevated label="导出" />
      </div>
    </q-card>
...
export default {
  ...
  methods: {
    ...
    countExport() {
      ...
      this.$store
        .dispatch('exports/getReturnExport', obj)
        .then((res) => {
          if (res.code == 200) {
