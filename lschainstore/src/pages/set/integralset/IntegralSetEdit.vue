  ...
  <q-dialog v-model="dialogShow" persistent>
    ...
    >
      <q-card-section class="row items-center q-pb-none">
        <div class="text-h6">修改{{ $q.localStorage.getItem('lschainstore_store_local').storeBaseConfig.consume_base_integralUnit }}折扣设置-{{ integralData.ic_name }}</div>
        <q-space />
            ...
            <div class="row">
              ...
              <div class="col-12">
                <q-input
                  outlined
                  dense
                  :label="`${$q.localStorage.getItem('lschainstore_store_local').storeBaseConfig.consume_base_integralUnit}系数`"
