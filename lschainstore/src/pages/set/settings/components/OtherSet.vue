          ...
          <q-card flat class="bg-white q-pa-md col-6">
            <q-list separator bordered padding>
              <q-item>
                ...
                <q-item-section>
                  <q-input outlined dense label="开始时间" v-model="configData.job_end_time" readonly>
              ...
              <q-item>
                ...
                <q-item-section>
                  <q-input outlined dense label="休息时间" v-model="configData.job_start_time" readonly>
                    <template v-slot:append>
