        ...
        <q-form ref="modelConfigRef" class="row q-my-sm">
          ...
          <div class="col-8" v-if="selectStoreData">
            <q-list separator padding>
              ...
              <q-item>
                <q-item-section>
                  <q-item-label>{{ $q.localStorage.getItem('lschainstore_store_local').storeBaseConfig.consume_base_integralUnit }}使用模式</q-item-label>
                  <q-item-label caption>启用后，门店只可使用当前门店内产生的>{{ $q.localStorage.getItem('lschainstore_store_local').storeBaseConfig.consume_base_integralUnit }}。默认禁用，门店可使用会员产生的全部>{{ $q.localStorage.getItem('lschainstore_store_local').storeBaseConfig.consume_base_integralUnit }}。</q-item-label>
                </q-item-section>
                <q-item-section side top>
              ...
              <q-item>
                <q-item-section>
                  <q-item-label>{{ $q.localStorage.getItem('lschainstore_store_local').storeBaseConfig.consume_base_balanceUnit }}使用模式</q-item-label>
                  <q-item-label caption>启用后，门店只可使用当前门店内产生的>{{ $q.localStorage.getItem('lschainstore_store_local').storeBaseConfig.consume_base_balanceUnit }}。默认禁用，门店可使用会员产生的全部>{{ $q.localStorage.getItem('lschainstore_store_local').storeBaseConfig.consume_base_integralUnit }}。</q-item-label>
                </q-item-section>
                <q-item-section side top>
