            ...
            <q-scroll-area class="fit full-height">
              <q-card-section>
                <q-item-label class="row q-gutter-y-md">
                  ...
                  <div class="col col-md-3 col-sm-6 col-xs-12">
                    {{ $q.localStorage.getItem('lschainstore_store_local').storeBaseConfig.consume_base_balanceUnit }}支付:<span class="text-body1"
                      >{{ $q.localStorage.getItem('lschainstore_store_local').storeBaseConfig.consume_base_moneySymbol
                  ...
                  <div class="col col-md-3 col-sm-6 col-xs-12">
                    {{ $q.localStorage.getItem('lschainstore_store_local').storeBaseConfig.consume_base_integralUnit }}支付:<span class="text-body1"
                      >{{ $q.localStorage.getItem('lschainstore_store_local').storeBaseConfig.consume_base_moneySymbol
                ...
                <div class="row q-col-gutter-sm">
                  ...
                  <div class="col-md-3 col-12">
                    <q-input
                      ...
                      v-model="returnPoint"
                      disable
                      :label="`扣除${$q.localStorage.getItem('lschainstore_store_local').storeBaseConfig.consume_base_integralUnit}`"
                    />
                  </div>
                  <div class="col-md-3 col-12">
