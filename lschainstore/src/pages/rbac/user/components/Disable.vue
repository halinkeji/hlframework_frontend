<template>
  <q-page class="fit">
    <div class="fit column no-wrap justify-between items-stretch content-stretch no-scroll">
      <div class="col-shrink bg-white q-px-xs q-pb-md row q-px-xs q-gutter-x-sm">
        <q-input class="col-12 col-md-2 q-mt-sm" label="姓名/电话" outlined v-model="searchData.userName" dense />
        <q-btn @click="getUserList" color="primary" class="col-12 col-md-1 q-mt-sm" unelevated  label="搜索" />
        <q-btn @click="resetSearch" color="warning" class=" col-12 col-md-1 q-mt-sm" unelevated  label="重置" />
        <q-btn :to="{ name: 'userList' }" color="green" class="col-12 col-md-1 q-mt-sm" unelevated label="用户管理" />
      </div>
