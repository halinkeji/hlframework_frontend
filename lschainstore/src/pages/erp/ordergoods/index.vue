    ...
    <div class="fit column no-wrap justify-between items-stretch content-stretch no-scroll">
      <div class="col-shrink bg-white q-px-xs q-pb-md">
        <div class="q-gutter-x-xs row">
         <div class="col" v-if="is_main_store">
          ...
          <q-btn color="primary" unelevated label="创建订货单" v-if="authorityMeta('add')" @click="clickCreateOrder" />
      ...
      <div class="col-shrink bg-white q-pb-md text-center">
        ...
        <show-log-data ref="showDataRef" v-if="showLogStatus" @dataList="showLogStatus = false"></show-log-data>
              ...
              <create-order-dialog ref="orderDialogRef" @colseDialog="colseOrderDialog" v-if="orderDialogStatus" />
    </div>
  </q-page>
</template>
<script>
...
export default {
  ...
  methods: {
    ...
    getList () {
      ...
      this.$store
        .dispatch('erpOrderGoods/getDataList', obj)
        .then((res) => {
          if (res.code == 200) {
    ...
    countExport () {
      ...
      this.$store
        .dispatch('exports/getOrderGoodsExport', obj)
        .then((res) => {
          if (res.code == 200) {
    ...
    showLogData (val) {
      ...
      this.$nextTick(() => {
        this.$refs.showDataRef.init(val, 4)
      })
    },
    authorityMeta (key) {
      if (this.$route.meta) {
