  ...
  <q-page class="fit">
    <div class="fit column no-wrap justify-between items-stretch content-stretch no-scroll">
      <div class="col-shrink bg-white q-px-sm q-pb-lg q-gutter-x-xs row">
        <q-input class="col-12 col-md-2 q-mt-sm" outlined v-model="searchNumber" label="商品名称/编码/助记码/简称" dense />
...
export default {
      ...
      columnDefs: [
      {
        ...
        },
        {
          ...
          onCellValueChanged: function (p) {
            const itemsToUpdate = [];
            const data = p.data;
            data.ca_name = Math.floor(Math.random() * 20000 + 20000);
  ...
  methods: {
    ...
    getList() {
      ...
      this.$store
        .dispatch('erphistory/getListData', obj)
        .then((res) => {
          if (res.code == 200) {
