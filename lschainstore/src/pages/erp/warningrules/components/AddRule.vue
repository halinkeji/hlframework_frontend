    ...
    <q-dialog @hide="hideNowPage" v-model="isSidebarActiveLocal" persistent>
      ...
      >
        <q-card-section class="row items-center q-pb-none">
          <div class="text-subtitle2">{{ ruleForm.id > 0 ? '修改' : '新增' }}预警规则</div>

          <q-space />
          <q-btn icon="close" flat round dense v-close-popup @click="hideNowPage" />
        </q-card-section>
        <q-form ref="ruleDataRef">
          <q-card-section >
            <div class="row">
              <div class="col-12">
                <q-input
              ...
              <div class="col-12">
                <q-input outlined v-model="ruleForm.wr_time" label="预警时间" bottom-slots dense  readonly>
