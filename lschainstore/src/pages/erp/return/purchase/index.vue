  ...
  <div class="fit column no-wrap justify-between items-stretch content-stretch no-scroll">
    <div class="col-shrink bg-white q-px-xs q-pt-sm q-pb-md">
      <div class="q-gutter-x-xs row">
        ...
        <q-btn color="primary" unelevated label="新增" v-if="authorityMeta('returnPrchaseAdd')" @click="createPurchaseOrder" />
...
export default {
  ...
  methods: {
    ...
    getList () {
      ...
      this.$store
        .dispatch('erpPurchaseReturn/getData', obj)
        .then((res) => {
          if (res.code == 200) {
    ...
    rowSpan (params) {
      const fields = ['gii_inventoryInCode', 'created_at', 'gii_note', 'cep_total_purchase_amount', 'cep_total_purchase_num', 'gii_total']
    ...
    showLogData (val) {
      ...
      this.$nextTick(() => {
        this.$refs.showDataRef.init(val, 9)
      })
    },
    showDetailData (val) {
