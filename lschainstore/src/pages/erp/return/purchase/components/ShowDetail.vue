        ...
        <div class="col-shrink bg-white q-px-xs q-pb-md">
          ...
          <div class="row">
            ...
            <div class="col-12 col-md-1 q-pa-xs">
              <q-input disable dense v-model="invoiceData.cd_name" label="退货仓库" />
            </div>
            <div class="col-12 col-md-1 q-pa-xs">
    ...
    return {
      ...
      columnDefs: [
        ...
        },
        {
          headerName: '折扣额',
          valueGetter: (p) => {
            return p.data.epr_archives_id > 0 ? (p.data.epr_fold_amount > 0 ? p.data.epr_fold_amount : 0) : ''
          },
          filter: false,
          width: this.nowpx(0.05) + 'px'
        },
        {
          headerName: '折后单价',
          field: 'epr_discount_after_amount',
          filter: false,
          valueGetter: (p) => {
            return p.data.epr_archives_id > 0 ? (p.data.epr_discount_after_amount > 0 ? p.data.epr_discount_after_amount : p.data.epr_price) : ''
          },
          width: this.nowpx(0.06) + 'px'
        },
        {
          headerName: '退货金额',
          field: 'epr_cash_amount',
          filter: false,
          width: this.nowpx(0.06) + 'px'
        },
        {
      ...
      this.$store
        ...
        .then((res) => {
          if (res.code == 200) {
            ...
            this.goodsInData = res.data.purchaseReturn.length > 0 ? res.data.purchaseReturn : []
          }
        })
        .catch((error) => {
          this.$q.notify({
