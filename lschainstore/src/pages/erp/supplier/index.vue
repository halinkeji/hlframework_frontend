  ...
  <div class="fit column no-wrap justify-between items-stretch content-stretch no-scroll">
    <div class="col-shrink bg-white q-px-xs q-pb-md">
      <div class="q-gutter-x-xs row">
        <q-input class="col-12 col-md-2 q-mt-sm q-ml-sm" label="供货商名称" outlined v-model="searchProvider" dense />
        <q-btn color="primary" class=" q-mt-sm" unelevated label="搜索" @click="getSupplierList" />
  ...
  data () {
    return {
      ...
      columnDefs: [
        ...
        {
          headerName: '联系人',
          field: 'ces_contact_people',
          width: this.nowpx(0.12) + 'px'
        },
        {
          headerName: '联系电话',
          field: 'ces_contact_tel',
          width: this.nowpx(0.12) + 'px'
        },
        {
          headerName: '供货商地址',
