      ...
      <div class="fit column no-wrap justify-between items-stretch content-stretch no-scroll">
        <div class="col-shrink bg-white q-px-xs q-pb-md">
          ...
          <div class="row">
            ...
            <div class="col-12 col-md-2 q-pa-xs">
              <q-input disable dense v-model="invoiceData.cep_total_purchase_num" label="采购总数量" />
            </div>
            <div class="col-12 col-md-2 q-pa-xs">
          ...
          <q-form ref="erpInRef">
            ...
            <div class="row q-gutter-sm q-mt-xs q-pb-lg">
              ...
              <div class="col-auto text-h5">
                ...
                <span v-if="invoiceData.cep_status == 6" class="text-primary">采购入库</span>
                <span v-if="invoiceData.cep_status == 7" class="text-primary">入库完毕</span>
              </div>
            </div>
          </q-form>
        </div>
