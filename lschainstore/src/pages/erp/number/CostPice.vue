<template>
  <div class="fit column no-wrap justify-between items-stretch content-stretch no-scroll">
    <div class="q-gutter-x-xs row col-shrink bg-white q-px-sm q-pb-md">
      ...
      <q-btn color="primary" class=" q-mt-sm" unelevated v-if="authorityMeta('search')" label="搜索" @click="getList" />
      <q-btn color="warning" @click="resetCondition" class=" q-mt-sm" unelevated v-if="authorityMeta('reset')" label="重置" />
      <q-btn
        <q-btn
        color="primary"
        class=" q-mt-sm  "
