  ...
  <q-page class="fit">
    <div class="fit column no-wrap justify-between items-stretch content-stretch no-scroll">
      ...
      <div class="col-shrink full-height bg-grey-2" v-if="activeName == '3'">
        <out-return-view :goods="goodsId" :archives_id="archives_id" :type="1" />
      </div>
      ...
      <div class="col-shrink full-height bg-grey-2" v-if="activeName == '6'">
        <numberlog-view :goods="goodsId" :archives_id="archives_id"></numberlog-view>
      </div>
...
import NumberlogView from './NumberlogView.vue'
