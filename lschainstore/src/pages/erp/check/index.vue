    ...
    <div class="fit column no-wrap justify-between items-stretch content-stretch no-scroll">
      <div class="col-shrink bg-white q-px-xs q-pb-md">
        <div class="q-gutter-x-xs row">
          ...
          <div class="col-2">
            <q-input class="col-2" outlined v-model="depot" label="请输入盘点仓库" dense />
          </div>
...
export default {
  ...
  data () {
    return {
      ...
      columnDefs: [
        ...
        {
          headerName: '应有库存',
          field: 'cep_should_total_quantity',
          width: this.nowpx(0.1) + 'px',
          comparator: (a, b) => a - b
        },
        // {
        //   headerName: '应存金额',
        //   field: 'cep_should_total_amount',
        //   width: this.nowpx(0.1) + 'px',
        //   comparator: (a, b) => a - b
        // },
        {
          headerName: '实盘库存',
          field: 'cep_real_total_quantity',
          width: this.nowpx(0.1) + 'px',
          comparator: (a, b) => a - b
        },
        // {
        //   headerName: '实盘金额',
        //   field: 'cep_real_total_amount',
        //   width: this.nowpx(0.1) + 'px',
        //   comparator: (a, b) => a - b
        // },
        {
  ...
  methods: {
      ...
      const newRows = this.countColumnData(list, [
        {
          ...
          // cep_should_total_amount: '',
          cep_real_total_quantity: ''
          // cep_real_total_amount: ''
        }
      ])
      setTimeout(() => {
    ...
    showLogData (val) {
      ...
      this.$nextTick(() => {
        this.$refs.showDataRef.init(val, 11)
      })
    },
    authorityMeta (key) {
      if (this.$route.meta) {
