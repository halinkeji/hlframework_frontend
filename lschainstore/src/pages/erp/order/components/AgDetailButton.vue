<template>
  <div v-if="!params.data.show_status">
    <q-btn
      ...
      round
      size="sm"
      v-if="params.data.id > 0 && params.data.ceo_status == 1 && authorityMeta('detailConfirm')"
    ...
    <q-btn
      ...
      round
      size="sm"
      v-if="params.data.id > 0 && params.data.ceo_status == 2 && authorityMeta('detailCancel')"
      @click="updated"
    >
    ...
    <q-btn
      ...
      round
      size="sm"
      v-if="params.data.id > 0 && params.data.ceo_status == 2 && authorityMeta('detailAudit')"
      :to="{ name: 'addOrderGoods', query: { id: params.data.id } }"
    >
    ...
    <q-btn
      ...
      round
      size="sm"
      v-if="params.data.id > 0 && params.data.ceo_status == 5 && authorityMeta('detailHangup')"
      :to="{ name: 'addOrderGoods', query: { id: params.data.id } }"
    >
    ...
    <q-btn
      ...
      round
      size="sm"
      v-if="params.data.ceo_status < 2 && authorityMeta('detailClose')"
      @click="close"
    >
    ...
    <q-btn
      ...
      round
      size="sm"
      v-if="params.data.ceo_link_id > 0 && authorityMeta('linkView')"
