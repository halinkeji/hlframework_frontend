    ...
    >
      ...
      <q-card-section>
        <q-form ref="depotDataRef">
          ...
          <q-input outlined type="textarea" bottom-slots dense :rows="2" v-model="depotData.cd_note" label="说明" />
          ...
          <q-input label="联系地址" bottom-slots outlined v-model="depotData.cd_address" dense :error="false" />
