      ...
      if (data && data.length > 0) {
        ...
        for (let i = 0; i < data.length; i++) {
          if (list.indexOf(parseInt(data[i].id)) == -1) {
            ...
            person.psg_goods_name = data[i].goo_name;
            person.psg_code = data[i].goo_code;
            person.psg_price = data[i].goo_price;
    ...
    getSelectedGoodsData(data, status = false) {
      ...
      if (data && data.length > 0) {
        ...
        for (let i = 0; i < data.length; i++) {
          if (list.indexOf(parseInt(data[i].id)) == -1) {
            const person = {};
            person.psg_goods_id = data[i].goods_id;
            person.psg_goods_name = data[i].goo_name;
            person.psg_sep_id = data[i].id;
            person.psg_spe_name = data[i].specificationName;
            person.psg_code = data[i].goo_code;
            person.psg_price = data[i].goo_price;
            specNewsDataBak.push(person);
          } else {
