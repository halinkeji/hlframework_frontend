    ...
    <div class="col-shrink bg-white  q-pb-md">
      <div class="row q-gutter-x-sm">
        <q-select
          ...
          label="会员级别"
        />
        <q-input class="col-12 col-md-2 q-mt-sm" :label="`请输入${$q.localStorage.getItem('lschainstore_store_local').storeBaseConfig.consume_base_integralUnit}`" outlined v-model="memberLevelPrice" dense />
...
export default {
  ...
  methods: {
    ...
    changeStatus () {
      ...
      this.$store
        .dispatch('pointPrice/SetAll', obj)
        .then((res) => {
          if (parseInt(res.code) == 200) {
            this.$q.notify({
              message: '成功',
