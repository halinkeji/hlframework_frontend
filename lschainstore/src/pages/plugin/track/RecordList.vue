<template>
  <div class="fit column no-wrap justify-between items-stretch content-stretch no-scroll">
    <div class="col-shrink bg-white q-px-xs q-pb-md q-gutter-x-xs row ">
      ...
      <q-input class="col-12 col-md-3 q-mt-sm " label="可搜索:会员卡号/手机号/真实姓名/昵称" outlined v-model="member" dense />
      <q-input class="col-12 col-md-3 q-mt-sm " label="可搜索:跟踪标题" outlined v-model="searchQuery" dense />
