<template>
  <div class="fit column no-wrap justify-between items-stretch content-stretch no-scroll bg-grey-2">
...
export default {
  ...
  data () {
    return {
      ...
      columnDefs: [
        ...
        {
          headerName: '应付总金额',
          field: 'pzr_payable_amount',
          width: this.nowpx(0.06) + 'px'
        },
        {
          headerName: '实收金额',
          field: 'pzr_real_pay_amount',
          filter: false,
          width: this.nowpx(0.1) + 'px',
          valueGetter: (p) => {
            return p.data.pzr_real_pay_amount > 0 ? p.data.pzr_real_pay_amount : 0
          }
        },
        {
          headerName: '支付状态',
  ...
  methods: {
    ...
    getList () {
      ...
      this.$store
        .dispatch('zzpay/getRecordList', obj)
        .then((res) => {
          if (res.code == 200) {
