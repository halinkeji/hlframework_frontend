                ...
                <q-item>
                  <q-item-section avatar>
                      ...
                      <q-avatar v-if="memberData.coverImage && memberData.coverImage.id" text-color="white">
                        <img :src="$q.localStorage.getItem('lschainstore_system_local').attach_url + memberData.coverImage.path" />
                      </q-avatar>
                ...
                <q-item>
                  <q-item-section avatar>
                      <q-avatar v-if="sonMemberData.coverImage && sonMemberData.coverImage.id" text-color="white">
                        <img :src="$q.localStorage.getItem('lschainstore_system_local').attach_url + sonMemberData.coverImage.path" />
                      </q-avatar>
                <q-avatar v-else><q-icon color="grey" name="las la-user-circle" size="xl"></q-icon></q-avatar>
                  </q-item-section>
                  <q-item-section>
        ...
        >
          <div class="col-6 q-pr-sm">
            <q-input
              ...
              :rules="[
                (val) => !!val || '必填项',
                (val) => /(^[1-9]([0-9]+)?(\.[0-9]{1,2})?$)|(^(0){1}$)|(^[0-9]\.[0-9]([0-9])?$)/.test(val) || '请输入正确的' + this.$q.localStorage.getItem('lschainstore_store_local').storeBaseConfig.consume_base_integralUnit,
              ]"
            />
          </div>
          <div class="col-6 q-pl-sm">
