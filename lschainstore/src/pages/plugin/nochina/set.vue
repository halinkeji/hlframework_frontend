...
const nochainConfig = LocalStorage.getItem('lschainstore_plugins_local').nochainConfig
...
export default {
  ...
  mounted () {
    this.getItemData()
    this.currentConfig = LocalStorage.getItem('lschainstore_plugins_local').nochainConfig
  },
