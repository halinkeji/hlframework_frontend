    ...
    <div class="fit column no-wrap justify-between items-stretch content-stretch no-scroll">
      <div class="col-shrink bg-white q-px-xs q-py-md">
        <q-form ref="zzfwfFormRef" class="row  q-gutter-sm items-start">
          ...
          <div class="col-2">
            <q-select v-model="zzfwfForm.zrg_link_type" dense outlined option-value="value" option-label="label" emit-value map-options :options="linkTypeOptions" label="选择折扣类型" />
          </div>
          <div class="col-4 row" v-if="zzfwfForm.zrg_link_type != 'close'">
            <div class="col-6" v-if="zzfwfForm.zrg_link_type == 'discount'">
              <q-input
                ...
                :rules="[
                (val) => /^(([1-9]{1}\d*)|(0{1}))(\.\d{1,2})?$/.test(val) || '请输入正确的数值1',
