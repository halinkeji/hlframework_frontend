<template>
  <q-dialog @hide="hideNowPage" v-model="showDialog" persistent class="">
    <q-card
      :style="{
    ...
    >
      ...
      <q-card-actions align="left" class="q-pb-md">
        <q-btn unelevated label="还原字段显示"  color="blue-grey-3 " icon="refresh" @click="refresh" class="q-ml-lg" />
