<template>
  <q-dialog v-model="pendingOrderDialog" @hide="$emit('hidePendingOrderDialog')" class="fit">
    <q-card
      :style="{
    ...
    >
                ...
                <template v-slot:body="props">
                  <q-tr :props="props">
                    ...
                    <q-td key="id" :props="props">
                      <q-checkbox v-model="currentHangId" :val="props.row.id" @input="getHangDetailsBut(props.row)" />
                    </q-td>
                  ...
                  <q-tr v-show="props.expand" :props="props">
                    <q-td colspan="100%">
                      <q-table bordered hide-pagination :data="props.row.lsDetail" :columns="orderDetailcolumns" row-key="name" flat separator="cell">
                        <template v-slot:body="props">
                          <q-tr :props="props">
      ...
      <div class="col-shrink bg-white q-pb-sm row q-gutter-sm text-center justify-center">
        ...
        <div class="col-6 text-center q-gutter-md">
          <q-btn color="deep-orange" unelevated :disable="!currentHangInfo.id" @click="solutionsHanging" label="去结账" />
          <q-btn color="white" text-color="black" unelevated :disable="!currentHangInfo.id" @click="deleteHangData" outline label="删除挂单" />
        </div>
      </div>
    </q-card>
