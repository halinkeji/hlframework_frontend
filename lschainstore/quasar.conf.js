...
module.exports = function (ctx) {
  return {
    ...
    framework: {
      ...
      // Quasar plugins
      plugins: ['Loading', 'Notify', 'LoadingBar', 'LocalStorage', 'SessionStorage', 'Cookies', 'Meta', 'Dialog', 'AppFullscreen']
    },
    ...
    pwa: {
      ...
      manifest: {
        name: 'hlframework frontend web lschainstore',
        short_name: 'hlframework frontend web lschainstore',
        description: 'hlframework frontend web lschainstore',
        display: 'standalone',
