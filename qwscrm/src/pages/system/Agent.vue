<template>
  <div>
        ...
        <q-tr :props="props">
         ...
         <q-td key="type" :props="props">
          ...
          <q-td key="close" :props="props">
             <q-badge color="grey" v-if="parseInt(props.row.close) == 1">
                是
              </q-badge>
               <q-badge color="blue" v-else>
                否
              </q-badge>
          </q-td>
          ...
          <q-td key="operate" :props="props">
            <q-btn outline color="positive" label="API配置 " @click="openApiDialog(props.row.id)" class="q-mr-xs" />
    ...
    <edit-agent v-if="editDialogStatus" ref="editDialogRef" @closeDialog="getDataList" />
     <edit-api-config v-if="editApiStatus" ref="editApiDialogRef" @closeDialog="getDataList" />
  </div>
</template>
...
import EditApiConfig from './EditApiConfig.vue'
