          ...
          <q-form ref="contractDataRef" class="row">
           ...
           <div class="col-6 q-px-xs">
            ...
            <q-card flat bordered class="col-12 q-my-sm">
              ...
              <div class="col-12 row q-pa-xs">
                <hl-upload
                  :multiple="true"
                  :maxTotal="5"
                  :currentAttach="contractDataForm.imageData"
                  @input="(val)=>{ $nextTick(()=>{ contractDataForm.file_attach.image = val })}"
            ...
            <hl-file-upload
              ...
              cardTitle="上传附件"
              :valuePath="contractDataForm.fileData"
              @filePath="(val)=>{ $nextTick(()=>{ contractDataForm.file_attach.file = val })}"
            ></hl-file-upload>
          </q-form>
        </q-page>
      </q-page-container>
