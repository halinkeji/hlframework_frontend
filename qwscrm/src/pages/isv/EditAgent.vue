...
export default {
  ...
  computed: {
    redirect_uri_data () {
      ...
      if (system_local) {
        if (parseInt(this.dataForm.type) == 3) {
          return system_local.systemInfo.site_url + '/qwscrm/v1/provider/suite-data-callback?SuiteId='
        }
      }
    ...
    redirect_uri_do () {
      ...
      if (system_local) {
        if (parseInt(this.dataForm.type) == 3) {
          return system_local.systemInfo.site_url + '/qwscrm/v1/provider/suite-do-callback?SuiteId='
        } else {
          return system_local.systemInfo.site_url + '/qwscrm/v1/provider/suite-replace-callback?SuiteId='
        }
      }
