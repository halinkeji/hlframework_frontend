  ...
  <div class="q-mt-sm ">
    ...
    <div class="row q-gutter-sm" v-if="currentAttachData && currentAttachData.length > 0 && multiple">
      <div v-for="(item,key) in currentAttachData">
        ...
        <q-img :src="$q.localStorage.getItem('qwscrm_system_local').attach_url + item.path" width="100px" height="100px">
    ...
    <div v-if="!multiple">
      <q-img :src="$q.localStorage.getItem('qwscrm_system_local').attach_url + currentAttachObject.path" width="100px" height="100px">
