<template>
  <div class="q-gutter-sm">
    ...
    <q-btn color="warning" unelevated v-if="parseInt(params.data.state) == 1" label="更新订单状态"  @click="updateOrderStatus" />
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    updateOrderStatus () {
      ...
      this.$store
        .dispatch('transferOrder/queryTransferOrder', {
          transfer_order_id: this.params.data.transfer_order_id,
