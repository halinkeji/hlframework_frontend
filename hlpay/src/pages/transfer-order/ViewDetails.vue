            ...
            <q-scroll-area class="fit full-height">
              <div class="row">
                <div class="col-6">
                  ...
                  <q-separator />
                  <q-item v-if="invoiceData.transfer_order_id">
                    <q-item-section>
                      <q-item-label class="text-grey-8">转账订单号</q-item-label>
                    </q-item-section>

                    <q-item-section side>
                      <q-item-label class="text-dark" lines="2">{{ invoiceData.transfer_order_id }}</q-item-label>
                    </q-item-section>
                  </q-item>
                  ...
                  <q-item v-if="invoiceData.channel_order_no">
                   ...
                   <q-item v-if="invoiceData.success_time">
                    <q-item-section>
                      <q-item-label class="text-grey-8">转账成功时间</q-item-label>
                    </q-item-section>
                  ...
                  <q-item v-if="invoiceData.refund_amount">
                    <q-item-section>
                      <q-item-label class="text-grey-8">转账金额</q-item-label>
                    </q-item-section>
                  ...
                  <q-item v-if="invoiceData.state">
                    <q-item-section>
                      <q-item-label class="text-grey-8">状态</q-item-label>
                    </q-item-section>

                    <q-item-section side>
                      <q-item-label class="text-dark" lines="2">{{ payTransferOrderStateObject[invoiceData.state] }}</q-item-label>
                    </q-item-section>
                  </q-item>
  ...
  methods: {
    ...
    getViewData (id) {
      ...
      if (enumLocal && enumLocal.payCodeObject) {
        ...
        this.payTransferOrderStateObject = enumLocal.payTransferOrderStateObject
      ...
      if (id > 0) {
        this.$store
          .dispatch('transferOrder/getItemData', id)
          .then((res) => {
            if (res.code == 200) {
