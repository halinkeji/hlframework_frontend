        ...
        <div class="row q-gutter-xs q-mt-sm">
          ...
          <div class="col-12 col-md-2">
            ...
            <q-select
              ...
              emit-value
              map-options
              :options="payTransferOrderStateArr"
...
export default {
      ...
      columnDefs: [
        {
          ...
          valueGetter: (p) => {
            return this.payTransferOrderStateObject[p.data.state]
          }
        },
        {
          headerName: '转账订单号',
          field: 'transfer_order_id',
  ...
  created () {
    ...
    if (enumLocal && enumLocal.wayCodeArr) {
      ...
      this.payTransferOrderStateArr = enumLocal.payTransferOrderStateArr
    }
  },
  methods: {
    timeFormatDate (p) {
    ...
    getList () {
      ...
      this.$store
        .dispatch('transferOrder/getListData', obj)
        .then((res) => {
          if (res.code == 200) {
