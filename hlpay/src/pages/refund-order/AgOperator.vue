<template>
  <div class="q-gutter-sm">
    ...
    <q-btn color="warning" unelevated v-if="['snappay','sqbpay','ylpay','fubeipay'].indexOf(params.data.pay_code) > -1 && parseInt(params.data.state) == 1" label="更新订单状态"  @click="updateOrderStatus" />
  </div>
</template>
