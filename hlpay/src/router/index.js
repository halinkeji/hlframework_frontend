  ...
  store().dispatch('user/roleInfo')
    .then(res => {
      if (res.data) {
        ...
        LocalStorage.set('hlpay_apply_local', res.data.apply_local)
        LocalStorage.set('hlpay_store_local', res.data.store_local)
        LocalStorage.set('hlpay_plugins_local', res.data.plugins_local)
