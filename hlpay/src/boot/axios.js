...
api.interceptors.request.use(
  function (config) {
    ...
    if (Cookies.get('loggedIn')) {
      ...
      config.headers.common.StoreId = LocalStorage.getItem('hlpay_account_info').store_id
      config.headers.common.UserId = LocalStorage.getItem('hlpay_account_info').user_id
      config.headers.common.ApplyId = LocalStorage.getItem('hlpay_account_info').apply_id
      config.headers.common.LibId = LocalStorage.getItem('hlpay_account_info').lib_id
    }
