...
module.exports = function (ctx) {
  return {
    ...
    pwa: {
      ...
      manifest: {
        name: 'hlframework frontend web cychainstore',
        short_name: 'hlframework frontend web cychainstore',
        description: 'hlframework frontend web cychainstore',
        display: 'standalone',
    ...
    electron: {
      ...
      builder: {
        ...
        appId: 'hlframework_e_cychainstore',
