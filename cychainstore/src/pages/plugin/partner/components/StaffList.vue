<template>
  <div class="fit column no-wrap justify-between items-stretch content-stretch no-scroll">
    <div class="col-shrink bg-white q-px-xs q-pb-md q-gutter-x-xs row">
      <q-input class="col-12 col-md-3 q-mt-sm " label="可搜索:卡号/员工昵称/员工姓名/手机号" outlined v-model="searchQuery" dense />
      ...
      <q-btn @click="addData()" v-if="authorityMeta('add')" color="primary" class=" col-12 col-md-1 q-mt-sm" unelevated label="新增" />
    </div>
