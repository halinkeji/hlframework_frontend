        ...
        },
        {
          ...
          valueGetter: (p) => {
            if (parseInt(p.data.zml_is_share_balance) == -1) {
              ...
              return '共享' + this.$q.localStorage.getItem('cychainstore_store_local').storeBaseConfig.consume_base_balanceUnit + '（限制）'
            } else {
              return ''
            }
          },
        ...
        },
        {
          ...
          valueGetter: (p) => {
            if (parseInt(p.data.zml_is_share_integral) == -1) {
              ...
              return '共享' + this.$q.localStorage.getItem('cychainstore_store_local').storeBaseConfig.consume_base_integralUnit + '（限制）'
            } else {
              return ''
            }
          },
