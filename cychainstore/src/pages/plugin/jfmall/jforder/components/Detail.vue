            ...
            <div class="row">
                ...
                <q-item clickable>
                  <q-item-section>
                    <q-item-label class="text-grey-8"
                      >{{ $q.localStorage.getItem('cychainstore_store_local').storeBaseConfig.consume_base_integralUnit }}:</q-item-label
                    >
                  </q-item-section>
              ...
              <div class="col-6" v-if="orderData.jo_saving_money > 0">
                <q-item clickable>
                  <q-item-section>
                    <q-item-label class="text-grey-8"
                      >{{ $q.localStorage.getItem('cychainstore_store_local').storeBaseConfig.consume_base_balanceUnit }}:</q-item-label
                    >
                  </q-item-section>
