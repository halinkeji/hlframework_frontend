   ...
   <q-dialog persistent v-model="detailDialogStatus" class="text-black">
    ...
    >
      <div class="fit column  no-wrap justify-between items-stretch content-stretch no-scroll">
                      ...
                      <div class="col row">
                        <div class="col-4 row">
                          ...
                          <q-input outlined class="col-5" v-model="item.fgm_one_amount" dense v-else>
                            <q-separator vertical />
                            <template v-slot:append>
                              <span class="text-caption q-px-xs">{{ $q.localStorage.getItem('cychainstore_store_local').storeBaseConfig.consume_base_moneyUnit }}</span>
                            </template>
                          </q-input>
                        </div>
                        <div class="col-4 row">
        ...
        <hl-goods-table ref="specificationTree" v-if="showGoodsList" @getSelectedGoodsData="getSelectedGoodsData" @closeDialog="showGoodsList = false"></hl-goods-table>
