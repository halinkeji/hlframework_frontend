<template>
  <div>
    ...
    <q-btn unelevated color="red" label="拒绝" @click="setMemberData(-2)" v-if="authorityMeta('editMember')&&parseInt(params.data.pfm_level_id)>-2"> </q-btn>
  </div>
</template>
<script>
export default {
