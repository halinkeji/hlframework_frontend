            ...
            <template v-slot:body="props">
              <q-tr :props="props">
                ...
                <q-td key="fgr_selling_price" :props="props">
                  <div>{{ $q.localStorage.getItem('cychainstore_store_local').storeBaseConfig.consume_base_moneySymbol }}{{ props.row.fgr_selling_price }}</div>
                </q-td>
                <q-td key="fgr_quantity" :props="props">
                  <div>{{ props.row.fgr_quantity }}</div>
                </q-td>
                <q-td key="fgr_total_amount" :props="props">
                  <div>{{ $q.localStorage.getItem('cychainstore_store_local').storeBaseConfig.consume_base_moneySymbol }}{{ props.row.fgr_total_amount }}</div>
                </q-td>
              </q-tr>
            </template>
          </q-table>
            ...
            <template v-slot:body="props">
              <q-tr :props="props">
                ...
                <q-td key="fxzxAmount" :props="props">
                  <div>{{ $q.localStorage.getItem('cychainstore_store_local').storeBaseConfig.consume_base_moneySymbol }}{{ props.row.fxzxAmount }}</div>
                </q-td>
