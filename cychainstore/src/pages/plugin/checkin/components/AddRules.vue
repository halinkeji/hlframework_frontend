              ...
              <div class="row">
                <div class="col-6 q-pr-md">
                  <q-banner rounded class="text-white bg-red" dense>
                    注意：赠送卡券、次卡、{{ $q.localStorage.getItem('cychainstore_store_local').storeBaseConfig.consume_base_balanceUnit }}、{{
              ...
              <div class="row q-my-xs">
                <div class="col-6">
                  <q-input
                    ...
                    lazy-rules
                    :rules="[(val) => /^[0-9]+(.[0-9]{1,2})?$/.test(val) || '请输入正确的' + `${$q.localStorage.getItem('cychainstore_store_local').storeBaseConfig.consume_base_integralUnit}`]"
                  />
                </div>
                <div class="col-6">
