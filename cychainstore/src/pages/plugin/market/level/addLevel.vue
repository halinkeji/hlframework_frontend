                          ...
                          <q-item>
                            <q-item-section>
                              ...
                              <q-item-label>
                                ...
                                <span class="text-orange"> {{ $q.localStorage.getItem('cychainstore_store_local').storeBaseConfig.consume_base_moneyUnit }}</span>
                              </q-item-label>
                              <q-item-label>
                                佣金比例：
                              ...
                              <q-item-label>
                                赠送{{ $q.localStorage.getItem('cychainstore_store_local').storeBaseConfig.consume_base_integralUnit }}：
