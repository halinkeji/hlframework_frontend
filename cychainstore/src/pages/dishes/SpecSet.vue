<template>
  <div class="fit bg-white row q-col-gutter-sm">
      ...
      <q-list bordered>
        <q-item>
          ...
          <q-item-section side v-if="parseInt(dishesData.goo_size) == 1">
            <q-btn unelevated color="primary" @click="addSpecification()" label="新增规格" :disable="mainStoreDisable"
          /></q-item-section>
          <q-item-section side>
            <q-checkbox true-value="1" :disable="mainStoreDisable" false-value="0" v-model="dishesData.goo_size"
          /></q-item-section>
        </q-item>
      </q-list>
    </div>
    ...
    <div class="col-3 q-mb-sm" v-if="parseInt(dishesData.goo_goodsOrService) < 3">
      <q-list bordered>
        <q-item>
          ...
          <q-item-section side>
            <q-checkbox true-value="1" :disable="mainStoreDisable" false-value="0" v-model="dishesData.fl_is_material"
          /></q-item-section>
        </q-item>
      </q-list>
    </div>
      ...
      <div class="col-4" v-for="(item, key) in specMain" :key="key">
        <q-card flat bordered>
          <q-item class="q-mt-sm">
            ...
            <q-item-section side class="q-mb-md">
              <q-checkbox true-value="1" :disable="mainStoreDisable" false-value="0" label="是否必选" v-model="item.fsm_required" />
            </q-item-section>
            <q-item-section side class="q-mb-md">
              <q-btn unelevated color="red" dense :disable="mainStoreDisable" @click="deleteSpecification(item, key)" icon="las la-trash-alt" round />
            </q-item-section>
          </q-item>
          <q-separator />
          ...
          <q-card-section class="q-pa-sm">
            <q-card flat bordered class="q-pa-sm q-mt-sm" v-for="(i, k) in item.sonItem" :key="k">
              ...
              <q-item >
                <q-item-section>
                  <q-input outlined bottom-slots :disable="mainStoreDisable" label="子规格名称" dense v-model="i.fss_name"> </q-input>
                </q-item-section>
                <q-item-section>
                  <q-input
                    outlined
                  ...
                  <div class="col-12" v-for="(value, ks) in i.fss_level_price">
                    <q-card flat>
                      ...
                      <q-item>
                        ...
                        <q-item-section>
                          <q-input outlined bottom-slots :disable="mainStoreDisable" label="折扣" dense v-model="value.discount">
                            <template v-slot:append>
              ...
              <q-list v-if="parseInt(dishesData.fl_is_material) == 1">
                <q-item>
                  ...
                  <q-item-section side >
                    <q-btn unelevated color="primary" :disable="mainStoreDisable" @click="bindMaterial(key, k)" label="选择原料" dense />
                  </q-item-section>
                </q-item>
                ...
                <q-item :key="ks + k" v-for="(value, ks) in i.materialData">
                  ...
                  <q-item-section side class="q-mb-md">
                    <q-btn unelevated color="red" :disable="mainStoreDisable" @click="deleteMaterialData(key,k,ks)" dense icon="las la-trash-alt" round />
                  </q-item-section>
                </q-item>
              </q-list>
            </q-card>
          ...
          <q-card-actions align="center">
            <q-btn unelevated color="primary" :disable="mainStoreDisable" @click="addSubSpecification(key)" label="添加子规格" />
          </q-card-actions>
        </q-card>
      </div>
    </div>
      ...
      <div class="col-4" v-for="(item, key) in flLevelPrice">
        <q-card flat bordered>
          ...
          <q-item>
            ...
            <q-item-section>
              <q-input outlined bottom-slots :disable="mainStoreDisable" label="折扣" dense v-model="item.discount">
                <template v-slot:append>
                  <span class="text-dark text-caption">%</span>
                </template>
              </q-input>
      ...
      <div class="col-4">
        <q-list bordered>
          <q-item>
            ...
            <q-item-section side >
              <q-btn unelevated color="primary" :disable="mainStoreDisable" @click="bindMainMaterial" label="选择原料" dense />
            </q-item-section>
          </q-item>
          ...
          <q-item :key="'material' + key" v-for="(item, key) in mainMaterialData">
            ...
            <q-item-section side class="q-mb-md">
              <q-btn unelevated color="red" :disable="mainStoreDisable" @click="deleteMainMaterialData(key)" dense icon="las la-trash-alt" round />
            </q-item-section>
          </q-item>
        </q-list>
      </div>
    ...
    <div class="row col-12" v-if="parseInt(dishesData.goo_goodsOrService) == 3">
      <div class="col-12">
        <q-btn unelevated :disable="mainStoreDisable" color="primary" label="选择菜品" @click="openSelectFoodDialog" />
      </div>
