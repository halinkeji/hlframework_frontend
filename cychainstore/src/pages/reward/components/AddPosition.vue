          ...
          <div class="row q-my-sm">
            <div class="col-8 col-md-6  q-ml-md">
              ...
              >
                ...
                <template slot="append">{{ $q.localStorage.getItem('cychainstore_store_local').storeBaseConfig.consume_base_moneyUnit }}</template>
              </q-input>
            </div>
          </div>
  ...
  methods: {
    init (id) {
      ...
      if (id > 0) {
        ...
        this.$store.dispatch('reward/getItem', id).then((res) => {
          if (res.code == 200) {
