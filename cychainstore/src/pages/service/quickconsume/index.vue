  ...
  <q-page class="fit">
    <div class="fit column  no-wrap justify-between items-stretch content-stretch no-scroll">
              ...
              <q-separator inset />
                <div class="row">
                  <div class="col-6 col-md-3 q-mt-md q-px-xs" v-for="(item, key) in fixedMoneyList">
                    <q-btn unelevated rounded color="green" @click="consumeAmount = item.fm_parameter" class="q-px-md full-width"> ￥{{ item.fm_parameter }} </q-btn>
                  </div>
                </div>
            </q-card>
          </q-form>
      ...
      <div class="col-shrink bg-white q-pb-md q-gutter-md  q-mt-xs text-center">
        ...
        <q-btn unelevated color="blue-6" class="q-px-xl" label="结账" :disable="buttonDisabled" size="lg" @click="checkoutWindow()" />
      </div>
    </div>
