                ...
                <q-card bordered flat>
                  <q-card-section class="q-pa-xs">
                    <div class="text-subtitle2 text-center">
                      {{ item.fsm_name }} <q-badge rounded v-if="parseInt(item.fsm_required) == 2" color="positive"> 必选 </q-badge> <q-badge rounded v-if="parseInt(item.fsm_multiple) == 1" color="positive"> 可多选 </q-badge>
                    </div>
                  </q-card-section>
                  <q-separator />
                  <q-card-section class="q-pa-sm">
