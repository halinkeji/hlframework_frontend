  ...
  <q-page class="fit">
    <div class="fit column no-wrap justify-between items-stretch content-stretch no-scroll">
        ...
        <div class="row fit bg-white justify-around">
          ...
          <q-form ref="submitFormRef" class="col-12  col-md-4  q-px-xs  q-pt-md">
            <q-card flat class="q-pa-md">
              ...
              <q-input outlined rows="3" dense bottom-slots label="备注" v-model="sc_note" type="textarea" class="q-mt-lg text-h6"> </q-input>
              ...
              <q-card-section class="q-py-sm" v-if="fixedMoneyList.length > 0">
                <div class="row">
                  <div class="col-6 col-md-3 q-mt-md q-px-xs" v-for="item in fixedMoneyList">
                    <q-btn unelevated rounded color="green" class="q-px-md full-width" :disable="memberId == 0" @click="deductAmount = item.fm_parameter"> ￥{{ item.fm_parameter }} </q-btn>
                  </div>
                </div>
              </q-card-section>
            </q-card>
      ...
      <div class="col-shrink bg-white q-pb-md q-gutter-md text-center q-mt-xs">
        ...
        <q-btn unelevated color="red-5" class="q-px-xl" size="lg" label="扣除" :disable="buttonDisabled" @click="minusBut()" icon="las la-minus-circle" />
      </div>
    </div>
  </q-page>
</template>
