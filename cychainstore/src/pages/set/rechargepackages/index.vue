    ...
    <div class="fit column no-wrap justify-between items-stretch content-stretch no-scroll">
      <div class="col-shrink bg-white " :class="{ 'q-pb-lg': parseInt(activeName) == 0 ? true : false }">
        ...
        <div class="row q-px-sm q-gutter-x-sm items-center" v-if="parseInt(activeName) == 0">
          ...
          <q-btn @click="getList()" color="primary" class="q-mt-sm" unelevated label="搜索" />
          <q-btn @click="clearButton" color="warning" class="q-mt-sm" unelevated label="重置" />
          <q-btn @click="addRechargePackage()" color="primary" class="q-mt-sm" unelevated v-if="authorityMeta('add')" label="新增" />
          <q-btn
