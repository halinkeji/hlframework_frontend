...
export default {
  ...
  created () {
    ...
    if (LocalStorage.getItem('cychainstore_store_local').storeMemberConfig) {
      this.storeMemberConfig = LocalStorage.getItem('cychainstore_store_local').storeMemberConfig
    }
