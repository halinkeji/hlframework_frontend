        ...
        <div class="q-px-sm" v-show="activeName == 'upgrade'">
          <div class="row">
            <q-input
              ...
              :label="'赠送' + `${$q.localStorage.getItem('cychainstore_store_local').storeBaseConfig.consume_base_integralUnit}`"
              outlined
              ...
              :rules="[
                (val) =>
                  /^(\d+|\d+\.\d{1,2})$/.test(val) ||
                  '赠送' + `${$q.localStorage.getItem('cychainstore_store_local').storeBaseConfig.consume_base_integralUnit}` + '为非负两位以内小数',
              ]"
            />

            <q-input
              class="col-12 col-md-4 q-pr-md"
              :label="`赠送${$q.localStorage.getItem('cychainstore_store_local').storeBaseConfig.consume_base_balanceUnit}`"
              outlined
              ...
              :rules="[
                (val) =>
                  /^(\d+|\d+\.\d{1,2})$/.test(val) ||
                  '赠送' + $q.localStorage.getItem('cychainstore_store_local').storeBaseConfig.consume_base_balanceUnit + '为非负两位以内小数',
              ]"
            />
          </div>
        </div>
            ...
            <div class="row q-pl-xs">
              ...
              <q-input
                ...
                :rules="[
                  (val) =>
                    /^(\d+|\d+\.\d{1,2})$/.test(val) ||
                    '扣除' + `${$q.localStorage.getItem('cychainstore_store_local').storeBaseConfig.consume_base_integralUnit}` + '为非负两位以内小数',
                ]"
              />
              <q-input
...
export default {
  ...
  data () {
    return {
      ...
      deductionmethod: [
        { label: '扣除' + this.$q.localStorage.getItem('cychainstore_store_local').storeBaseConfig.consume_base_balanceUnit, value: '1' },
        { label: '扣除' + this.$q.localStorage.getItem('cychainstore_store_local').storeBaseConfig.consume_base_integralUnit, value: '2' },
        { label: this.$q.localStorage.getItem('cychainstore_store_local').storeBaseConfig.consume_base_balanceUnit + '清零', value: '3' },
        { label: this.$q.localStorage.getItem('cychainstore_store_local').storeBaseConfig.consume_base_integralUnit + '清零', value: '4' }
      ],
  ...
  methods: {
    ...
    serviceRuleText (item) {
      ...
      if (item.lsr_deduct_type == 1) {
        data += item.lsr_deduct_amount + this.$q.localStorage.getItem('cychainstore_store_local').storeBaseConfig.consume_base_moneyUnit
      }
      if (item.lsr_deduct_type == 2) {
        data += item.lsr_deduct_amount + this.$q.localStorage.getItem('cychainstore_store_local').storeBaseConfig.consume_base_integralUnit
      }
