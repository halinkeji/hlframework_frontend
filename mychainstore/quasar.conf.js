...
module.exports = function (ctx) {
  return {
    ...
    pwa: {
      ...
      manifest: {
        name: 'hlframework frontend web mychainstore',
        short_name: 'hlframework frontend web mychainstore',
        description: 'hlframework frontend web mychainstore',
        display: 'standalone',
    ...
    electron: {
      ...
      builder: {
        ...
        appId: 'hlframework_frontend_web_mychainstore'
