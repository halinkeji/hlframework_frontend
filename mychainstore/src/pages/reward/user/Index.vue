  ...
  <div class="fit column no-wrap justify-between items-stretch content-stretch no-scroll">
    <div class="col-shrink bg-white q-px-xs q-pb-md row q-gutter-x-sm">
      <div class="col-12 col-md-2">
        <q-input label="请输入员工名称/联系电话" outlined v-model="searchQuery" dense />
      </div>
      <div class="col-12 col-md-2">
        <q-select
          outlined
      ...
      <q-btn @click="addUserInfo" color="primary" unelevated label="添加员工" />
    </div>
    ...
    <add-user-info v-if="userStatus" ref="addUserInfoRef" @getMethods="getList"></add-user-info>
  </div>
</template>
