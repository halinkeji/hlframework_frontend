  ...
  <q-page class="fit">
    <div class="fit column no-wrap justify-between items-stretch content-stretch no-scroll">
      <div class="col-shrink bg-white q-px-xs q-py-sm row q-gutter-xs">
        ...
        <q-btn unelevated color="warning" dense label="搜索" class="q-px-md" @click="getList" v-if="authorityMeta('searchTemplate')" />
        <q-btn unelevated color="grey" dense label="重置" @click="clearBtn" class="q-px-md" v-if="authorityMeta('resetTemplate')" />
        <q-btn unelevated color="primary" dense label="新增" @click="showAddTemplate" class="q-px-md" v-if="authorityMeta('addTemplate')" />
        <q-btn unelevated color="green" dense label="全部导出" @click="exportBtn" class="q-px-md" v-if="authorityMeta('exportTemplate')" />
