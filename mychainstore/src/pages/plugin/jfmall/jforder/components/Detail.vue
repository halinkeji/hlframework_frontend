      ...
      <div class="fit column no-wrap justify-between items-stretch content-stretch no-scroll">
        ...
        <div class="col-shrink q-pa-sm full-height bg-white">
          <q-scroll-area class="fit full-height">
            <div class="row">
              <div class="col-6">
                <q-item clickable>
                  ...
                  <q-item-section side>
                    <q-item-label class="text-dark" lines="2">{{ orderData.jo_order }}</q-item-label>
                  </q-item-section>
                </q-item>
              </div>
              ...
              <div class="col-6">
                <q-item clickable>
                  ...
                  <q-item-section side>
                    <q-item-label class="text-dark" lines="2">{{ orderStatusObject[orderData.jo_state] }}</q-item-label>
                  </q-item-section>
                </q-item>
              </div>

              <div class="col-6" v-if="orderData.jo_point > 0">
                <q-item clickable>
                  <q-item-section>
                    <q-item-label class="text-grey-8"
                      >{{ $q.localStorage.getItem('mychainstore_store_local').storeBaseConfig.consume_base_integralUnit }}:</q-item-label
                    >
                  </q-item-section>

                  <q-item-section side>
                    <q-item-label class="text-dark" lines="2">{{ orderData.jo_point }}</q-item-label>
                  </q-item-section>
                </q-item>
              </div>

              <div class="col-6" v-if="orderData.jo_saving_money > 0">
                <q-item clickable>
                  <q-item-section>
                    <q-item-label class="text-grey-8"
                      >{{ $q.localStorage.getItem('mychainstore_store_local').storeBaseConfig.consume_base_balanceUnit }}:</q-item-label
                    >
                  </q-item-section>

                  <q-item-section side>
                    <q-item-label class="text-dark" lines="2">{{ orderData.jo_saving_money }}</q-item-label>
                  </q-item-section>
                </q-item>
              </div>

              <div class="col-6" v-if="orderData.jo_shipping > 0">
                <q-item clickable>
                  <q-item-section>
                  ...
                  <q-item-section side>
                    <q-item-label class="text-dark" lines="2">{{ orderData.jo_shipping }}</q-item-label>
                  </q-item-section>
                </q-item>
              </div>

              <div class="col-6" v-if="orderData.jo_deduct_balance > 0">
                <q-item clickable>
                  <q-item-section>
                  ...
                  <q-item-section side>
                    <q-item-label class="text-dark" lines="2">{{ orderData.jo_deduct_balance }}</q-item-label>
                  </q-item-section>
                </q-item>
              </div>

              <div class="col-6" v-if="orderData.jo_deduct_integral_money > 0">
                <q-item clickable>
                  <q-item-section>
                  ...
                  <q-item-section side>
                    <q-item-label class="text-dark" lines="2">{{ orderData.jo_deduct_integral_money }}</q-item-label>
                  </q-item-section>
                </q-item>
              </div>

              <div class="col-6" v-if="orderData.jo_deduct_coupon_money > 0">
                <q-item clickable>
                  <q-item-section>
                  ...
                  <q-item-section side>
                    <q-item-label class="text-dark" lines="2">{{ orderData.jo_deduct_coupon_money }}</q-item-label>
                  </q-item-section>
                </q-item>
              </div>

              <div class="col-6" v-if="orderData.jo_handle_amount > 0">
                <q-item clickable>
                  <q-item-section>
                  ...
                  <q-item-section side>
                    <q-item-label class="text-red text-h6" lines="2">{{ orderData.jo_handle_amount }}</q-item-label>
                  </q-item-section>
                </q-item>
              </div>

              <div class="col-6" v-if="orderData.jo_real_amount > 0">
                <q-item clickable>
                  <q-item-section>
                  ...
                  <q-item-section side>
                    <q-item-label class="text-red text-h6" lines="2">{{ orderData.jo_real_amount }}</q-item-label>
                  </q-item-section>
                </q-item>
              </div>
              ...
              <div class="col-12">
                <q-item>
                  <q-item-section>
                    <q-item-label v-if="parseInt(orderData.jo_type) == 1">配送信息</q-item-label>
                    <q-item-label v-if="parseInt(orderData.jo_type) == 2">自取信息</q-item-label>
                  </q-item-section>
                </q-item>
              </div>

              <div class="col-6" v-if="parseInt(orderData.jo_type) == 2">
                <q-item clickable>
                  <q-item-section>
                  ...
                  <q-item-section side>
                    <q-item-label class="text-red text-h6" lines="2">
                      {{ $q_date.formatDate(orderData.jo_pickup_time * 1000, 'YYYY-MM-DD HH:mm:ss') }}</q-item-label
                    >
                  </q-item-section>
                </q-item>
              </div>
              ...
              <div class="col-6" v-if="parseInt(orderData.jo_type) == 2">
                <q-item clickable>
                  ...
                  <q-item-section side>
                    <q-item-label class="text-red text-h6" lines="2"> {{ orderData.jo_pickup_code }}</q-item-label>
                  </q-item-section>
                </q-item>
              </div>
              ...
              <div class="col-6" v-if="parseInt(orderData.jo_type) == 2">
                <q-item clickable>
                  ...
                  <q-item-section side>
                    <q-item-label class="text-dark" lines="2"> {{ orderData.jo_name }} </q-item-label>
                  </q-item-section>
                </q-item>
              </div>
              ...
              <div class="col-6" v-if="parseInt(orderData.jo_type) == 2">
                <q-item clickable>
                  ...
                  <q-item-section side>
                    <q-item-label class="text-dark" lines="2"> {{ orderData.jo_mobile }}</q-item-label>
                  </q-item-section>
                </q-item>
              </div>

              <div class="col-6" v-if="parseInt(orderData.jo_type) == 1 && orderData.memberAddress && orderData.address_id">
                <q-item clickable>
                  <q-item-section>
                    <q-item-label class="text-grey-8">联系人：</q-item-label>
                  </q-item-section>
              ...
              <div class="col-6" v-if="parseInt(orderData.jo_state) >= 3 && parseInt(orderData.jo_type) == 1">
                <q-item clickable>
                  <q-item-section>
                    <q-item-label class="text-grey-8">快递单号：</q-item-label>
                  </q-item-section>
                  <q-item-section side>
                    <q-item-label class="text-dark" lines="2"> {{ orderData.jo_wuliu_order }}</q-item-label>
                  </q-item-section>
                </q-item>
              </div>
              <div class="col-6" v-if="parseInt(orderData.jo_state) >= 3 && parseInt(orderData.jo_type) == 1">
                <q-item clickable>
                  ...
                  <q-item-section side>
                    <q-item-label class="text-dark" lines="2"> {{ $store.state.jfOrder.wuliuCompany[orderData.jo_wuliu_company] }}</q-item-label>
                  </q-item-section>
                </q-item>
              </div>
            </div>
              ...
              <template v-slot:body="props">
                <q-tr :props="props">
                  <q-td key="coverImage" :props="props">
                    <q-avatar square v-if="props.row.coverImage && props.row.coverImage.id">
                      <q-img :ratio="1"
                        :src="
                          props.row.coverImage && props.row.coverImage.id
                            ? $q.localStorage.getItem('mychainstore_system_local').attach_url + props.row.coverImage.path
                            : ''
                        "
                        alt=""
                      >
                      ...
                      <template v-slot:error>
                        <div class="absolute-full flex flex-center text-white bg-grey">
                          <q-avatar color="grey" text-color="white" size="sm" icon="collections" />
                        </div>
                      </template>
                      </q-img>
                    </q-avatar>
                    <q-avatar color="grey" text-color="white" v-else icon="collections" />
            ...
            <div v-if="parseInt(orderData.jo_state) >= 4 && parseInt(orderData.jo_type) == 1 && wuliuLog && wuliuLog.length > 0">
              <q-table
                row-key="id"
                hide-bottom
                flat
  ...
  data () {
    return {
      ...
      columns: [
        ...
        // { name: 'created_at', label: '动作类型', field: 'created_at' },
        { name: 'jos_description', label: '日志内容', align: 'center', field: 'jos_description' }
      ],
      goodsColumns: [
        {
          name: 'coverImage',
        ...
        .then((res) => {
          if (res.code == 200) {
            if (res.data) {
              ...
              this.wuliuLog = this.orderData && this.orderData.jo_wuliu_log && this.orderData.jo_wuliu_log.time ? this.orderData.jo_wuliu_log.log : []
      ...
      this.$q
        ...
        .onOk(() => {
          ...
          this.$store
            ...
            .then((res) => {
              if (res.code == 200) {
                if (parseInt(res.data.jo_state) == 7) {
                  this.$q.notify({
                    message: '成功',
                    caption: '订单已取消！',
