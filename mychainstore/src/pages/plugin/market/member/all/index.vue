<template>
  <div class="fit bg-grey-3">
    ...
    <market-member-detail ref="memberDetaillRef" v-if="detailPoppupStatus" @dataList="hideDetailPoppup" />
...
import MarketMemberDetail from './MemberDetail'

import AddMarketMember from '../AddMarketMember.vue'
export default {
  name: 'marketAllMember',
  components: {
    AgOperate,
    MarketMemberDetail,
    AddMarketMember
