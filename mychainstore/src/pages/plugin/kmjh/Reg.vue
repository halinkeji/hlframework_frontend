            ...
            <q-card flat bordered class="q-mt-lg q-pa-sm" v-if="cardSecretData.package">
              <div class="bg-white">
                ...
                <div class="row q-pa-sm bg-grey-3 text-center q-mt-xs">
                  <div class="col">赠送{{ $q.localStorage.getItem('mychainstore_store_local').storeBaseConfig.consume_base_integralUnit }}</div>
                  <div class="col">赠送{{ $q.localStorage.getItem('mychainstore_store_local').storeBaseConfig.consume_base_balanceUnit }}</div>
                </div>
                <div
...
export default {
  ...
  created () {
    const headerLocal = this.$q.localStorage.getItem('mychainstore_header_local')
