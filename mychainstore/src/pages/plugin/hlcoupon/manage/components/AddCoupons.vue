              ...
              <div class="row q-col-gutter-sm">
                ...
                <div class="col" v-if="dataForm.cou_type == 6">
                  <q-input
                    outlined
                    bottom-slots
                    :label="'会员获得' + `${$q.localStorage.getItem('mychainstore_store_local').storeBaseConfig.consume_base_integralUnit}`"
                    ...
                    :rules="[
                      ...
                      (val) =>
                        ...
                        '请输入正确的' + `${$q.localStorage.getItem('mychainstore_store_local').storeBaseConfig.consume_base_integralUnit}`,
                    ]"
                  >
                  </q-input>
                </div>
                ...
                <div class="col" v-if="dataForm.cou_type == 7">
                  <q-input
                    outlined
                    bottom-slots
                    :label="`会员获得${$q.localStorage.getItem('mychainstore_store_local').storeBaseConfig.consume_base_balanceUnit}`"
                    ...
                    :rules="[
                      ...
                      (val) =>
                        /(^[1-9]([0-9]+)?(\.[0-9]{1,2})?$)|(^(0){1}$)|(^[0-9]\.[0-9]([0-9])?$)/.test(val) ||
                        '请输入正确的' + $q.localStorage.getItem('mychainstore_store_local').storeBaseConfig.consume_base_balanceUnit,
                    ]"
                  >
                  </q-input>
                </div>
              ...
              <div class="row q-mt-sm q-col-gutter-xs">
                <div v-if="dataForm.cou_couponProperty == 2 || dataForm.cou_couponProperty == 5" class="col-12 col-md-4">
                  <q-input
                    outlined
                    bottom-slots
                    :label="`${$q.localStorage.getItem('mychainstore_store_local').storeBaseConfig.consume_base_balanceUnit}支付`"
                    v-model="dataForm.cou_use_balance"
                    dense
                    :rules="[
                      (val) => !!val || $q.localStorage.getItem('mychainstore_store_local').storeBaseConfig.consume_base_balanceUnit + '支付是必填项',
                ...
                <div v-if="dataForm.cou_couponProperty == 3 || dataForm.cou_couponProperty == 5" class="col-12 col-md-4">
                  <q-input
                    outlined
                    bottom-slots
                    :label="`${$q.localStorage.getItem('mychainstore_store_local').storeBaseConfig.consume_base_integralUnit}支付`"
                    v-model="dataForm.cou_use_integral"
                    dense
                    :rules="[
                      (val) =>
                        !!val || `${$q.localStorage.getItem('mychainstore_store_local').storeBaseConfig.consume_base_integralUnit}` + '支付是必填项',
                      (val) => /(^[1-9]([0-9]+)?(\.[0-9]{1,2})?$)|(^(0){1}$)|(^[0-9]\.[0-9]([0-9])?$)/.test(val) || '请输入正确的数字',
                    ]"
                  >
                  </q-input>
