          ...
          for (var j in i) {
            ...
            if (!i[j]) {
              data.forEach((value, key) => {
                ...
                } else if (value.extend_pay) {
                  if (value.extend_pay && JSON.parse(value.extend_pay) && JSON.parse(value.extend_pay).length > 0) {
                    console.log('extend_pay', JSON.parse(value.extend_pay))
