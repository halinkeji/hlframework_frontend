  ...
  <q-page class="fit">
    <div class="fit column no-wrap justify-between items-stretch content-stretch no-scroll">
      <div class="col-shrink bg-white q-px-xs q-py-sm text-subtitle2">
        ...
        会员获得{{ $q.localStorage.getItem('mychainstore_store_local').storeBaseConfig.consume_base_integralUnit }}报表
      </div>
          ...
          <div class="q-mt-sm">
            <div class="q-mt-sm q-pa-md bg-white">
              <div class="full-width text-weight-bold q-mb-md">
                新增{{ $q.localStorage.getItem('mychainstore_store_local').storeBaseConfig.consume_base_integralUnit }}TOP排行榜
  ...
  methods: {
    ...
    drawLine () {
      ...
      memberGiveCharts.setOption({
        ...
        series: [
          {
            name: '新增' + this.$q.localStorage.getItem('mychainstore_store_local').storeBaseConfig.consume_base_integralUnit,
    ...
    exportBut () {
      ...
      this.gridOptions.api.exportDataAsCsv({
        fileName: date + '-新增' + this.$q.localStorage.getItem('mychainstore_store_local').storeBaseConfig.consume_base_integralUnit + 'TOP排行榜'
      })
    }
  }
}
