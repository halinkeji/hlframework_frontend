      ...
      <div class="fit column no-wrap justify-between items-stretch content-stretch no-scroll">
        <div class="col-shrink bg-white q-px-xs q-pb-md row">
          <q-tabs
            ...
            @input="getListSwitch"
          >
            <q-tab name="moneyRecord"> {{ $q.localStorage.getItem('mychainstore_store_local').storeBaseConfig.consume_base_balanceUnit }}记录 </q-tab>

            <q-tab name="pointRecord"> {{ $q.localStorage.getItem('mychainstore_store_local').storeBaseConfig.consume_base_integralUnit }}记录 </q-tab>
