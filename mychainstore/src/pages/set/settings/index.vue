  ...
  <q-page class="fit">
    <div class="fit column no-wrap justify-between items-stretch content-stretch no-scroll">
      <div class="col-shrink bg-white q-px-xs q-pb-md">
        <q-tabs v-model="tab" indicator-color="primary" @input="changeTab" active-color="primary" dense align="left" inline-label class="bg-white">
          ...
          <q-tab name="invoicePage" icon="las la-icons"  label="单据修改记录"> </q-tab>
        </q-tabs>
      </div>
      ...
      <div class="col-shrink full-height q-mt-xs fit" v-if="tab == 'other'">
       ...
       <div class="col-shrink full-height q-mt-xs fit" v-if="tab == 'invoicePage'">
        <invoice-change-page></invoice-change-page>
      </div>
    </div>
  </q-page>
</template>
...
import InvoiceChangePage from './components/InvoiceChangePage.vue'
export default {
  name: 'set',
  components: {
    IndexInfo,
