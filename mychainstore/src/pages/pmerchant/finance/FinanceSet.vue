          ...
          <q-card-section class="row q-col-gutter-sm">
            <div class="col">
              <q-card bordered flat>
                <q-card-section>
                  启用平台{{ $q.localStorage.getItem('mychainstore_store_local').storeBaseConfig.consume_base_balanceUnit }}</q-card-section
                >
                <q-separator />
                <q-card-section>
                  <q-option-group
            ...
            <div class="col">
              <q-card bordered flat>
                <q-card-section>
                  启用平台{{ $q.localStorage.getItem('mychainstore_store_local').storeBaseConfig.consume_base_integralUnit }}</q-card-section
                >
                <q-separator />
                <q-card-section>
                  <q-option-group
...
export default {
  ...
  created () {
    if (this.$q.localStorage.getItem('mychainstore_account_info')) {
      this.accountInfo = this.$q.localStorage.getItem('mychainstore_account_info')
    }
  },
  computed: {},
  methods: {
