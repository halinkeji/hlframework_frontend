...
export default {
  ...
  created () {
    ...
    if (LocalStorage.getItem('mychainstore_store_local').storeMemberConfig) {
      this.storeMemberConfig = LocalStorage.getItem('mychainstore_store_local').storeMemberConfig
    }
    if (LocalStorage.getItem('mychainstore_plugins_local').openPlugins) {
