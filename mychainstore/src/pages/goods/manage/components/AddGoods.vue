            ...
            <q-card flat>
              <q-card-section class="row q-col-gutter-sm">
                ...
                <div class="col-md-3 col-12 row ">
                  ...
                  <div class="col-auto">
                    <q-btn anchor="bottom right" dense self="top left" flat class="q-mr-sm" icon="ion-help-circle" color="warning">
                      <q-tooltip>
...
export default {
  ...
  created () {
    this.context = this
    const systemLocal = LocalStorage.getItem('mychainstore_system_local')
    ...
    getItemData () {
      ...
      this.$store
        ...
        .then((res) => {
          if (res.code == 200) {
            this.$nextTick(() => {
              this.$refs.rewardGoodsBindRef.init(this.goodsId)
            })
