  ...
  <q-page class="fit">
    <div class="fit column no-wrap justify-between items-stretch content-stretch no-scroll">
      <div class="col-shrink bg-white q-px-xs q-py-sm text-subtitle2">
        ...
        {{ $q.localStorage.getItem('mychainstore_store_local').storeBaseConfig.consume_base_integralUnit }}操作
      </div>
      ...
      <div class="col-shrink bg-white q-pb-md q-gutter-md text-center  q-mt-xs">
        ...
        <q-btn
          ...
          label="重置"
          @click="refreshBut()"
          :disable="!pointInput && !memberId"
          icon="ion-refresh"
        />
        <q-btn
          unelevated
          class="q-px-xl bg_cinnabar text-white"
          size="lg"
          label="增加"
        ...
        <q-btn
          unelevated
          class="q-px-xl bg_rouge text-white"
          size="lg"
          label="扣除"
