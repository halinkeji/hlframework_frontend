  ...
  <q-page class="fit">
    <div class="fit column no-wrap justify-between items-stretch content-stretch no-scroll">
      <div class="col-shrink bg-white q-px-xs q-py-sm q-gutter-xs row">
        <div class="col">
          <q-input outlined v-model="receipt" clearable label="收款单据号/销货单据号" dense />
        </div>
        ...
        <q-btn-dropdown color="primary" unelevated v-if="authorityMeta('add')" label="新增收款">
            <q-list>
    ...
    return {
      ...
      columnDefs: [
        ...
        },
        {
          ...
          width: this.nowpx(0.1) + 'px',
          valueGetter: (p) => {
            return this.formatAmount(p.data.err_last_remainder - p.data.err_pay_back)
          }
        },
        {
          headerName: '应收金额',
          ...
          width: this.nowpx(0.1) + 'px',
          valueGetter: (p) => {
            return this.formatAmount(p.data.err_receivable)
          },
          rowSpan: this.rowSpan,
          cellClassRules: {
            'cell-span-erp-repayment': function (p) {
        ...
        },
        {
          ...
          width: this.nowpx(0.1) + 'px',
          valueGetter: (p) => {
            return this.formatAmount(p.data.err_money)
          },
          rowSpan: this.rowSpan,
          cellClassRules: {
            'cell-span-erp-repayment': function (p) {
