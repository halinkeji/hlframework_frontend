    ...
    <div class="fit column no-wrap justify-between items-stretch content-stretch no-scroll">
      ...
      <div class="col-shrink bg-white q-px-xs q-pb-lg row text-left">
        <div class="col-4 q-pa-xs">
            <q-input disable dense v-model="clientName" label="客户" />
          </div>
        <div class="col-4 q-pa-xs">
      ...
      this.$store
        ...
        .then((res) => {
          if (res.code == 200) {
            ...
            if (this.outData && this.outData.client && this.outData.client.id) {
              this.clientName = this.outData.client.ecp_name
            }
          }
        })
        .catch((error) => {
