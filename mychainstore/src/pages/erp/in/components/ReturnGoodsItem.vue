<template>
  <q-page class="fit">
    <div class="fit column no-wrap justify-between items-stretch content-stretch no-scroll">
      <div class="col-shrink bg-white q-px-xs q-pb-lg">
        <div class="row text-left">
          <div class="col-4 q-pa-xs">
            <q-input disable dense v-model="supplierName" label="供货商" />
          </div>
          <div class="col-4 q-pa-xs">
      ...
      <div class="col-shrink bg-white q-py-md text-center q-gutter-sm">
        <q-btn
          color="primary"
          @click="confirmReturn()"
          unelevated
      ...
      this.$store
        ...
        .then((res) => {
          if (res.code == 200) {
            ...
            if (this.outData && this.outData.supplier && this.outData.supplier.id) {
              this.supplierName = this.outData.supplier.gs_supplierName
            }
          }
        })
        .catch((error) => {
