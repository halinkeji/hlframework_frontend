...
const currentRouterData = LocalStorage.getItem('mychainstore_router_local')
  ...
  Store.dispatch('user/roleInfo')
    .then(res => {
      if (res.data) {
        ...
        // 写入左侧菜单
        LocalStorage.set('mychainstore_left_menu_navigate_local', menu)
        Store.commit('settings/SET_MENUData', menu)

        // 写入业务菜单
        LocalStorage.set('mychainstore_business_menu_navigate_local', businessMenu)
